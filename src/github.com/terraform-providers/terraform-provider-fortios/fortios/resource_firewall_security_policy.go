...
func resourceFirewallSecurityPolicyRead(d *schema.ResourceData, m interface{}) error {
	...
	//Refresh property
	d.Set("name", o.Name)
	srcintf := forticlient.ExpandStringList(o.Srcintf)
	d.Set("srcintf", srcintf)
	dstintf := forticlient.ExpandStringList(o.Dstintf)
	d.Set("dstintf", dstintf)
	srcaddr := forticlient.ExpandStringList(o.Srcaddr)
	d.Set("srcaddr", srcaddr)
	dstaddr := forticlient.ExpandStringList(o.Dstaddr)
	...
	service := forticlient.ExpandStringList(o.Service)
	...
	poolname := forticlient.ExpandStringList(o.Poolname)
	d.Set("poolname", poolname)
	groups := forticlient.ExpandStringList(o.Groups)
	d.Set("groups", groups)
	devices := forticlient.ExpandStringList(o.Devices)
