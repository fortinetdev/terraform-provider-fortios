...
func resourceWirelessControllerHotspot20H2QpOperatorNameCreate(d *schema.ResourceData, m interface{}) error {
	...
	return readBackAfterCreate(d, "WirelessControllerHotspot20H2QpOperatorName", mkey,
		func() (map[string]interface{}, error) {
			return c.ReadWirelessControllerHotspot20H2QpOperatorName(mkey, vdomparam)
		},
		refreshObjectWirelessControllerHotspot20H2QpOperatorName, c.Fv)
}
...
func flattenWirelessControllerHotspot20H2QpOperatorNameValueList(v interface{}, d *schema.ResourceData, pre string, sv string) []map[string]interface{} {
	...
	for _, r := range parsed_list {
		...
		if cur_v, ok := i["index"]; ok {
			...
			tmp["index"] = flattenWirelessControllerHotspot20H2QpOperatorNameValueListIndex(cur_v, d, pre_append, sv)
		}
		...
		if cur_v, ok := i["lang"]; ok {
			...
			tmp["lang"] = flattenWirelessControllerHotspot20H2QpOperatorNameValueListLang(cur_v, d, pre_append, sv)
		}
		...
		if cur_v, ok := i["value"]; ok {
			...
			tmp["value"] = flattenWirelessControllerHotspot20H2QpOperatorNameValueListValue(cur_v, d, pre_append, sv)
		}
