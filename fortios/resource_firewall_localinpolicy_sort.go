...
func resourceFirewallLocalinpolicySortCreateUpdate(d *schema.ResourceData, m interface{}) error {
	...
	err := c.CreateUpdateFirewallLocalinpolicySort(sortby, sortdirection, vdomparam, manual_order)
	if err != nil {
...
func resourceFirewallLocalinpolicySortRead(d *schema.ResourceData, m interface{}) error {
	...
	sorted, o, err := c.ReadFirewallLocalinpolicySort(sortby, sortdirection, vdomparam, manual_order)
	if err != nil {
