...
func flattenFirewallCentralSnatMapOrigAddr(v interface{}, d *schema.ResourceData, pre string) []map[string]interface{} {
	if v == nil {
		return nil
	}
	...
	for _, r := range l {
		...
		if _, ok := i["name"]; ok {
			tmp["name"] = flattenFirewallCentralSnatMapOrigAddrName(i["name"], d, pre_append)
		}
...
func flattenFirewallCentralSnatMapOrigAddrName(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenFirewallCentralSnatMapSrcintf(v interface{}, d *schema.ResourceData, pre string) []map[string]interface{} {
	if v == nil {
		return nil
	}
	...
	for _, r := range l {
		...
		pre_append = pre + "." + strconv.Itoa(con) + "." + "name"
		if _, ok := i["name"]; ok {
			tmp["name"] = flattenFirewallCentralSnatMapSrcintfName(i["name"], d, pre_append)
		}
...
func flattenFirewallCentralSnatMapSrcintfName(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenFirewallCentralSnatMapDstAddr(v interface{}, d *schema.ResourceData, pre string) []map[string]interface{} {
	if v == nil {
		return nil
	}
	...
	for _, r := range l {
		...
		pre_append = pre + "." + strconv.Itoa(con) + "." + "name"
		if _, ok := i["name"]; ok {
			tmp["name"] = flattenFirewallCentralSnatMapDstAddrName(i["name"], d, pre_append)
		}
...
func flattenFirewallCentralSnatMapDstAddrName(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenFirewallCentralSnatMapDstintf(v interface{}, d *schema.ResourceData, pre string) []map[string]interface{} {
	if v == nil {
		return nil
	}
	...
	for _, r := range l {
		...
		pre_append = pre + "." + strconv.Itoa(con) + "." + "name"
		if _, ok := i["name"]; ok {
			tmp["name"] = flattenFirewallCentralSnatMapDstintfName(i["name"], d, pre_append)
		}
...
func flattenFirewallCentralSnatMapDstintfName(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenFirewallCentralSnatMapNatIppool(v interface{}, d *schema.ResourceData, pre string) []map[string]interface{} {
	if v == nil {
		return nil
	}
	...
	for _, r := range l {
		...
		pre_append = pre + "." + strconv.Itoa(con) + "." + "name"
		if _, ok := i["name"]; ok {
			tmp["name"] = flattenFirewallCentralSnatMapNatIppoolName(i["name"], d, pre_append)
		}
...
func flattenFirewallCentralSnatMapNatIppoolName(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func expandFirewallCentralSnatMapOrigAddr(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	...
	for _, r := range l {
		...
		if _, ok := d.GetOk(pre_append); ok {
			tmp["name"], _ = expandFirewallCentralSnatMapOrigAddrName(d, i["name"], pre_append)
		}
...
func expandFirewallCentralSnatMapOrigAddrName(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func expandFirewallCentralSnatMapSrcintf(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	...
	for _, r := range l {
		...
		pre_append = pre + "." + strconv.Itoa(con) + "." + "name"
		if _, ok := d.GetOk(pre_append); ok {
			tmp["name"], _ = expandFirewallCentralSnatMapSrcintfName(d, i["name"], pre_append)
		}
...
func expandFirewallCentralSnatMapSrcintfName(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func expandFirewallCentralSnatMapDstAddr(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	...
	for _, r := range l {
		...
		pre_append = pre + "." + strconv.Itoa(con) + "." + "name"
		if _, ok := d.GetOk(pre_append); ok {
			tmp["name"], _ = expandFirewallCentralSnatMapDstAddrName(d, i["name"], pre_append)
		}
...
func expandFirewallCentralSnatMapDstAddrName(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func expandFirewallCentralSnatMapDstintf(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	...
	for _, r := range l {
		...
		pre_append = pre + "." + strconv.Itoa(con) + "." + "name"
		if _, ok := d.GetOk(pre_append); ok {
			tmp["name"], _ = expandFirewallCentralSnatMapDstintfName(d, i["name"], pre_append)
		}
...
func expandFirewallCentralSnatMapDstintfName(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func expandFirewallCentralSnatMapNatIppool(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	...
	for _, r := range l {
		...
		pre_append = pre + "." + strconv.Itoa(con) + "." + "name"
		if _, ok := d.GetOk(pre_append); ok {
			tmp["name"], _ = expandFirewallCentralSnatMapNatIppoolName(d, i["name"], pre_append)
		}
...
func expandFirewallCentralSnatMapNatIppoolName(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
