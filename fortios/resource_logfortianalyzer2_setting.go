...
func flattenLogFortianalyzer2SettingChangeIp(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return convintf2i(v)
}
...
func flattenLogFortianalyzer2SettingVrfSelect(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return convintf2i(v)
}
...
func refreshObjectLogFortianalyzer2Setting(d *schema.ResourceData, o map[string]interface{}, sv string) error {
	...
	if err = d.Set("__change_ip", flattenLogFortianalyzer2SettingChangeIp(o["__change_ip"], d, "__change_ip", sv)); err != nil {
	...
	if err = d.Set("vrf_select", flattenLogFortianalyzer2SettingVrfSelect(o["vrf-select"], d, "vrf_select", sv)); err != nil {
...
func expandLogFortianalyzer2SettingChangeIp(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func expandLogFortianalyzer2SettingVrfSelect(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func getObjectLogFortianalyzer2Setting(d *schema.ResourceData, setArgNil bool, sv string) (*map[string]interface{}, error) {
	...
	if v, ok := d.GetOkExists("__change_ip"); ok {
		if setArgNil {
			...
			t, err := expandLogFortianalyzer2SettingChangeIp(d, v, "__change_ip", sv)
			if err != nil {
				return &obj, err
			} else if t != nil {
				obj["__change_ip"] = t
	...
	if v, ok := d.GetOkExists("vrf_select"); ok {
		if setArgNil {
			...
			t, err := expandLogFortianalyzer2SettingVrfSelect(d, v, "vrf_select", sv)
			if err != nil {
				return &obj, err
			} else if t != nil {
				obj["vrf-select"] = t
