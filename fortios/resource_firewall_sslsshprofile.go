...
func flattenFirewallSslSshProfileUuid(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}

func flattenFirewallSslSshProfileFabricObject(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}

func flattenFirewallSslSshProfileFabricForceSync(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}

func flattenFirewallSslSshProfileFabricObjectSource(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func flattenFirewallSslSshProfileSsl(v interface{}, d *schema.ResourceData, pre string, sv string) []map[string]interface{} {
	...
	if _, ok := i["encrypted-client-hello"]; ok {
		result["encrypted_client_hello"] = flattenFirewallSslSshProfileSslEncryptedClientHello(i["encrypted-client-hello"], d, pre_append, sv)
	}
...
func flattenFirewallSslSshProfileSslEncryptedClientHello(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func flattenFirewallSslSshProfileHttps(v interface{}, d *schema.ResourceData, pre string, sv string) []map[string]interface{} {
	...
	if _, ok := i["udp-not-quic"]; ok {
		result["udp_not_quic"] = flattenFirewallSslSshProfileHttpsUdpNotQuic(i["udp-not-quic"], d, pre_append, sv)
	}
	...
	pre_append = pre + ".0." + "encrypted_client_hello"
	if _, ok := i["encrypted-client-hello"]; ok {
		result["encrypted_client_hello"] = flattenFirewallSslSshProfileHttpsEncryptedClientHello(i["encrypted-client-hello"], d, pre_append, sv)
	}
...
func flattenFirewallSslSshProfileHttpsUdpNotQuic(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func flattenFirewallSslSshProfileHttpsEncryptedClientHello(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func flattenFirewallSslSshProfileDot(v interface{}, d *schema.ResourceData, pre string, sv string) []map[string]interface{} {
	...
	pre_append = pre + ".0." + "udp_not_quic"
	if _, ok := i["udp-not-quic"]; ok {
		result["udp_not_quic"] = flattenFirewallSslSshProfileDotUdpNotQuic(i["udp-not-quic"], d, pre_append, sv)
	}
...
func flattenFirewallSslSshProfileDotUdpNotQuic(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func flattenFirewallSslSshProfileEchOuterSni(v interface{}, d *schema.ResourceData, pre string, sv string) []map[string]interface{} {
	if v == nil {
		return nil
	}
	...
	for _, r := range parsed_list {
		...
		if cur_v, ok := i["name"]; ok {
			...
			tmp["name"] = flattenFirewallSslSshProfileEchOuterSniName(cur_v, d, pre_append, sv)
		}

		if cur_v, ok := i["sni"]; ok {
			pre_append := ""
			if tf_exist {
				pre_append = pre + "." + strconv.Itoa(con) + "." + "sni"
			}
			tmp["sni"] = flattenFirewallSslSshProfileEchOuterSniSni(cur_v, d, pre_append, sv)
		}
...
func flattenFirewallSslSshProfileEchOuterSniName(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}

func flattenFirewallSslSshProfileEchOuterSniSni(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func refreshObjectFirewallSslSshProfile(d *schema.ResourceData, o map[string]interface{}, sv string) error {
	...
	if err = d.Set("uuid", flattenFirewallSslSshProfileUuid(o["uuid"], d, "uuid", sv)); err != nil {
		if !fortiAPIPatch(o["uuid"]) {
			return fmt.Errorf("Error reading uuid: %v", err)
		}
	}

	if err = d.Set("fabric_object", flattenFirewallSslSshProfileFabricObject(o["fabric-object"], d, "fabric_object", sv)); err != nil {
		if !fortiAPIPatch(o["fabric-object"]) {
			return fmt.Errorf("Error reading fabric_object: %v", err)
		}
	}

	if err = d.Set("fabric_force_sync", flattenFirewallSslSshProfileFabricForceSync(o["fabric-force-sync"], d, "fabric_force_sync", sv)); err != nil {
		if !fortiAPIPatch(o["fabric-force-sync"]) {
			return fmt.Errorf("Error reading fabric_force_sync: %v", err)
		}
	}

	if err = d.Set("fabric_object_source", flattenFirewallSslSshProfileFabricObjectSource(o["fabric-object-source"], d, "fabric_object_source", sv)); err != nil {
	...
	if b_get_all_tables {
		if err = d.Set("ech_outer_sni", flattenFirewallSslSshProfileEchOuterSni(o["ech-outer-sni"], d, "ech_outer_sni", sv)); err != nil {
			if !fortiAPIPatch(o["ech-outer-sni"]) {
...
func expandFirewallSslSshProfileUuid(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandFirewallSslSshProfileFabricObject(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandFirewallSslSshProfileFabricForceSync(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandFirewallSslSshProfileFabricObjectSource(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func expandFirewallSslSshProfileSsl(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	...
	pre_append = pre + ".0." + "encrypted_client_hello"
	if _, ok := d.GetOk(pre_append); ok {
		result["encrypted-client-hello"], _ = expandFirewallSslSshProfileSslEncryptedClientHello(d, i["encrypted_client_hello"], pre_append, sv)
	}
	pre_append = pre + ".0." + "min_allowed_ssl_version"
	if _, ok := d.GetOk(pre_append); ok {
...
func expandFirewallSslSshProfileSslEncryptedClientHello(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func expandFirewallSslSshProfileHttps(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	...
	pre_append = pre + ".0." + "udp_not_quic"
	if _, ok := d.GetOk(pre_append); ok {
		result["udp-not-quic"], _ = expandFirewallSslSshProfileHttpsUdpNotQuic(d, i["udp_not_quic"], pre_append, sv)
	}
	pre_append = pre + ".0." + "proxy_after_tcp_handshake"
	if _, ok := d.GetOk(pre_append); ok {
	...
	pre_append = pre + ".0." + "encrypted_client_hello"
	if _, ok := d.GetOk(pre_append); ok {
		result["encrypted-client-hello"], _ = expandFirewallSslSshProfileHttpsEncryptedClientHello(d, i["encrypted_client_hello"], pre_append, sv)
	}
	pre_append = pre + ".0." + "min_allowed_ssl_version"
	if _, ok := d.GetOk(pre_append); ok {
...
func expandFirewallSslSshProfileHttpsUdpNotQuic(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func expandFirewallSslSshProfileHttpsEncryptedClientHello(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func expandFirewallSslSshProfileDot(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	...
	pre_append = pre + ".0." + "udp_not_quic"
	if _, ok := d.GetOk(pre_append); ok {
		result["udp-not-quic"], _ = expandFirewallSslSshProfileDotUdpNotQuic(d, i["udp_not_quic"], pre_append, sv)
	}
	pre_append = pre + ".0." + "proxy_after_tcp_handshake"
	if _, ok := d.GetOk(pre_append); ok {
...
func expandFirewallSslSshProfileDotUdpNotQuic(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func expandFirewallSslSshProfileEchOuterSni(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	l := v.([]interface{})
	result := make([]map[string]interface{}, 0, len(l))
...
func expandFirewallSslSshProfileEchOuterSniName(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandFirewallSslSshProfileEchOuterSniSni(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func getObjectFirewallSslSshProfile(d *schema.ResourceData, sv string) (*map[string]interface{}, error) {
	...
	if v, ok := d.GetOk("uuid"); ok {
		t, err := expandFirewallSslSshProfileUuid(d, v, "uuid", sv)
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["uuid"] = t
	...
	if v, ok := d.GetOk("fabric_object"); ok {
		t, err := expandFirewallSslSshProfileFabricObject(d, v, "fabric_object", sv)
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["fabric-object"] = t
	...
	if v, ok := d.GetOk("fabric_force_sync"); ok {
		t, err := expandFirewallSslSshProfileFabricForceSync(d, v, "fabric_force_sync", sv)
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("fabric_object_source"); ok {
		t, err := expandFirewallSslSshProfileFabricObjectSource(d, v, "fabric_object_source", sv)
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("ech_outer_sni"); ok || d.HasChange("ech_outer_sni") {
		t, err := expandFirewallSslSshProfileEchOuterSni(d, v, "ech_outer_sni", sv)
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["ech-outer-sni"] = t
