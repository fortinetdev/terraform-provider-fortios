...
func refreshObjectRouterbgpNeighbor(d *schema.ResourceData, o map[string]interface{}) error {
	...
	if err = d.Set("ip", flattenRouterbgpNeighborIp(o["ip"], d, "ip")); err != nil {
		if !fortiAPIPatch(o["ip"]) {
			return fmt.Errorf("Error reading ip: %v", err)
		}
	}

	if err = d.Set("advertisement_interval", flattenRouterbgpNeighborAdvertisementInterval(o["advertisement-interval"], d, "advertisement_interval")); err != nil {
		if !fortiAPIPatch(o["advertisement-interval"]) {
			return fmt.Errorf("Error reading advertisement_interval: %v", err)
		}
	}

	if err = d.Set("allowas_in_enable", flattenRouterbgpNeighborAllowasInEnable(o["allowas-in-enable"], d, "allowas_in_enable")); err != nil {
		if !fortiAPIPatch(o["allowas-in-enable"]) {
			return fmt.Errorf("Error reading allowas_in_enable: %v", err)
		}
	}

	if err = d.Set("allowas_in_enable6", flattenRouterbgpNeighborAllowasInEnable6(o["allowas-in-enable6"], d, "allowas_in_enable6")); err != nil {
		if !fortiAPIPatch(o["allowas-in-enable6"]) {
			return fmt.Errorf("Error reading allowas_in_enable6: %v", err)
		}
	}

	if err = d.Set("allowas_in", flattenRouterbgpNeighborAllowasIn(o["allowas-in"], d, "allowas_in")); err != nil {
		if !fortiAPIPatch(o["allowas-in"]) {
			return fmt.Errorf("Error reading allowas_in: %v", err)
		}
	}

	if err = d.Set("allowas_in6", flattenRouterbgpNeighborAllowasIn6(o["allowas-in6"], d, "allowas_in6")); err != nil {
		if !fortiAPIPatch(o["allowas-in6"]) {
			return fmt.Errorf("Error reading allowas_in6: %v", err)
		}
	}

	if err = d.Set("attribute_unchanged", flattenRouterbgpNeighborAttributeUnchanged(o["attribute-unchanged"], d, "attribute_unchanged")); err != nil {
		if !fortiAPIPatch(o["attribute-unchanged"]) {
			return fmt.Errorf("Error reading attribute_unchanged: %v", err)
		}
	}

	if err = d.Set("attribute_unchanged6", flattenRouterbgpNeighborAttributeUnchanged6(o["attribute-unchanged6"], d, "attribute_unchanged6")); err != nil {
		if !fortiAPIPatch(o["attribute-unchanged6"]) {
			return fmt.Errorf("Error reading attribute_unchanged6: %v", err)
		}
	}

	if err = d.Set("activate", flattenRouterbgpNeighborActivate(o["activate"], d, "activate")); err != nil {
		if !fortiAPIPatch(o["activate"]) {
			return fmt.Errorf("Error reading activate: %v", err)
		}
	}

	if err = d.Set("activate6", flattenRouterbgpNeighborActivate6(o["activate6"], d, "activate6")); err != nil {
		if !fortiAPIPatch(o["activate6"]) {
			return fmt.Errorf("Error reading activate6: %v", err)
		}
	}

	if err = d.Set("bfd", flattenRouterbgpNeighborBfd(o["bfd"], d, "bfd")); err != nil {
		if !fortiAPIPatch(o["bfd"]) {
			return fmt.Errorf("Error reading bfd: %v", err)
		}
	}

	if err = d.Set("capability_dynamic", flattenRouterbgpNeighborCapabilityDynamic(o["capability-dynamic"], d, "capability_dynamic")); err != nil {
		if !fortiAPIPatch(o["capability-dynamic"]) {
			return fmt.Errorf("Error reading capability_dynamic: %v", err)
		}
	}

	if err = d.Set("capability_orf", flattenRouterbgpNeighborCapabilityOrf(o["capability-orf"], d, "capability_orf")); err != nil {
		if !fortiAPIPatch(o["capability-orf"]) {
			return fmt.Errorf("Error reading capability_orf: %v", err)
		}
	}

	if err = d.Set("capability_orf6", flattenRouterbgpNeighborCapabilityOrf6(o["capability-orf6"], d, "capability_orf6")); err != nil {
		if !fortiAPIPatch(o["capability-orf6"]) {
			return fmt.Errorf("Error reading capability_orf6: %v", err)
		}
	}

	if err = d.Set("capability_graceful_restart", flattenRouterbgpNeighborCapabilityGracefulRestart(o["capability-graceful-restart"], d, "capability_graceful_restart")); err != nil {
		if !fortiAPIPatch(o["capability-graceful-restart"]) {
			return fmt.Errorf("Error reading capability_graceful_restart: %v", err)
		}
	}

	if err = d.Set("capability_graceful_restart6", flattenRouterbgpNeighborCapabilityGracefulRestart6(o["capability-graceful-restart6"], d, "capability_graceful_restart6")); err != nil {
		if !fortiAPIPatch(o["capability-graceful-restart6"]) {
			return fmt.Errorf("Error reading capability_graceful_restart6: %v", err)
		}
	}

	if err = d.Set("capability_route_refresh", flattenRouterbgpNeighborCapabilityRouteRefresh(o["capability-route-refresh"], d, "capability_route_refresh")); err != nil {
		if !fortiAPIPatch(o["capability-route-refresh"]) {
			return fmt.Errorf("Error reading capability_route_refresh: %v", err)
		}
	}

	if err = d.Set("capability_default_originate", flattenRouterbgpNeighborCapabilityDefaultOriginate(o["capability-default-originate"], d, "capability_default_originate")); err != nil {
		if !fortiAPIPatch(o["capability-default-originate"]) {
			return fmt.Errorf("Error reading capability_default_originate: %v", err)
		}
	}

	if err = d.Set("capability_default_originate6", flattenRouterbgpNeighborCapabilityDefaultOriginate6(o["capability-default-originate6"], d, "capability_default_originate6")); err != nil {
		if !fortiAPIPatch(o["capability-default-originate6"]) {
			return fmt.Errorf("Error reading capability_default_originate6: %v", err)
		}
	}

	if err = d.Set("dont_capability_negotiate", flattenRouterbgpNeighborDontCapabilityNegotiate(o["dont-capability-negotiate"], d, "dont_capability_negotiate")); err != nil {
		if !fortiAPIPatch(o["dont-capability-negotiate"]) {
			return fmt.Errorf("Error reading dont_capability_negotiate: %v", err)
		}
	}

	if err = d.Set("ebgp_enforce_multihop", flattenRouterbgpNeighborEbgpEnforceMultihop(o["ebgp-enforce-multihop"], d, "ebgp_enforce_multihop")); err != nil {
		if !fortiAPIPatch(o["ebgp-enforce-multihop"]) {
			return fmt.Errorf("Error reading ebgp_enforce_multihop: %v", err)
		}
	}

	if err = d.Set("link_down_failover", flattenRouterbgpNeighborLinkDownFailover(o["link-down-failover"], d, "link_down_failover")); err != nil {
		if !fortiAPIPatch(o["link-down-failover"]) {
			return fmt.Errorf("Error reading link_down_failover: %v", err)
		}
	}

	if err = d.Set("stale_route", flattenRouterbgpNeighborStaleRoute(o["stale-route"], d, "stale_route")); err != nil {
		if !fortiAPIPatch(o["stale-route"]) {
			return fmt.Errorf("Error reading stale_route: %v", err)
		}
	}

	if err = d.Set("next_hop_self", flattenRouterbgpNeighborNextHopSelf(o["next-hop-self"], d, "next_hop_self")); err != nil {
		if !fortiAPIPatch(o["next-hop-self"]) {
			return fmt.Errorf("Error reading next_hop_self: %v", err)
		}
	}

	if err = d.Set("next_hop_self6", flattenRouterbgpNeighborNextHopSelf6(o["next-hop-self6"], d, "next_hop_self6")); err != nil {
		if !fortiAPIPatch(o["next-hop-self6"]) {
			return fmt.Errorf("Error reading next_hop_self6: %v", err)
		}
	}

	if err = d.Set("override_capability", flattenRouterbgpNeighborOverrideCapability(o["override-capability"], d, "override_capability")); err != nil {
		if !fortiAPIPatch(o["override-capability"]) {
			return fmt.Errorf("Error reading override_capability: %v", err)
		}
	}

	if err = d.Set("passive", flattenRouterbgpNeighborPassive(o["passive"], d, "passive")); err != nil {
		if !fortiAPIPatch(o["passive"]) {
			return fmt.Errorf("Error reading passive: %v", err)
		}
	}

	if err = d.Set("remove_private_as", flattenRouterbgpNeighborRemovePrivateAs(o["remove-private-as"], d, "remove_private_as")); err != nil {
		if !fortiAPIPatch(o["remove-private-as"]) {
			return fmt.Errorf("Error reading remove_private_as: %v", err)
		}
	}

	if err = d.Set("remove_private_as6", flattenRouterbgpNeighborRemovePrivateAs6(o["remove-private-as6"], d, "remove_private_as6")); err != nil {
		if !fortiAPIPatch(o["remove-private-as6"]) {
			return fmt.Errorf("Error reading remove_private_as6: %v", err)
		}
	}

	if err = d.Set("route_reflector_client", flattenRouterbgpNeighborRouteReflectorClient(o["route-reflector-client"], d, "route_reflector_client")); err != nil {
		if !fortiAPIPatch(o["route-reflector-client"]) {
			return fmt.Errorf("Error reading route_reflector_client: %v", err)
		}
	}

	if err = d.Set("route_reflector_client6", flattenRouterbgpNeighborRouteReflectorClient6(o["route-reflector-client6"], d, "route_reflector_client6")); err != nil {
		if !fortiAPIPatch(o["route-reflector-client6"]) {
			return fmt.Errorf("Error reading route_reflector_client6: %v", err)
		}
	}

	if err = d.Set("route_server_client", flattenRouterbgpNeighborRouteServerClient(o["route-server-client"], d, "route_server_client")); err != nil {
		if !fortiAPIPatch(o["route-server-client"]) {
			return fmt.Errorf("Error reading route_server_client: %v", err)
		}
	}

	if err = d.Set("route_server_client6", flattenRouterbgpNeighborRouteServerClient6(o["route-server-client6"], d, "route_server_client6")); err != nil {
		if !fortiAPIPatch(o["route-server-client6"]) {
			return fmt.Errorf("Error reading route_server_client6: %v", err)
		}
	}

	if err = d.Set("shutdown", flattenRouterbgpNeighborShutdown(o["shutdown"], d, "shutdown")); err != nil {
		if !fortiAPIPatch(o["shutdown"]) {
			return fmt.Errorf("Error reading shutdown: %v", err)
		}
	}

	if err = d.Set("soft_reconfiguration", flattenRouterbgpNeighborSoftReconfiguration(o["soft-reconfiguration"], d, "soft_reconfiguration")); err != nil {
		if !fortiAPIPatch(o["soft-reconfiguration"]) {
			return fmt.Errorf("Error reading soft_reconfiguration: %v", err)
		}
	}

	if err = d.Set("soft_reconfiguration6", flattenRouterbgpNeighborSoftReconfiguration6(o["soft-reconfiguration6"], d, "soft_reconfiguration6")); err != nil {
		if !fortiAPIPatch(o["soft-reconfiguration6"]) {
			return fmt.Errorf("Error reading soft_reconfiguration6: %v", err)
		}
	}

	if err = d.Set("as_override", flattenRouterbgpNeighborAsOverride(o["as-override"], d, "as_override")); err != nil {
		if !fortiAPIPatch(o["as-override"]) {
			return fmt.Errorf("Error reading as_override: %v", err)
		}
	}

	if err = d.Set("as_override6", flattenRouterbgpNeighborAsOverride6(o["as-override6"], d, "as_override6")); err != nil {
		if !fortiAPIPatch(o["as-override6"]) {
			return fmt.Errorf("Error reading as_override6: %v", err)
		}
	}

	if err = d.Set("strict_capability_match", flattenRouterbgpNeighborStrictCapabilityMatch(o["strict-capability-match"], d, "strict_capability_match")); err != nil {
		if !fortiAPIPatch(o["strict-capability-match"]) {
			return fmt.Errorf("Error reading strict_capability_match: %v", err)
		}
	}

	if err = d.Set("default_originate_routemap", flattenRouterbgpNeighborDefaultOriginateRoutemap(o["default-originate-routemap"], d, "default_originate_routemap")); err != nil {
		if !fortiAPIPatch(o["default-originate-routemap"]) {
			return fmt.Errorf("Error reading default_originate_routemap: %v", err)
		}
	}

	if err = d.Set("default_originate_routemap6", flattenRouterbgpNeighborDefaultOriginateRoutemap6(o["default-originate-routemap6"], d, "default_originate_routemap6")); err != nil {
		if !fortiAPIPatch(o["default-originate-routemap6"]) {
			return fmt.Errorf("Error reading default_originate_routemap6: %v", err)
		}
	}

	if err = d.Set("description", flattenRouterbgpNeighborDescription(o["description"], d, "description")); err != nil {
		if !fortiAPIPatch(o["description"]) {
			return fmt.Errorf("Error reading description: %v", err)
		}
	}

	if err = d.Set("distribute_list_in", flattenRouterbgpNeighborDistributeListIn(o["distribute-list-in"], d, "distribute_list_in")); err != nil {
		if !fortiAPIPatch(o["distribute-list-in"]) {
			return fmt.Errorf("Error reading distribute_list_in: %v", err)
		}
	}

	if err = d.Set("distribute_list_in6", flattenRouterbgpNeighborDistributeListIn6(o["distribute-list-in6"], d, "distribute_list_in6")); err != nil {
		if !fortiAPIPatch(o["distribute-list-in6"]) {
			return fmt.Errorf("Error reading distribute_list_in6: %v", err)
		}
	}

	if err = d.Set("distribute_list_out", flattenRouterbgpNeighborDistributeListOut(o["distribute-list-out"], d, "distribute_list_out")); err != nil {
		if !fortiAPIPatch(o["distribute-list-out"]) {
			return fmt.Errorf("Error reading distribute_list_out: %v", err)
		}
	}

	if err = d.Set("distribute_list_out6", flattenRouterbgpNeighborDistributeListOut6(o["distribute-list-out6"], d, "distribute_list_out6")); err != nil {
		if !fortiAPIPatch(o["distribute-list-out6"]) {
			return fmt.Errorf("Error reading distribute_list_out6: %v", err)
		}
	}

	if err = d.Set("ebgp_multihop_ttl", flattenRouterbgpNeighborEbgpMultihopTtl(o["ebgp-multihop-ttl"], d, "ebgp_multihop_ttl")); err != nil {
		if !fortiAPIPatch(o["ebgp-multihop-ttl"]) {
			return fmt.Errorf("Error reading ebgp_multihop_ttl: %v", err)
		}
	}

	if err = d.Set("filter_list_in", flattenRouterbgpNeighborFilterListIn(o["filter-list-in"], d, "filter_list_in")); err != nil {
		if !fortiAPIPatch(o["filter-list-in"]) {
			return fmt.Errorf("Error reading filter_list_in: %v", err)
		}
	}

	if err = d.Set("filter_list_in6", flattenRouterbgpNeighborFilterListIn6(o["filter-list-in6"], d, "filter_list_in6")); err != nil {
		if !fortiAPIPatch(o["filter-list-in6"]) {
			return fmt.Errorf("Error reading filter_list_in6: %v", err)
		}
	}

	if err = d.Set("filter_list_out", flattenRouterbgpNeighborFilterListOut(o["filter-list-out"], d, "filter_list_out")); err != nil {
		if !fortiAPIPatch(o["filter-list-out"]) {
			return fmt.Errorf("Error reading filter_list_out: %v", err)
		}
	}

	if err = d.Set("filter_list_out6", flattenRouterbgpNeighborFilterListOut6(o["filter-list-out6"], d, "filter_list_out6")); err != nil {
		if !fortiAPIPatch(o["filter-list-out6"]) {
			return fmt.Errorf("Error reading filter_list_out6: %v", err)
		}
	}

	if err = d.Set("interface", flattenRouterbgpNeighborInterface(o["interface"], d, "interface")); err != nil {
		if !fortiAPIPatch(o["interface"]) {
			return fmt.Errorf("Error reading interface: %v", err)
		}
	}

	if err = d.Set("maximum_prefix", flattenRouterbgpNeighborMaximumPrefix(o["maximum-prefix"], d, "maximum_prefix")); err != nil {
		if !fortiAPIPatch(o["maximum-prefix"]) {
			return fmt.Errorf("Error reading maximum_prefix: %v", err)
		}
	}

	if err = d.Set("maximum_prefix6", flattenRouterbgpNeighborMaximumPrefix6(o["maximum-prefix6"], d, "maximum_prefix6")); err != nil {
		if !fortiAPIPatch(o["maximum-prefix6"]) {
			return fmt.Errorf("Error reading maximum_prefix6: %v", err)
		}
	}

	if err = d.Set("maximum_prefix_threshold", flattenRouterbgpNeighborMaximumPrefixThreshold(o["maximum-prefix-threshold"], d, "maximum_prefix_threshold")); err != nil {
		if !fortiAPIPatch(o["maximum-prefix-threshold"]) {
			return fmt.Errorf("Error reading maximum_prefix_threshold: %v", err)
		}
	}

	if err = d.Set("maximum_prefix_threshold6", flattenRouterbgpNeighborMaximumPrefixThreshold6(o["maximum-prefix-threshold6"], d, "maximum_prefix_threshold6")); err != nil {
		if !fortiAPIPatch(o["maximum-prefix-threshold6"]) {
			return fmt.Errorf("Error reading maximum_prefix_threshold6: %v", err)
		}
	}

	if err = d.Set("maximum_prefix_warning_only", flattenRouterbgpNeighborMaximumPrefixWarningOnly(o["maximum-prefix-warning-only"], d, "maximum_prefix_warning_only")); err != nil {
		if !fortiAPIPatch(o["maximum-prefix-warning-only"]) {
			return fmt.Errorf("Error reading maximum_prefix_warning_only: %v", err)
		}
	}

	if err = d.Set("maximum_prefix_warning_only6", flattenRouterbgpNeighborMaximumPrefixWarningOnly6(o["maximum-prefix-warning-only6"], d, "maximum_prefix_warning_only6")); err != nil {
		if !fortiAPIPatch(o["maximum-prefix-warning-only6"]) {
			return fmt.Errorf("Error reading maximum_prefix_warning_only6: %v", err)
		}
	}

	if err = d.Set("prefix_list_in", flattenRouterbgpNeighborPrefixListIn(o["prefix-list-in"], d, "prefix_list_in")); err != nil {
		if !fortiAPIPatch(o["prefix-list-in"]) {
			return fmt.Errorf("Error reading prefix_list_in: %v", err)
		}
	}

	if err = d.Set("prefix_list_in6", flattenRouterbgpNeighborPrefixListIn6(o["prefix-list-in6"], d, "prefix_list_in6")); err != nil {
		if !fortiAPIPatch(o["prefix-list-in6"]) {
			return fmt.Errorf("Error reading prefix_list_in6: %v", err)
		}
	}

	if err = d.Set("prefix_list_out", flattenRouterbgpNeighborPrefixListOut(o["prefix-list-out"], d, "prefix_list_out")); err != nil {
		if !fortiAPIPatch(o["prefix-list-out"]) {
			return fmt.Errorf("Error reading prefix_list_out: %v", err)
		}
	}

	if err = d.Set("prefix_list_out6", flattenRouterbgpNeighborPrefixListOut6(o["prefix-list-out6"], d, "prefix_list_out6")); err != nil {
		if !fortiAPIPatch(o["prefix-list-out6"]) {
			return fmt.Errorf("Error reading prefix_list_out6: %v", err)
		}
	}

	if err = d.Set("remote_as", flattenRouterbgpNeighborRemoteAs(o["remote-as"], d, "remote_as")); err != nil {
		if !fortiAPIPatch(o["remote-as"]) {
			return fmt.Errorf("Error reading remote_as: %v", err)
		}
	}

	if err = d.Set("local_as", flattenRouterbgpNeighborLocalAs(o["local-as"], d, "local_as")); err != nil {
		if !fortiAPIPatch(o["local-as"]) {
			return fmt.Errorf("Error reading local_as: %v", err)
		}
	}

	if err = d.Set("local_as_no_prepend", flattenRouterbgpNeighborLocalAsNoPrepend(o["local-as-no-prepend"], d, "local_as_no_prepend")); err != nil {
		if !fortiAPIPatch(o["local-as-no-prepend"]) {
			return fmt.Errorf("Error reading local_as_no_prepend: %v", err)
		}
	}

	if err = d.Set("local_as_replace_as", flattenRouterbgpNeighborLocalAsReplaceAs(o["local-as-replace-as"], d, "local_as_replace_as")); err != nil {
		if !fortiAPIPatch(o["local-as-replace-as"]) {
			return fmt.Errorf("Error reading local_as_replace_as: %v", err)
		}
	}

	if err = d.Set("retain_stale_time", flattenRouterbgpNeighborRetainStaleTime(o["retain-stale-time"], d, "retain_stale_time")); err != nil {
		if !fortiAPIPatch(o["retain-stale-time"]) {
			return fmt.Errorf("Error reading retain_stale_time: %v", err)
		}
	}

	if err = d.Set("route_map_in", flattenRouterbgpNeighborRouteMapIn(o["route-map-in"], d, "route_map_in")); err != nil {
		if !fortiAPIPatch(o["route-map-in"]) {
			return fmt.Errorf("Error reading route_map_in: %v", err)
		}
	}

	if err = d.Set("route_map_in6", flattenRouterbgpNeighborRouteMapIn6(o["route-map-in6"], d, "route_map_in6")); err != nil {
		if !fortiAPIPatch(o["route-map-in6"]) {
			return fmt.Errorf("Error reading route_map_in6: %v", err)
		}
	}

	if err = d.Set("route_map_out", flattenRouterbgpNeighborRouteMapOut(o["route-map-out"], d, "route_map_out")); err != nil {
		if !fortiAPIPatch(o["route-map-out"]) {
			return fmt.Errorf("Error reading route_map_out: %v", err)
		}
	}

	if err = d.Set("route_map_out6", flattenRouterbgpNeighborRouteMapOut6(o["route-map-out6"], d, "route_map_out6")); err != nil {
		if !fortiAPIPatch(o["route-map-out6"]) {
			return fmt.Errorf("Error reading route_map_out6: %v", err)
		}
	}

	if err = d.Set("send_community", flattenRouterbgpNeighborSendCommunity(o["send-community"], d, "send_community")); err != nil {
		if !fortiAPIPatch(o["send-community"]) {
			return fmt.Errorf("Error reading send_community: %v", err)
		}
	}

	if err = d.Set("send_community6", flattenRouterbgpNeighborSendCommunity6(o["send-community6"], d, "send_community6")); err != nil {
		if !fortiAPIPatch(o["send-community6"]) {
			return fmt.Errorf("Error reading send_community6: %v", err)
		}
	}

	if err = d.Set("keep_alive_timer", flattenRouterbgpNeighborKeepAliveTimer(o["keep-alive-timer"], d, "keep_alive_timer")); err != nil {
		if !fortiAPIPatch(o["keep-alive-timer"]) {
			return fmt.Errorf("Error reading keep_alive_timer: %v", err)
		}
	}

	if err = d.Set("holdtime_timer", flattenRouterbgpNeighborHoldtimeTimer(o["holdtime-timer"], d, "holdtime_timer")); err != nil {
		if !fortiAPIPatch(o["holdtime-timer"]) {
			return fmt.Errorf("Error reading holdtime_timer: %v", err)
		}
	}

	if err = d.Set("connect_timer", flattenRouterbgpNeighborConnectTimer(o["connect-timer"], d, "connect_timer")); err != nil {
		if !fortiAPIPatch(o["connect-timer"]) {
			return fmt.Errorf("Error reading connect_timer: %v", err)
		}
	}

	if err = d.Set("unsuppress_map", flattenRouterbgpNeighborUnsuppressMap(o["unsuppress-map"], d, "unsuppress_map")); err != nil {
		if !fortiAPIPatch(o["unsuppress-map"]) {
			return fmt.Errorf("Error reading unsuppress_map: %v", err)
		}
	}

	if err = d.Set("unsuppress_map6", flattenRouterbgpNeighborUnsuppressMap6(o["unsuppress-map6"], d, "unsuppress_map6")); err != nil {
		if !fortiAPIPatch(o["unsuppress-map6"]) {
			return fmt.Errorf("Error reading unsuppress_map6: %v", err)
		}
	}

	if err = d.Set("update_source", flattenRouterbgpNeighborUpdateSource(o["update-source"], d, "update_source")); err != nil {
		if !fortiAPIPatch(o["update-source"]) {
			return fmt.Errorf("Error reading update_source: %v", err)
		}
	}

	if err = d.Set("weight", flattenRouterbgpNeighborWeight(o["weight"], d, "weight")); err != nil {
		if !fortiAPIPatch(o["weight"]) {
			return fmt.Errorf("Error reading weight: %v", err)
		}
	}

	if err = d.Set("restart_time", flattenRouterbgpNeighborRestartTime(o["restart-time"], d, "restart_time")); err != nil {
		if !fortiAPIPatch(o["restart-time"]) {
			return fmt.Errorf("Error reading restart_time: %v", err)
		}
	}

	if err = d.Set("additional_path", flattenRouterbgpNeighborAdditionalPath(o["additional-path"], d, "additional_path")); err != nil {
		if !fortiAPIPatch(o["additional-path"]) {
			return fmt.Errorf("Error reading additional_path: %v", err)
		}
	}

	if err = d.Set("additional_path6", flattenRouterbgpNeighborAdditionalPath6(o["additional-path6"], d, "additional_path6")); err != nil {
		if !fortiAPIPatch(o["additional-path6"]) {
			return fmt.Errorf("Error reading additional_path6: %v", err)
		}
	}

	if err = d.Set("adv_additional_path", flattenRouterbgpNeighborAdvAdditionalPath(o["adv-additional-path"], d, "adv_additional_path")); err != nil {
		if !fortiAPIPatch(o["adv-additional-path"]) {
			return fmt.Errorf("Error reading adv_additional_path: %v", err)
		}
	}

	if err = d.Set("adv_additional_path6", flattenRouterbgpNeighborAdvAdditionalPath6(o["adv-additional-path6"], d, "adv_additional_path6")); err != nil {
		if !fortiAPIPatch(o["adv-additional-path6"]) {
			return fmt.Errorf("Error reading adv_additional_path6: %v", err)
		}
	}

	if err = d.Set("password", flattenRouterbgpNeighborPassword(o["password"], d, "password")); err != nil {
	...
	if isImportTable() {
		if err = d.Set("conditional_advertise", flattenRouterbgpNeighborConditionalAdvertise(o["conditional-advertise"], d, "conditional_advertise")); err != nil {
...
func getObjectRouterbgpNeighbor(d *schema.ResourceData) (*map[string]interface{}, error) {
	...
	if v, ok := d.GetOk("ip"); ok {
		t, err := expandRouterbgpNeighborIp(d, v, "ip")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["ip"] = t
	...
	if v, ok := d.GetOk("advertisement_interval"); ok {
		t, err := expandRouterbgpNeighborAdvertisementInterval(d, v, "advertisement_interval")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("allowas_in_enable"); ok {
		t, err := expandRouterbgpNeighborAllowasInEnable(d, v, "allowas_in_enable")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("allowas_in_enable6"); ok {
		t, err := expandRouterbgpNeighborAllowasInEnable6(d, v, "allowas_in_enable6")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("allowas_in"); ok {
		t, err := expandRouterbgpNeighborAllowasIn(d, v, "allowas_in")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["allowas-in"] = t
	...
	if v, ok := d.GetOk("allowas_in6"); ok {
		t, err := expandRouterbgpNeighborAllowasIn6(d, v, "allowas_in6")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["allowas-in6"] = t
	...
	if v, ok := d.GetOk("attribute_unchanged"); ok {
		t, err := expandRouterbgpNeighborAttributeUnchanged(d, v, "attribute_unchanged")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("attribute_unchanged6"); ok {
		t, err := expandRouterbgpNeighborAttributeUnchanged6(d, v, "attribute_unchanged6")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("activate"); ok {
		t, err := expandRouterbgpNeighborActivate(d, v, "activate")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["activate"] = t
	...
	if v, ok := d.GetOk("activate6"); ok {
		t, err := expandRouterbgpNeighborActivate6(d, v, "activate6")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["activate6"] = t
	...
	if v, ok := d.GetOk("bfd"); ok {
		t, err := expandRouterbgpNeighborBfd(d, v, "bfd")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["bfd"] = t
	...
	if v, ok := d.GetOk("capability_dynamic"); ok {
		t, err := expandRouterbgpNeighborCapabilityDynamic(d, v, "capability_dynamic")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("capability_orf"); ok {
		t, err := expandRouterbgpNeighborCapabilityOrf(d, v, "capability_orf")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("capability_orf6"); ok {
		t, err := expandRouterbgpNeighborCapabilityOrf6(d, v, "capability_orf6")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("capability_graceful_restart"); ok {
		t, err := expandRouterbgpNeighborCapabilityGracefulRestart(d, v, "capability_graceful_restart")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("capability_graceful_restart6"); ok {
		t, err := expandRouterbgpNeighborCapabilityGracefulRestart6(d, v, "capability_graceful_restart6")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("capability_route_refresh"); ok {
		t, err := expandRouterbgpNeighborCapabilityRouteRefresh(d, v, "capability_route_refresh")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("capability_default_originate"); ok {
		t, err := expandRouterbgpNeighborCapabilityDefaultOriginate(d, v, "capability_default_originate")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("capability_default_originate6"); ok {
		t, err := expandRouterbgpNeighborCapabilityDefaultOriginate6(d, v, "capability_default_originate6")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("dont_capability_negotiate"); ok {
		t, err := expandRouterbgpNeighborDontCapabilityNegotiate(d, v, "dont_capability_negotiate")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("ebgp_enforce_multihop"); ok {
		t, err := expandRouterbgpNeighborEbgpEnforceMultihop(d, v, "ebgp_enforce_multihop")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("link_down_failover"); ok {
		t, err := expandRouterbgpNeighborLinkDownFailover(d, v, "link_down_failover")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("stale_route"); ok {
		t, err := expandRouterbgpNeighborStaleRoute(d, v, "stale_route")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["stale-route"] = t
	...
	if v, ok := d.GetOk("next_hop_self"); ok {
		t, err := expandRouterbgpNeighborNextHopSelf(d, v, "next_hop_self")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["next-hop-self"] = t
	...
	if v, ok := d.GetOk("next_hop_self6"); ok {
		t, err := expandRouterbgpNeighborNextHopSelf6(d, v, "next_hop_self6")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("override_capability"); ok {
		t, err := expandRouterbgpNeighborOverrideCapability(d, v, "override_capability")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("passive"); ok {
		t, err := expandRouterbgpNeighborPassive(d, v, "passive")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["passive"] = t
	...
	if v, ok := d.GetOk("remove_private_as"); ok {
		t, err := expandRouterbgpNeighborRemovePrivateAs(d, v, "remove_private_as")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("remove_private_as6"); ok {
		t, err := expandRouterbgpNeighborRemovePrivateAs6(d, v, "remove_private_as6")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("route_reflector_client"); ok {
		t, err := expandRouterbgpNeighborRouteReflectorClient(d, v, "route_reflector_client")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("route_reflector_client6"); ok {
		t, err := expandRouterbgpNeighborRouteReflectorClient6(d, v, "route_reflector_client6")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("route_server_client"); ok {
		t, err := expandRouterbgpNeighborRouteServerClient(d, v, "route_server_client")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("route_server_client6"); ok {
		t, err := expandRouterbgpNeighborRouteServerClient6(d, v, "route_server_client6")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("shutdown"); ok {
		t, err := expandRouterbgpNeighborShutdown(d, v, "shutdown")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["shutdown"] = t
	...
	if v, ok := d.GetOk("soft_reconfiguration"); ok {
		t, err := expandRouterbgpNeighborSoftReconfiguration(d, v, "soft_reconfiguration")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("soft_reconfiguration6"); ok {
		t, err := expandRouterbgpNeighborSoftReconfiguration6(d, v, "soft_reconfiguration6")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("as_override"); ok {
		t, err := expandRouterbgpNeighborAsOverride(d, v, "as_override")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["as-override"] = t
	...
	if v, ok := d.GetOk("as_override6"); ok {
		t, err := expandRouterbgpNeighborAsOverride6(d, v, "as_override6")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["as-override6"] = t
	...
	if v, ok := d.GetOk("strict_capability_match"); ok {
		t, err := expandRouterbgpNeighborStrictCapabilityMatch(d, v, "strict_capability_match")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("default_originate_routemap"); ok {
		t, err := expandRouterbgpNeighborDefaultOriginateRoutemap(d, v, "default_originate_routemap")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("default_originate_routemap6"); ok {
		t, err := expandRouterbgpNeighborDefaultOriginateRoutemap6(d, v, "default_originate_routemap6")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("description"); ok {
		t, err := expandRouterbgpNeighborDescription(d, v, "description")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["description"] = t
	...
	if v, ok := d.GetOk("distribute_list_in"); ok {
		t, err := expandRouterbgpNeighborDistributeListIn(d, v, "distribute_list_in")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("distribute_list_in6"); ok {
		t, err := expandRouterbgpNeighborDistributeListIn6(d, v, "distribute_list_in6")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("distribute_list_out"); ok {
		t, err := expandRouterbgpNeighborDistributeListOut(d, v, "distribute_list_out")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("distribute_list_out6"); ok {
		t, err := expandRouterbgpNeighborDistributeListOut6(d, v, "distribute_list_out6")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("ebgp_multihop_ttl"); ok {
		t, err := expandRouterbgpNeighborEbgpMultihopTtl(d, v, "ebgp_multihop_ttl")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("filter_list_in"); ok {
		t, err := expandRouterbgpNeighborFilterListIn(d, v, "filter_list_in")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("filter_list_in6"); ok {
		t, err := expandRouterbgpNeighborFilterListIn6(d, v, "filter_list_in6")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("filter_list_out"); ok {
		t, err := expandRouterbgpNeighborFilterListOut(d, v, "filter_list_out")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("filter_list_out6"); ok {
		t, err := expandRouterbgpNeighborFilterListOut6(d, v, "filter_list_out6")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("interface"); ok {
		t, err := expandRouterbgpNeighborInterface(d, v, "interface")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["interface"] = t
	...
	if v, ok := d.GetOk("maximum_prefix"); ok {
		t, err := expandRouterbgpNeighborMaximumPrefix(d, v, "maximum_prefix")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("maximum_prefix6"); ok {
		t, err := expandRouterbgpNeighborMaximumPrefix6(d, v, "maximum_prefix6")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("maximum_prefix_threshold"); ok {
		t, err := expandRouterbgpNeighborMaximumPrefixThreshold(d, v, "maximum_prefix_threshold")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("maximum_prefix_threshold6"); ok {
		t, err := expandRouterbgpNeighborMaximumPrefixThreshold6(d, v, "maximum_prefix_threshold6")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("maximum_prefix_warning_only"); ok {
		t, err := expandRouterbgpNeighborMaximumPrefixWarningOnly(d, v, "maximum_prefix_warning_only")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("maximum_prefix_warning_only6"); ok {
		t, err := expandRouterbgpNeighborMaximumPrefixWarningOnly6(d, v, "maximum_prefix_warning_only6")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("prefix_list_in"); ok {
		t, err := expandRouterbgpNeighborPrefixListIn(d, v, "prefix_list_in")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("prefix_list_in6"); ok {
		t, err := expandRouterbgpNeighborPrefixListIn6(d, v, "prefix_list_in6")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("prefix_list_out"); ok {
		t, err := expandRouterbgpNeighborPrefixListOut(d, v, "prefix_list_out")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("prefix_list_out6"); ok {
		t, err := expandRouterbgpNeighborPrefixListOut6(d, v, "prefix_list_out6")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("remote_as"); ok {
		t, err := expandRouterbgpNeighborRemoteAs(d, v, "remote_as")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["remote-as"] = t
	...
	if v, ok := d.GetOkExists("local_as"); ok {
		t, err := expandRouterbgpNeighborLocalAs(d, v, "local_as")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["local-as"] = t
	...
	if v, ok := d.GetOk("local_as_no_prepend"); ok {
		t, err := expandRouterbgpNeighborLocalAsNoPrepend(d, v, "local_as_no_prepend")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("local_as_replace_as"); ok {
		t, err := expandRouterbgpNeighborLocalAsReplaceAs(d, v, "local_as_replace_as")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOkExists("retain_stale_time"); ok {
		t, err := expandRouterbgpNeighborRetainStaleTime(d, v, "retain_stale_time")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("route_map_in"); ok {
		t, err := expandRouterbgpNeighborRouteMapIn(d, v, "route_map_in")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["route-map-in"] = t
	...
	if v, ok := d.GetOk("route_map_in6"); ok {
		t, err := expandRouterbgpNeighborRouteMapIn6(d, v, "route_map_in6")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["route-map-in6"] = t
	...
	if v, ok := d.GetOk("route_map_out"); ok {
		t, err := expandRouterbgpNeighborRouteMapOut(d, v, "route_map_out")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["route-map-out"] = t
	...
	if v, ok := d.GetOk("route_map_out6"); ok {
		t, err := expandRouterbgpNeighborRouteMapOut6(d, v, "route_map_out6")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("send_community"); ok {
		t, err := expandRouterbgpNeighborSendCommunity(d, v, "send_community")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("send_community6"); ok {
		t, err := expandRouterbgpNeighborSendCommunity6(d, v, "send_community6")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOkExists("keep_alive_timer"); ok {
		t, err := expandRouterbgpNeighborKeepAliveTimer(d, v, "keep_alive_timer")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("holdtime_timer"); ok {
		t, err := expandRouterbgpNeighborHoldtimeTimer(d, v, "holdtime_timer")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOkExists("connect_timer"); ok {
		t, err := expandRouterbgpNeighborConnectTimer(d, v, "connect_timer")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["connect-timer"] = t
	...
	if v, ok := d.GetOk("unsuppress_map"); ok {
		t, err := expandRouterbgpNeighborUnsuppressMap(d, v, "unsuppress_map")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("unsuppress_map6"); ok {
		t, err := expandRouterbgpNeighborUnsuppressMap6(d, v, "unsuppress_map6")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("update_source"); ok {
		t, err := expandRouterbgpNeighborUpdateSource(d, v, "update_source")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["update-source"] = t
	...
	if v, ok := d.GetOkExists("weight"); ok {
		t, err := expandRouterbgpNeighborWeight(d, v, "weight")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["weight"] = t
	...
	if v, ok := d.GetOkExists("restart_time"); ok {
		t, err := expandRouterbgpNeighborRestartTime(d, v, "restart_time")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["restart-time"] = t
	...
	if v, ok := d.GetOk("additional_path"); ok {
		t, err := expandRouterbgpNeighborAdditionalPath(d, v, "additional_path")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("additional_path6"); ok {
		t, err := expandRouterbgpNeighborAdditionalPath6(d, v, "additional_path6")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("adv_additional_path"); ok {
		t, err := expandRouterbgpNeighborAdvAdditionalPath(d, v, "adv_additional_path")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("adv_additional_path6"); ok {
		t, err := expandRouterbgpNeighborAdvAdditionalPath6(d, v, "adv_additional_path6")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("password"); ok {
		t, err := expandRouterbgpNeighborPassword(d, v, "password")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["password"] = t
	...
	if v, ok := d.GetOk("conditional_advertise"); ok {
		t, err := expandRouterbgpNeighborConditionalAdvertise(d, v, "conditional_advertise")
		if err != nil {
			return &obj, err
		} else if t != nil {
