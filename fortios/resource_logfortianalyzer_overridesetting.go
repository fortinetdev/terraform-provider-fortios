...
func flattenLogFortianalyzerOverrideSettingSerial(v interface{}, d *schema.ResourceData, pre string, sv string) []map[string]interface{} {
	...
	for _, r := range l {
		...
		if cur_v, ok := i["name"]; ok {
			tmp["name"] = flattenLogFortianalyzerOverrideSettingSerialName(cur_v, d, pre_append, sv)
		}
...
func flattenLogFortianalyzerOverrideSettingServerCertCa(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func refreshObjectLogFortianalyzerOverrideSetting(d *schema.ResourceData, o map[string]interface{}, sv string) error {
	...
	if err = d.Set("server_cert_ca", flattenLogFortianalyzerOverrideSettingServerCertCa(o["server-cert-ca"], d, "server_cert_ca", sv)); err != nil {
	...
	if err = d.Set("__change_ip", flattenLogFortianalyzerOverrideSettingChangeIp(o["__change_ip"], d, "__change_ip", sv)); err != nil {
...
func expandLogFortianalyzerOverrideSettingServerCertCa(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func expandLogFortianalyzerOverrideSettingChangeIp(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func getObjectLogFortianalyzerOverrideSetting(d *schema.ResourceData, setArgNil bool, sv string) (*map[string]interface{}, error) {
	...
	if v, ok := d.GetOk("server_cert_ca"); ok {
		if setArgNil {
			...
			t, err := expandLogFortianalyzerOverrideSettingServerCertCa(d, v, "server_cert_ca", sv)
			if err != nil {
				return &obj, err
			} else if t != nil {
	...
	if v, ok := d.GetOkExists("__change_ip"); ok {
		if setArgNil {
			...
			t, err := expandLogFortianalyzerOverrideSettingChangeIp(d, v, "__change_ip", sv)
			if err != nil {
				return &obj, err
			} else if t != nil {
				obj["__change_ip"] = t
