...
func resourceVpnIpsecPhase1InterfaceCreate(d *schema.ResourceData, m interface{}) error {
	...
	return readBackAfterCreate(d, "VpnIpsecPhase1Interface", mkey,
		func() (map[string]interface{}, error) { return c.ReadVpnIpsecPhase1Interface(mkey, vdomparam) },
		refreshObjectVpnIpsecPhase1Interface, c.Fv)
}
...
func flattenVpnIpsecPhase1InterfaceInternalDomainList(v interface{}, d *schema.ResourceData, pre string, sv string) []map[string]interface{} {
	...
	parsed_list := mergeBlock(tf_list, l, "domain-name", "domain_name")
...
func flattenVpnIpsecPhase1InterfaceDnsSuffixSearch(v interface{}, d *schema.ResourceData, pre string, sv string) []map[string]interface{} {
	...
	parsed_list := mergeBlock(tf_list, l, "dns-suffix", "dns_suffix")
