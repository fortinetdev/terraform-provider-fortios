...
func flattenLogFortianalyzer2FilterHttpTransaction(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func flattenLogFortianalyzer2FilterFortiSwitch(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}

func flattenLogFortianalyzer2FilterDebug(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func flattenLogFortianalyzer2FilterFreeStyle(v interface{}, d *schema.ResourceData, pre string, sv string) []map[string]interface{} {
	...
	for _, r := range l {
		...
		if cur_v, ok := i["id"]; ok {
			tmp["id"] = flattenLogFortianalyzer2FilterFreeStyleId(cur_v, d, pre_append, sv)
		}

		pre_append = pre + "." + strconv.Itoa(con) + "." + "category"
		if cur_v, ok := i["category"]; ok {
			tmp["category"] = flattenLogFortianalyzer2FilterFreeStyleCategory(cur_v, d, pre_append, sv)
		}

		pre_append = pre + "." + strconv.Itoa(con) + "." + "filter"
		if cur_v, ok := i["filter"]; ok {
			tmp["filter"] = flattenLogFortianalyzer2FilterFreeStyleFilter(cur_v, d, pre_append, sv)
		}

		pre_append = pre + "." + strconv.Itoa(con) + "." + "filter_type"
		if cur_v, ok := i["filter-type"]; ok {
			tmp["filter_type"] = flattenLogFortianalyzer2FilterFreeStyleFilterType(cur_v, d, pre_append, sv)
		}
...
func refreshObjectLogFortianalyzer2Filter(d *schema.ResourceData, o map[string]interface{}, sv string) error {
	...
	if err = d.Set("http_transaction", flattenLogFortianalyzer2FilterHttpTransaction(o["http-transaction"], d, "http_transaction", sv)); err != nil {
	...
	if err = d.Set("forti_switch", flattenLogFortianalyzer2FilterFortiSwitch(o["forti-switch"], d, "forti_switch", sv)); err != nil {
		if !fortiAPIPatch(o["forti-switch"]) {
			return fmt.Errorf("Error reading forti_switch: %v", err)
		}
	}

	if err = d.Set("debug", flattenLogFortianalyzer2FilterDebug(o["debug"], d, "debug", sv)); err != nil {
...
func expandLogFortianalyzer2FilterHttpTransaction(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func expandLogFortianalyzer2FilterFortiSwitch(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandLogFortianalyzer2FilterDebug(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func getObjectLogFortianalyzer2Filter(d *schema.ResourceData, setArgNil bool, sv string) (*map[string]interface{}, error) {
	...
	if v, ok := d.GetOk("http_transaction"); ok {
		if setArgNil {
			...
			t, err := expandLogFortianalyzer2FilterHttpTransaction(d, v, "http_transaction", sv)
			if err != nil {
				return &obj, err
			} else if t != nil {
	...
	if v, ok := d.GetOk("forti_switch"); ok {
		if setArgNil {
			...
			t, err := expandLogFortianalyzer2FilterFortiSwitch(d, v, "forti_switch", sv)
			if err != nil {
				return &obj, err
			} else if t != nil {
				obj["forti-switch"] = t
	...
	if v, ok := d.GetOk("debug"); ok {
		if setArgNil {
			...
			t, err := expandLogFortianalyzer2FilterDebug(d, v, "debug", sv)
			if err != nil {
				return &obj, err
			} else if t != nil {
				obj["debug"] = t
