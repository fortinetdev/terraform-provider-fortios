...
func resourceWirelessControllerHotspot20H2QpTermsAndConditionsCreate(d *schema.ResourceData, m interface{}) error {
	...
	obj, err := getObjectWirelessControllerHotspot20H2QpTermsAndConditions(d, c.Fv)
	if err != nil {
		return fmt.Errorf("Error creating WirelessControllerHotspot20H2QpTermsAndConditions resource while getting object: %v", err)
	}

	o, err := c.CreateWirelessControllerHotspot20H2QpTermsAndConditions(obj, vdomparam)
...
func resourceWirelessControllerHotspot20H2QpTermsAndConditionsUpdate(d *schema.ResourceData, m interface{}) error {
	...
	o, err := c.UpdateWirelessControllerHotspot20H2QpTermsAndConditions(obj, mkey, vdomparam)
	if err != nil {
...
func resourceWirelessControllerHotspot20H2QpTermsAndConditionsDelete(d *schema.ResourceData, m interface{}) error {
	...
	err := c.DeleteWirelessControllerHotspot20H2QpTermsAndConditions(mkey, vdomparam)
	if err != nil {
...
func resourceWirelessControllerHotspot20H2QpTermsAndConditionsRead(d *schema.ResourceData, m interface{}) error {
	...
	o, err := c.ReadWirelessControllerHotspot20H2QpTermsAndConditions(mkey, vdomparam)
	if err != nil {
	...
	err = refreshObjectWirelessControllerHotspot20H2QpTermsAndConditions(d, o, c.Fv)
	if err != nil {
...
func flattenWirelessControllerHotspot20H2QpTermsAndConditionsName(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}

func flattenWirelessControllerHotspot20H2QpTermsAndConditionsFilename(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func refreshObjectWirelessControllerHotspot20H2QpTermsAndConditions(d *schema.ResourceData, o map[string]interface{}, sv string) error {
	var err error

	if err = d.Set("name", flattenWirelessControllerHotspot20H2QpTermsAndConditionsName(o["name"], d, "name", sv)); err != nil {
		if !fortiAPIPatch(o["name"]) {
			return fmt.Errorf("Error reading name: %v", err)
		}
	}

	if err = d.Set("filename", flattenWirelessControllerHotspot20H2QpTermsAndConditionsFilename(o["filename"], d, "filename", sv)); err != nil {
		if !fortiAPIPatch(o["filename"]) {
			return fmt.Errorf("Error reading filename: %v", err)
		}
	}

	if err = d.Set("timestamp", flattenWirelessControllerHotspot20H2QpTermsAndConditionsTimestamp(o["timestamp"], d, "timestamp", sv)); err != nil {
		if !fortiAPIPatch(o["timestamp"]) {
			return fmt.Errorf("Error reading timestamp: %v", err)
		}
	}

	if err = d.Set("url", flattenWirelessControllerHotspot20H2QpTermsAndConditionsUrl(o["url"], d, "url", sv)); err != nil {
...
func expandWirelessControllerHotspot20H2QpTermsAndConditionsName(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerHotspot20H2QpTermsAndConditionsFilename(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerHotspot20H2QpTermsAndConditionsTimestamp(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerHotspot20H2QpTermsAndConditionsUrl(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func getObjectWirelessControllerHotspot20H2QpTermsAndConditions(d *schema.ResourceData, sv string) (*map[string]interface{}, error) {
