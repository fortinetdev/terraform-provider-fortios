...
func flattenLogSyslogdOverrideSettingUseManagementVdom(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func flattenLogSyslogdOverrideSettingSourceIpInterface(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func refreshObjectLogSyslogdOverrideSetting(d *schema.ResourceData, o map[string]interface{}, sv string) error {
	...
	if err = d.Set("use_management_vdom", flattenLogSyslogdOverrideSettingUseManagementVdom(o["use-management-vdom"], d, "use_management_vdom", sv)); err != nil {
	...
	if err = d.Set("source_ip_interface", flattenLogSyslogdOverrideSettingSourceIpInterface(o["source-ip-interface"], d, "source_ip_interface", sv)); err != nil {
...
func expandLogSyslogdOverrideSettingUseManagementVdom(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func expandLogSyslogdOverrideSettingSourceIpInterface(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func getObjectLogSyslogdOverrideSetting(d *schema.ResourceData, setArgNil bool, sv string) (*map[string]interface{}, error) {
	...
	if v, ok := d.GetOk("use_management_vdom"); ok {
		if setArgNil {
			...
			t, err := expandLogSyslogdOverrideSettingUseManagementVdom(d, v, "use_management_vdom", sv)
			if err != nil {
				return &obj, err
			} else if t != nil {
	...
	if v, ok := d.GetOk("source_ip_interface"); ok {
		if setArgNil {
			...
			t, err := expandLogSyslogdOverrideSettingSourceIpInterface(d, v, "source_ip_interface", sv)
			if err != nil {
				return &obj, err
			} else if t != nil {
