...
func flattenLogFortiguardOverrideFilterHttpTransaction(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func flattenLogFortiguardOverrideFilterFortiSwitch(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}

func flattenLogFortiguardOverrideFilterDebug(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func flattenLogFortiguardOverrideFilterFreeStyle(v interface{}, d *schema.ResourceData, pre string, sv string) []map[string]interface{} {
	...
	for _, r := range parsed_list {
		...
		if cur_v, ok := i["id"]; ok {
			...
			tmp["id"] = flattenLogFortiguardOverrideFilterFreeStyleId(cur_v, d, pre_append, sv)
		}
		...
		if cur_v, ok := i["category"]; ok {
			...
			tmp["category"] = flattenLogFortiguardOverrideFilterFreeStyleCategory(cur_v, d, pre_append, sv)
		}
		...
		if cur_v, ok := i["filter"]; ok {
			...
			tmp["filter"] = flattenLogFortiguardOverrideFilterFreeStyleFilter(cur_v, d, pre_append, sv)
		}
		...
		if cur_v, ok := i["filter-type"]; ok {
			...
			tmp["filter_type"] = flattenLogFortiguardOverrideFilterFreeStyleFilterType(cur_v, d, pre_append, sv)
		}
...
func refreshObjectLogFortiguardOverrideFilter(d *schema.ResourceData, o map[string]interface{}, sv string) error {
	...
	if err = d.Set("http_transaction", flattenLogFortiguardOverrideFilterHttpTransaction(o["http-transaction"], d, "http_transaction", sv)); err != nil {
	...
	if err = d.Set("forti_switch", flattenLogFortiguardOverrideFilterFortiSwitch(o["forti-switch"], d, "forti_switch", sv)); err != nil {
		if !fortiAPIPatch(o["forti-switch"]) {
			return fmt.Errorf("Error reading forti_switch: %v", err)
		}
	}

	if err = d.Set("debug", flattenLogFortiguardOverrideFilterDebug(o["debug"], d, "debug", sv)); err != nil {
...
func expandLogFortiguardOverrideFilterHttpTransaction(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func expandLogFortiguardOverrideFilterFortiSwitch(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandLogFortiguardOverrideFilterDebug(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func getObjectLogFortiguardOverrideFilter(d *schema.ResourceData, setArgNil bool, sv string) (*map[string]interface{}, error) {
	...
	if v, ok := d.GetOk("http_transaction"); ok {
		if setArgNil {
			...
			t, err := expandLogFortiguardOverrideFilterHttpTransaction(d, v, "http_transaction", sv)
			if err != nil {
				return &obj, err
			} else if t != nil {
	...
	if v, ok := d.GetOk("forti_switch"); ok {
		if setArgNil {
			...
			t, err := expandLogFortiguardOverrideFilterFortiSwitch(d, v, "forti_switch", sv)
			if err != nil {
				return &obj, err
			} else if t != nil {
				obj["forti-switch"] = t
	...
	if v, ok := d.GetOk("debug"); ok {
		if setArgNil {
			...
			t, err := expandLogFortiguardOverrideFilterDebug(d, v, "debug", sv)
			if err != nil {
				return &obj, err
			} else if t != nil {
				obj["debug"] = t
