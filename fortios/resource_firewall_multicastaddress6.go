...
func resourceFirewallMulticastAddress6Create(d *schema.ResourceData, m interface{}) error {
	...
	return readBackAfterCreate(d, "FirewallMulticastAddress6", mkey,
		func() (map[string]interface{}, error) { return c.ReadFirewallMulticastAddress6(mkey, vdomparam) },
		refreshObjectFirewallMulticastAddress6, c.Fv)
}
...
func flattenFirewallMulticastAddress6DisplayWith(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}

func flattenFirewallMulticastAddress6CustomTags(v interface{}, d *schema.ResourceData, pre string, sv string) []map[string]interface{} {
	if v == nil {
		return nil
	}
	...
	for _, r := range parsed_list {
		...
		if cur_v, ok := i["name"]; ok {
			...
			tmp["name"] = flattenFirewallMulticastAddress6CustomTagsName(cur_v, d, pre_append, sv)
		}
...
func flattenFirewallMulticastAddress6CustomTagsName(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func refreshObjectFirewallMulticastAddress6(d *schema.ResourceData, o map[string]interface{}, sv string) error {
	...
	if err = d.Set("display_with", flattenFirewallMulticastAddress6DisplayWith(o["display-with"], d, "display_with", sv)); err != nil {
	...
	if b_get_all_tables {
		if err = d.Set("custom_tags", flattenFirewallMulticastAddress6CustomTags(o["custom-tags"], d, "custom_tags", sv)); err != nil {
...
func expandFirewallMulticastAddress6DisplayWith(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandFirewallMulticastAddress6CustomTags(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	l := v.(*schema.Set).List()
	result := make([]map[string]interface{}, 0, len(l))
	...
	for _, r := range l {
		...
		tmp["name"], _ = expandFirewallMulticastAddress6CustomTagsName(d, i["name"], pre_append, sv)
...
func expandFirewallMulticastAddress6CustomTagsName(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func getObjectFirewallMulticastAddress6(d *schema.ResourceData, sv string) (*map[string]interface{}, error) {
	...
	if v, ok := d.GetOk("display_with"); ok {
		t, err := expandFirewallMulticastAddress6DisplayWith(d, v, "display_with", sv)
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["display-with"] = t
	...
	if v, ok := d.GetOk("custom_tags"); ok || d.HasChange("custom_tags") {
		t, err := expandFirewallMulticastAddress6CustomTags(d, v, "custom_tags", sv)
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["custom-tags"] = t
