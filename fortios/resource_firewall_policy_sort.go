...
func resourceFirewallPolicySortCreateUpdate(d *schema.ResourceData, m interface{}) error {
	...
	err := c.CreateUpdateFirewallPolicySort(sortby, sortdirection, vdomparam, manual_order)
	if err != nil {
...
func resourceFirewallPolicySortRead(d *schema.ResourceData, m interface{}) error {
	...
	sorted, o, err := c.ReadFirewallPolicySort(sortby, sortdirection, vdomparam, manual_order)
	if err != nil {
