...
func resourceFirewallProxypolicySortCreateUpdate(d *schema.ResourceData, m interface{}) error {
	...
	err := c.CreateUpdateFirewallProxypolicySort(sortby, sortdirection, vdomparam, manual_order)
	if err != nil {
...
func resourceFirewallProxypolicySortRead(d *schema.ResourceData, m interface{}) error {
	...
	sorted, o, err := c.ReadFirewallProxypolicySort(sortby, sortdirection, vdomparam, manual_order)
	if err != nil {
