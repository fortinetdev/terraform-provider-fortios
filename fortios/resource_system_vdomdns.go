...
func flattenSystemVdomDnsSourceIpInterface(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func flattenSystemVdomDnsVrfSelect(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return convintf2i(v)
}
...
func refreshObjectSystemVdomDns(d *schema.ResourceData, o map[string]interface{}, sv string) error {
	...
	if err = d.Set("source_ip_interface", flattenSystemVdomDnsSourceIpInterface(o["source-ip-interface"], d, "source_ip_interface", sv)); err != nil {
	...
	if err = d.Set("vrf_select", flattenSystemVdomDnsVrfSelect(o["vrf-select"], d, "vrf_select", sv)); err != nil {
...
func expandSystemVdomDnsSourceIpInterface(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func expandSystemVdomDnsVrfSelect(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func getObjectSystemVdomDns(d *schema.ResourceData, setArgNil bool, sv string) (*map[string]interface{}, error) {
	...
	if v, ok := d.GetOk("source_ip_interface"); ok {
		if setArgNil {
			...
			t, err := expandSystemVdomDnsSourceIpInterface(d, v, "source_ip_interface", sv)
			if err != nil {
				return &obj, err
			} else if t != nil {
	...
	if v, ok := d.GetOkExists("vrf_select"); ok {
		if setArgNil {
			...
			t, err := expandSystemVdomDnsVrfSelect(d, v, "vrf_select", sv)
			if err != nil {
				return &obj, err
			} else if t != nil {
				obj["vrf-select"] = t
