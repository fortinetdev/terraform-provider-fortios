...
func resourceFirewallInterfacePolicyCreate(d *schema.ResourceData, m interface{}) error {
	...
	return readBackAfterCreate(d, "FirewallInterfacePolicy", mkey,
		func() (map[string]interface{}, error) { return c.ReadFirewallInterfacePolicy(mkey, vdomparam) },
		refreshObjectFirewallInterfacePolicy, c.Fv)
}
...
func flattenFirewallInterfacePolicyUuid(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func flattenFirewallInterfacePolicySrcaddr(v interface{}, d *schema.ResourceData, pre string, sv string) []map[string]interface{} {
	...
	for _, r := range parsed_list {
		...
		if cur_v, ok := i["name"]; ok {
			...
			tmp["name"] = flattenFirewallInterfacePolicySrcaddrName(cur_v, d, pre_append, sv)
		}
...
func flattenFirewallInterfacePolicyDstaddr(v interface{}, d *schema.ResourceData, pre string, sv string) []map[string]interface{} {
	...
	for _, r := range parsed_list {
		...
		if cur_v, ok := i["name"]; ok {
			...
			tmp["name"] = flattenFirewallInterfacePolicyDstaddrName(cur_v, d, pre_append, sv)
		}
...
func flattenFirewallInterfacePolicyService(v interface{}, d *schema.ResourceData, pre string, sv string) []map[string]interface{} {
	...
	for _, r := range parsed_list {
		...
		if cur_v, ok := i["name"]; ok {
			...
			tmp["name"] = flattenFirewallInterfacePolicyServiceName(cur_v, d, pre_append, sv)
		}
...
func refreshObjectFirewallInterfacePolicy(d *schema.ResourceData, o map[string]interface{}, sv string) error {
	...
	if err = d.Set("uuid", flattenFirewallInterfacePolicyUuid(o["uuid"], d, "uuid", sv)); err != nil {
...
func expandFirewallInterfacePolicyUuid(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func getObjectFirewallInterfacePolicy(d *schema.ResourceData, sv string) (*map[string]interface{}, error) {
	...
	if v, ok := d.GetOk("uuid"); ok {
		t, err := expandFirewallInterfacePolicyUuid(d, v, "uuid", sv)
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["uuid"] = t
