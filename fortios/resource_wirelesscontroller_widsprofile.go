...
func flattenWirelessControllerWidsProfileApBgscanDisableDay(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenWirelessControllerWidsProfileApBgscanDisableStart(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenWirelessControllerWidsProfileApBgscanDisableEnd(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func refreshObjectWirelessControllerWidsProfile(d *schema.ResourceData, o map[string]interface{}) error {
	...
	if err = d.Set("ap_bgscan_disable_day", flattenWirelessControllerWidsProfileApBgscanDisableDay(o["ap-bgscan-disable-day"], d, "ap_bgscan_disable_day")); err != nil {
		if !fortiAPIPatch(o["ap-bgscan-disable-day"]) {
			return fmt.Errorf("Error reading ap_bgscan_disable_day: %v", err)
		}
	}

	if err = d.Set("ap_bgscan_disable_start", flattenWirelessControllerWidsProfileApBgscanDisableStart(o["ap-bgscan-disable-start"], d, "ap_bgscan_disable_start")); err != nil {
		if !fortiAPIPatch(o["ap-bgscan-disable-start"]) {
			return fmt.Errorf("Error reading ap_bgscan_disable_start: %v", err)
		}
	}

	if err = d.Set("ap_bgscan_disable_end", flattenWirelessControllerWidsProfileApBgscanDisableEnd(o["ap-bgscan-disable-end"], d, "ap_bgscan_disable_end")); err != nil {
...
func expandWirelessControllerWidsProfileApBgscanDisableDay(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerWidsProfileApBgscanDisableStart(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerWidsProfileApBgscanDisableEnd(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func getObjectWirelessControllerWidsProfile(d *schema.ResourceData) (*map[string]interface{}, error) {
	...
	if v, ok := d.GetOk("ap_bgscan_disable_day"); ok {
		t, err := expandWirelessControllerWidsProfileApBgscanDisableDay(d, v, "ap_bgscan_disable_day")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("ap_bgscan_disable_start"); ok {
		t, err := expandWirelessControllerWidsProfileApBgscanDisableStart(d, v, "ap_bgscan_disable_start")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("ap_bgscan_disable_end"); ok {
		t, err := expandWirelessControllerWidsProfileApBgscanDisableEnd(d, v, "ap_bgscan_disable_end")
		if err != nil {
			return &obj, err
		} else if t != nil {
