...
func refreshObjectCertificateLocal(d *schema.ResourceData, o map[string]interface{}) error {
	...
	if err = d.Set("password", flattenCertificateLocalPassword(o["password"], d, "password")); err != nil {
	...
	if err = d.Set("private_key", flattenCertificateLocalPrivateKey(o["private-key"], d, "private_key")); err != nil {
	...
	if err = d.Set("scep_password", flattenCertificateLocalScepPassword(o["scep-password"], d, "scep_password")); err != nil {
