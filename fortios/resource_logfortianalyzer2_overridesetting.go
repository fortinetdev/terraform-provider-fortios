...
func flattenLogFortianalyzer2OverrideSettingAltServer(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}

func flattenLogFortianalyzer2OverrideSettingFallbackToPrimary(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func flattenLogFortianalyzer2OverrideSettingSerial(v interface{}, d *schema.ResourceData, pre string, sv string) []map[string]interface{} {
	...
	for _, r := range l {
		...
		if cur_v, ok := i["name"]; ok {
			tmp["name"] = flattenLogFortianalyzer2OverrideSettingSerialName(cur_v, d, pre_append, sv)
		}
...
func flattenLogFortianalyzer2OverrideSettingServerCertCa(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func flattenLogFortianalyzer2OverrideSettingChangeIp(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return convintf2i(v)
}
...
func flattenLogFortianalyzer2OverrideSettingVrfSelect(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return convintf2i(v)
}
...
func refreshObjectLogFortianalyzer2OverrideSetting(d *schema.ResourceData, o map[string]interface{}, sv string) error {
	...
	if err = d.Set("alt_server", flattenLogFortianalyzer2OverrideSettingAltServer(o["alt-server"], d, "alt_server", sv)); err != nil {
		if !fortiAPIPatch(o["alt-server"]) {
			return fmt.Errorf("Error reading alt_server: %v", err)
		}
	}

	if err = d.Set("fallback_to_primary", flattenLogFortianalyzer2OverrideSettingFallbackToPrimary(o["fallback-to-primary"], d, "fallback_to_primary", sv)); err != nil {
	...
	if err = d.Set("server_cert_ca", flattenLogFortianalyzer2OverrideSettingServerCertCa(o["server-cert-ca"], d, "server_cert_ca", sv)); err != nil {
	...
	if err = d.Set("__change_ip", flattenLogFortianalyzer2OverrideSettingChangeIp(o["__change_ip"], d, "__change_ip", sv)); err != nil {
	...
	if err = d.Set("vrf_select", flattenLogFortianalyzer2OverrideSettingVrfSelect(o["vrf-select"], d, "vrf_select", sv)); err != nil {
...
func expandLogFortianalyzer2OverrideSettingAltServer(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandLogFortianalyzer2OverrideSettingFallbackToPrimary(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func expandLogFortianalyzer2OverrideSettingServerCertCa(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func expandLogFortianalyzer2OverrideSettingChangeIp(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func expandLogFortianalyzer2OverrideSettingVrfSelect(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func getObjectLogFortianalyzer2OverrideSetting(d *schema.ResourceData, setArgNil bool, sv string) (*map[string]interface{}, error) {
	...
	if v, ok := d.GetOk("alt_server"); ok {
		if setArgNil {
			...
			t, err := expandLogFortianalyzer2OverrideSettingAltServer(d, v, "alt_server", sv)
			if err != nil {
				return &obj, err
			} else if t != nil {
				obj["alt-server"] = t
	...
	if v, ok := d.GetOk("fallback_to_primary"); ok {
		if setArgNil {
			...
			t, err := expandLogFortianalyzer2OverrideSettingFallbackToPrimary(d, v, "fallback_to_primary", sv)
			if err != nil {
				return &obj, err
			} else if t != nil {
	...
	if v, ok := d.GetOk("server_cert_ca"); ok {
		if setArgNil {
			...
			t, err := expandLogFortianalyzer2OverrideSettingServerCertCa(d, v, "server_cert_ca", sv)
			if err != nil {
				return &obj, err
			} else if t != nil {
	...
	if v, ok := d.GetOkExists("__change_ip"); ok {
		if setArgNil {
			...
			t, err := expandLogFortianalyzer2OverrideSettingChangeIp(d, v, "__change_ip", sv)
			if err != nil {
				return &obj, err
			} else if t != nil {
				obj["__change_ip"] = t
	...
	if v, ok := d.GetOkExists("vrf_select"); ok {
		if setArgNil {
			...
			t, err := expandLogFortianalyzer2OverrideSettingVrfSelect(d, v, "vrf_select", sv)
			if err != nil {
				return &obj, err
			} else if t != nil {
				obj["vrf-select"] = t
