...
func flattenSwitchControllerGlobalSwitchCustomCmd(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func refreshObjectSwitchControllerGlobal(d *schema.ResourceData, o map[string]interface{}, sv string) error {
	...
	if err = d.Set("switch_custom_cmd", flattenSwitchControllerGlobalSwitchCustomCmd(o["switch-custom-cmd"], d, "switch_custom_cmd", sv)); err != nil {
		if !fortiAPIPatch(o["switch-custom-cmd"]) {
...
func expandSwitchControllerGlobalSwitchCustomCmd(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func getObjectSwitchControllerGlobal(d *schema.ResourceData, setArgNil bool, sv string) (*map[string]interface{}, error) {
	...
	if v, ok := d.GetOk("switch_custom_cmd"); ok {
		if setArgNil {
			obj["switch-custom-cmd"] = nil
		} else {
			t, err := expandSwitchControllerGlobalSwitchCustomCmd(d, v, "switch_custom_cmd", sv)
			if err != nil {
				return &obj, err
			} else if t != nil {
