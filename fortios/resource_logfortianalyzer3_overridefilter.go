...
func flattenLogFortianalyzer3OverrideFilterHttpTransaction(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func flattenLogFortianalyzer3OverrideFilterFortiSwitch(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func flattenLogFortianalyzer3OverrideFilterFreeStyle(v interface{}, d *schema.ResourceData, pre string, sv string) []map[string]interface{} {
	...
	for _, r := range l {
		...
		if cur_v, ok := i["id"]; ok {
			tmp["id"] = flattenLogFortianalyzer3OverrideFilterFreeStyleId(cur_v, d, pre_append, sv)
		}

		pre_append = pre + "." + strconv.Itoa(con) + "." + "category"
		if cur_v, ok := i["category"]; ok {
			tmp["category"] = flattenLogFortianalyzer3OverrideFilterFreeStyleCategory(cur_v, d, pre_append, sv)
		}

		pre_append = pre + "." + strconv.Itoa(con) + "." + "filter"
		if cur_v, ok := i["filter"]; ok {
			tmp["filter"] = flattenLogFortianalyzer3OverrideFilterFreeStyleFilter(cur_v, d, pre_append, sv)
		}

		pre_append = pre + "." + strconv.Itoa(con) + "." + "filter_type"
		if cur_v, ok := i["filter-type"]; ok {
			tmp["filter_type"] = flattenLogFortianalyzer3OverrideFilterFreeStyleFilterType(cur_v, d, pre_append, sv)
		}
...
func refreshObjectLogFortianalyzer3OverrideFilter(d *schema.ResourceData, o map[string]interface{}, sv string) error {
	...
	if err = d.Set("http_transaction", flattenLogFortianalyzer3OverrideFilterHttpTransaction(o["http-transaction"], d, "http_transaction", sv)); err != nil {
	...
	if err = d.Set("forti_switch", flattenLogFortianalyzer3OverrideFilterFortiSwitch(o["forti-switch"], d, "forti_switch", sv)); err != nil {
...
func expandLogFortianalyzer3OverrideFilterHttpTransaction(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func getObjectLogFortianalyzer3OverrideFilter(d *schema.ResourceData, setArgNil bool, sv string) (*map[string]interface{}, error) {
	...
	if v, ok := d.GetOk("http_transaction"); ok {
		if setArgNil {
			...
			t, err := expandLogFortianalyzer3OverrideFilterHttpTransaction(d, v, "http_transaction", sv)
			if err != nil {
				return &obj, err
			} else if t != nil {
	...
	if v, ok := d.GetOk("forti_switch"); ok {
		if setArgNil {
			...
			t, err := expandLogFortianalyzer3OverrideFilterFortiSwitch(d, v, "forti_switch", sv)
			if err != nil {
				return &obj, err
			} else if t != nil {
				obj["forti-switch"] = t
