...
func resourceFirewallOnDemandSnifferCreate(d *schema.ResourceData, m interface{}) error {
	...
	return readBackAfterCreate(d, "FirewallOnDemandSniffer", mkey,
		func() (map[string]interface{}, error) { return c.ReadFirewallOnDemandSniffer(mkey, vdomparam) },
		refreshObjectFirewallOnDemandSniffer, c.Fv)
}
...
func flattenFirewallOnDemandSnifferHosts(v interface{}, d *schema.ResourceData, pre string, sv string) []map[string]interface{} {
	...
	parsed_list := mergeBlock(tf_list, l, "host", "host")
