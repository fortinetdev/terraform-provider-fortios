	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"admin_http_login_request_size_limit": &schema.Schema{
				Type:         schema.TypeInt,
				ValidateFunc: validation.IntBetween(1024, 32768),
				Optional:     true,
				Computed:     true,
			},
			"admin_http_json_request_limit": &schema.Schema{
				Type:         schema.TypeInt,
				ValidateFunc: validation.IntBetween(33554432, 268435456),
				Optional:     true,
				Computed:     true,
			},
			"http_unauthenticated_request_limit": &schema.Schema{
				Type:         schema.TypeInt,
				ValidateFunc: validation.IntBetween(1024, 524288),
				Optional:     true,
				Computed:     true,
			},
			"admin_http_request_header_timeout": &schema.Schema{
				Type:         schema.TypeInt,
				ValidateFunc: validation.IntBetween(100, 60000),
				Optional:     true,
				Computed:     true,
			},
			"admin_http_request_body_timeout": &schema.Schema{
				Type:         schema.TypeInt,
				ValidateFunc: validation.IntBetween(100, 3600000),
				Optional:     true,
				Computed:     true,
			},
			...
			"admin_http_rate_limit_max_requests": &schema.Schema{
				Type:         schema.TypeInt,
				ValidateFunc: validation.IntBetween(50, 1000),
				Optional:     true,
				Computed:     true,
			},
			...
			"user_device_store_max_devices": &schema.Schema{
				Type:         schema.TypeInt,
				ValidateFunc: validation.IntBetween(10444, 240381),
				Optional:     true,
				Computed:     true,
			},
...
func flattenSystemGlobalWadP2SMaxBodySize(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return convintf2i(v)
}
...
func flattenSystemGlobalLogFsckTimeout(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return convintf2i(v)
}
...
func flattenSystemGlobalSplitPortMode(v interface{}, d *schema.ResourceData, pre string, sv string) []map[string]interface{} {
	if v == nil {
		return nil
	}
	...
	for _, r := range parsed_list {
		...
		if cur_v, ok := i["interface"]; ok {
			...
			tmp["interface"] = flattenSystemGlobalSplitPortModeInterface(cur_v, d, pre_append, sv)
		}

		if cur_v, ok := i["split-mode"]; ok {
			pre_append := ""
			if tf_exist {
				pre_append = pre + "." + strconv.Itoa(con) + "." + "split_mode"
			}
			tmp["split_mode"] = flattenSystemGlobalSplitPortModeSplitMode(cur_v, d, pre_append, sv)
		}
...
func flattenSystemGlobalSplitPortModeInterface(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}

func flattenSystemGlobalSplitPortModeSplitMode(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func flattenSystemGlobalGuiWorkflowManagement(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func flattenSystemGlobalIpv6SnatRouteChange(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func flattenSystemGlobalIpFragmentTimeout(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return convintf2i(v)
}

func flattenSystemGlobalIpv6FragmentTimeout(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return convintf2i(v)
}
...
func flattenSystemGlobalSingleVdomNpuvlink(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func flattenSystemGlobalAdminHost(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func flattenSystemGlobalAuthIkeSamlPort(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return convintf2i(v)
}
...
func flattenSystemGlobalTcpCongestionControl(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func flattenSystemGlobalTelemetryController(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}

func flattenSystemGlobalTelemetryDataPort(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return convintf2i(v)
}
...
func flattenSystemGlobalHttpdMaxWorkerCount(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return convintf2i(v)
}
...
func flattenSystemGlobalIpv6AllowMulticastProbe(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func flattenSystemGlobalSslvpnAffinity(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func flattenSystemGlobalIpConflictDetection(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func flattenSystemGlobalGuiLoginRequestRateLimit(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return convintf2i(v)
}

func flattenSystemGlobalHttpRequestLimit(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return convintf2i(v)
}

func flattenSystemGlobalAdminHttpLoginRequestSizeLimit(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return convintf2i(v)
}

func flattenSystemGlobalAdminHttpJsonRequestLimit(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return convintf2i(v)
}

func flattenSystemGlobalHttpUnauthenticatedRequestLimit(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return convintf2i(v)
}

func flattenSystemGlobalAdminHttpRequestHeaderTimeout(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return convintf2i(v)
}

func flattenSystemGlobalAdminHttpRequestBodyTimeout(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return convintf2i(v)
}

func flattenSystemGlobalAdminHttpUnauthenticatedRequestBodyTimeout(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return convintf2i(v)
}

func flattenSystemGlobalAdminHttpRateLimitMaxRequests(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return convintf2i(v)
}

func flattenSystemGlobalAdminHttpRateLimitExemptAuth(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func flattenSystemGlobalRouterAffinity(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func flattenSystemGlobalUserDeviceStoreMaxDeviceMem(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return convintf2i(v)
}
...
func flattenSystemGlobalGuiCustomTheme(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func flattenSystemGlobalFortitokenCloudRegion(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func flattenSystemGlobalDelayTcpNpuSession(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func flattenSystemGlobalGtpuDynamicSourcePort(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}

func flattenSystemGlobalUserHistoryPasswordThreshold(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return convintf2i(v)
}

func flattenSystemGlobalAuthSessionAutoBackup(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}

func flattenSystemGlobalAuthSessionAutoBackupInterval(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}

func flattenSystemGlobalScimHttpsPort(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return convintf2i(v)
}

func flattenSystemGlobalScimHttpPort(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return convintf2i(v)
}
...
func flattenSystemGlobalTlsSessionCache(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}

func flattenSystemGlobalGuiRestrictThemeChange(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func refreshObjectSystemGlobal(d *schema.ResourceData, o map[string]interface{}, sv string) error {
	...
	if err = d.Set("wad_p2s_max_body_size", flattenSystemGlobalWadP2SMaxBodySize(o["wad-p2s-max-body-size"], d, "wad_p2s_max_body_size", sv)); err != nil {
	...
	if err = d.Set("log_fsck_timeout", flattenSystemGlobalLogFsckTimeout(o["log-fsck-timeout"], d, "log_fsck_timeout", sv)); err != nil {
	...
	if b_get_all_tables {
		if err = d.Set("split_port_mode", flattenSystemGlobalSplitPortMode(o["split-port-mode"], d, "split_port_mode", sv)); err != nil {
	...
	if err = d.Set("gui_workflow_management", flattenSystemGlobalGuiWorkflowManagement(o["gui-workflow-management"], d, "gui_workflow_management", sv)); err != nil {
	...
	if err = d.Set("ipv6_snat_route_change", flattenSystemGlobalIpv6SnatRouteChange(o["ipv6-snat-route-change"], d, "ipv6_snat_route_change", sv)); err != nil {
	...
	if err = d.Set("ip_fragment_timeout", flattenSystemGlobalIpFragmentTimeout(o["ip-fragment-timeout"], d, "ip_fragment_timeout", sv)); err != nil {
		if !fortiAPIPatch(o["ip-fragment-timeout"]) {
			return fmt.Errorf("Error reading ip_fragment_timeout: %v", err)
		}
	}

	if err = d.Set("ipv6_fragment_timeout", flattenSystemGlobalIpv6FragmentTimeout(o["ipv6-fragment-timeout"], d, "ipv6_fragment_timeout", sv)); err != nil {
	...
	if err = d.Set("single_vdom_npuvlink", flattenSystemGlobalSingleVdomNpuvlink(o["single-vdom-npuvlink"], d, "single_vdom_npuvlink", sv)); err != nil {
	...
	if err = d.Set("admin_host", flattenSystemGlobalAdminHost(o["admin-host"], d, "admin_host", sv)); err != nil {
	...
	if err = d.Set("auth_ike_saml_port", flattenSystemGlobalAuthIkeSamlPort(o["auth-ike-saml-port"], d, "auth_ike_saml_port", sv)); err != nil {
	...
	if err = d.Set("tcp_congestion_control", flattenSystemGlobalTcpCongestionControl(o["tcp-congestion-control"], d, "tcp_congestion_control", sv)); err != nil {
	...
	if err = d.Set("telemetry_controller", flattenSystemGlobalTelemetryController(o["telemetry-controller"], d, "telemetry_controller", sv)); err != nil {
		if !fortiAPIPatch(o["telemetry-controller"]) {
			return fmt.Errorf("Error reading telemetry_controller: %v", err)
		}
	}

	if err = d.Set("telemetry_data_port", flattenSystemGlobalTelemetryDataPort(o["telemetry-data-port"], d, "telemetry_data_port", sv)); err != nil {
	...
	if err = d.Set("httpd_max_worker_count", flattenSystemGlobalHttpdMaxWorkerCount(o["httpd-max-worker-count"], d, "httpd_max_worker_count", sv)); err != nil {
	...
	if err = d.Set("ipv6_allow_multicast_probe", flattenSystemGlobalIpv6AllowMulticastProbe(o["ipv6-allow-multicast-probe"], d, "ipv6_allow_multicast_probe", sv)); err != nil {
	...
	if err = d.Set("sslvpn_affinity", flattenSystemGlobalSslvpnAffinity(o["sslvpn-affinity"], d, "sslvpn_affinity", sv)); err != nil {
	...
	if err = d.Set("ip_conflict_detection", flattenSystemGlobalIpConflictDetection(o["ip-conflict-detection"], d, "ip_conflict_detection", sv)); err != nil {
	...
	if err = d.Set("gui_login_request_rate_limit", flattenSystemGlobalGuiLoginRequestRateLimit(o["gui-login-request-rate-limit"], d, "gui_login_request_rate_limit", sv)); err != nil {
		if !fortiAPIPatch(o["gui-login-request-rate-limit"]) {
			return fmt.Errorf("Error reading gui_login_request_rate_limit: %v", err)
		}
	}

	if err = d.Set("http_request_limit", flattenSystemGlobalHttpRequestLimit(o["http-request-limit"], d, "http_request_limit", sv)); err != nil {
		if !fortiAPIPatch(o["http-request-limit"]) {
			return fmt.Errorf("Error reading http_request_limit: %v", err)
		}
	}

	if err = d.Set("admin_http_login_request_size_limit", flattenSystemGlobalAdminHttpLoginRequestSizeLimit(o["admin-http-login-request-size-limit"], d, "admin_http_login_request_size_limit", sv)); err != nil {
	...
	if err = d.Set("admin_http_json_request_limit", flattenSystemGlobalAdminHttpJsonRequestLimit(o["admin-http-json-request-limit"], d, "admin_http_json_request_limit", sv)); err != nil {
		if !fortiAPIPatch(o["admin-http-json-request-limit"]) {
			return fmt.Errorf("Error reading admin_http_json_request_limit: %v", err)
		}
	}

	if err = d.Set("http_unauthenticated_request_limit", flattenSystemGlobalHttpUnauthenticatedRequestLimit(o["http-unauthenticated-request-limit"], d, "http_unauthenticated_request_limit", sv)); err != nil {
	...
	if err = d.Set("admin_http_request_header_timeout", flattenSystemGlobalAdminHttpRequestHeaderTimeout(o["admin-http-request-header-timeout"], d, "admin_http_request_header_timeout", sv)); err != nil {
	...
	if err = d.Set("admin_http_request_body_timeout", flattenSystemGlobalAdminHttpRequestBodyTimeout(o["admin-http-request-body-timeout"], d, "admin_http_request_body_timeout", sv)); err != nil {
		if !fortiAPIPatch(o["admin-http-request-body-timeout"]) {
			return fmt.Errorf("Error reading admin_http_request_body_timeout: %v", err)
		}
	}

	if err = d.Set("admin_http_unauthenticated_request_body_timeout", flattenSystemGlobalAdminHttpUnauthenticatedRequestBodyTimeout(o["admin-http-unauthenticated-request-body-timeout"], d, "admin_http_unauthenticated_request_body_timeout", sv)); err != nil {
	...
	if err = d.Set("admin_http_rate_limit_max_requests", flattenSystemGlobalAdminHttpRateLimitMaxRequests(o["admin-http-rate-limit-max-requests"], d, "admin_http_rate_limit_max_requests", sv)); err != nil {
	...
	if err = d.Set("admin_http_rate_limit_exempt_auth", flattenSystemGlobalAdminHttpRateLimitExemptAuth(o["admin-http-rate-limit-exempt-auth"], d, "admin_http_rate_limit_exempt_auth", sv)); err != nil {
	...
	if err = d.Set("router_affinity", flattenSystemGlobalRouterAffinity(o["router-affinity"], d, "router_affinity", sv)); err != nil {
	...
	if err = d.Set("user_device_store_max_device_mem", flattenSystemGlobalUserDeviceStoreMaxDeviceMem(o["user-device-store-max-device-mem"], d, "user_device_store_max_device_mem", sv)); err != nil {
	...
	if err = d.Set("gui_custom_theme", flattenSystemGlobalGuiCustomTheme(o["gui-custom-theme"], d, "gui_custom_theme", sv)); err != nil {
	...
	if err = d.Set("fortitoken_cloud_region", flattenSystemGlobalFortitokenCloudRegion(o["fortitoken-cloud-region"], d, "fortitoken_cloud_region", sv)); err != nil {
	...
	if err = d.Set("delay_tcp_npu_session", flattenSystemGlobalDelayTcpNpuSession(o["delay-tcp-npu-session"], d, "delay_tcp_npu_session", sv)); err != nil {
	...
	if err = d.Set("gtpu_dynamic_source_port", flattenSystemGlobalGtpuDynamicSourcePort(o["gtpu-dynamic-source-port"], d, "gtpu_dynamic_source_port", sv)); err != nil {
		if !fortiAPIPatch(o["gtpu-dynamic-source-port"]) {
			return fmt.Errorf("Error reading gtpu_dynamic_source_port: %v", err)
		}
	}

	if err = d.Set("user_history_password_threshold", flattenSystemGlobalUserHistoryPasswordThreshold(o["user-history-password-threshold"], d, "user_history_password_threshold", sv)); err != nil {
		if !fortiAPIPatch(o["user-history-password-threshold"]) {
			return fmt.Errorf("Error reading user_history_password_threshold: %v", err)
		}
	}

	if err = d.Set("auth_session_auto_backup", flattenSystemGlobalAuthSessionAutoBackup(o["auth-session-auto-backup"], d, "auth_session_auto_backup", sv)); err != nil {
		if !fortiAPIPatch(o["auth-session-auto-backup"]) {
			return fmt.Errorf("Error reading auth_session_auto_backup: %v", err)
		}
	}

	if err = d.Set("auth_session_auto_backup_interval", flattenSystemGlobalAuthSessionAutoBackupInterval(o["auth-session-auto-backup-interval"], d, "auth_session_auto_backup_interval", sv)); err != nil {
	...
	if err = d.Set("scim_https_port", flattenSystemGlobalScimHttpsPort(o["scim-https-port"], d, "scim_https_port", sv)); err != nil {
		if !fortiAPIPatch(o["scim-https-port"]) {
			return fmt.Errorf("Error reading scim_https_port: %v", err)
		}
	}

	if err = d.Set("scim_http_port", flattenSystemGlobalScimHttpPort(o["scim-http-port"], d, "scim_http_port", sv)); err != nil {
		if !fortiAPIPatch(o["scim-http-port"]) {
			return fmt.Errorf("Error reading scim_http_port: %v", err)
		}
	}

	if err = d.Set("scim_server_cert", flattenSystemGlobalScimServerCert(o["scim-server-cert"], d, "scim_server_cert", sv)); err != nil {
	...
	if err = d.Set("tls_session_cache", flattenSystemGlobalTlsSessionCache(o["tls-session-cache"], d, "tls_session_cache", sv)); err != nil {
		if !fortiAPIPatch(o["tls-session-cache"]) {
			return fmt.Errorf("Error reading tls_session_cache: %v", err)
		}
	}

	if err = d.Set("gui_restrict_theme_change", flattenSystemGlobalGuiRestrictThemeChange(o["gui-restrict-theme-change"], d, "gui_restrict_theme_change", sv)); err != nil {
...
func expandSystemGlobalWadP2SMaxBodySize(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func expandSystemGlobalLogFsckTimeout(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func expandSystemGlobalSplitPortMode(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	l := v.([]interface{})
	result := make([]map[string]interface{}, 0, len(l))
	...
	for _, r := range l {
		...
		if _, ok := d.GetOk(pre_append); ok {
			tmp["interface"], _ = expandSystemGlobalSplitPortModeInterface(d, i["interface"], pre_append, sv)
		...
		pre_append = pre + "." + strconv.Itoa(con) + "." + "split_mode"
		if _, ok := d.GetOk(pre_append); ok {
			tmp["split-mode"], _ = expandSystemGlobalSplitPortModeSplitMode(d, i["split_mode"], pre_append, sv)
		}
...
func expandSystemGlobalSplitPortModeInterface(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandSystemGlobalSplitPortModeSplitMode(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func expandSystemGlobalGuiWorkflowManagement(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func expandSystemGlobalIpv6SnatRouteChange(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func expandSystemGlobalIpFragmentTimeout(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandSystemGlobalIpv6FragmentTimeout(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func expandSystemGlobalSingleVdomNpuvlink(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func expandSystemGlobalAdminHost(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func expandSystemGlobalAuthIkeSamlPort(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func expandSystemGlobalTcpCongestionControl(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func expandSystemGlobalTelemetryController(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandSystemGlobalTelemetryDataPort(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func expandSystemGlobalHttpdMaxWorkerCount(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func expandSystemGlobalIpv6AllowMulticastProbe(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func expandSystemGlobalSslvpnAffinity(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func expandSystemGlobalIpConflictDetection(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func expandSystemGlobalGuiLoginRequestRateLimit(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandSystemGlobalHttpRequestLimit(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandSystemGlobalAdminHttpLoginRequestSizeLimit(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandSystemGlobalAdminHttpJsonRequestLimit(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandSystemGlobalHttpUnauthenticatedRequestLimit(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandSystemGlobalAdminHttpRequestHeaderTimeout(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandSystemGlobalAdminHttpRequestBodyTimeout(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandSystemGlobalAdminHttpUnauthenticatedRequestBodyTimeout(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandSystemGlobalAdminHttpRateLimitMaxRequests(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandSystemGlobalAdminHttpRateLimitExemptAuth(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func expandSystemGlobalRouterAffinity(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func expandSystemGlobalUserDeviceStoreMaxDeviceMem(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func expandSystemGlobalGuiCustomTheme(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func expandSystemGlobalFortitokenCloudRegion(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func expandSystemGlobalDelayTcpNpuSession(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func expandSystemGlobalGtpuDynamicSourcePort(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandSystemGlobalUserHistoryPasswordThreshold(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandSystemGlobalAuthSessionAutoBackup(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandSystemGlobalAuthSessionAutoBackupInterval(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandSystemGlobalScimHttpsPort(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandSystemGlobalScimHttpPort(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func expandSystemGlobalTlsSessionCache(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandSystemGlobalGuiRestrictThemeChange(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func getObjectSystemGlobal(d *schema.ResourceData, setArgNil bool, sv string) (*map[string]interface{}, error) {
	...
	} else if d.HasChange("gui_firmware_upgrade_setup_warning") {
		obj["gui-firmware-upgrade-setup-warning"] = nil
	}
	...
	} else if d.HasChange("gui_lines_per_page") {
		obj["gui-lines-per-page"] = nil
	}
	...
	} else if d.HasChange("admin_https_ssl_banned_ciphers") {
		obj["admin-https-ssl-banned-ciphers"] = nil
	}
	...
	} else if d.HasChange("admin_console_timeout") {
		obj["admin-console-timeout"] = nil
	}
	...
	if v, ok := d.GetOk("wad_p2s_max_body_size"); ok {
		if setArgNil {
			obj["wad-p2s-max-body-size"] = nil
		} else {
			t, err := expandSystemGlobalWadP2SMaxBodySize(d, v, "wad_p2s_max_body_size", sv)
			if err != nil {
				return &obj, err
			} else if t != nil {
	...
	} else if d.HasChange("max_dlpstat_memory") {
		obj["max-dlpstat-memory"] = nil
	}
	...
	if v, ok := d.GetOkExists("log_fsck_timeout"); ok {
		if setArgNil {
			obj["log-fsck-timeout"] = nil
		} else {
			t, err := expandSystemGlobalLogFsckTimeout(d, v, "log_fsck_timeout", sv)
			if err != nil {
				return &obj, err
			} else if t != nil {
	...
	if v, ok := d.GetOk("split_port_mode"); ok || d.HasChange("split_port_mode") {
		if setArgNil {
			...
			t, err := expandSystemGlobalSplitPortMode(d, v, "split_port_mode", sv)
			if err != nil {
				return &obj, err
			} else if t != nil {
	...
	} else if d.HasChange("split_port") {
		obj["split-port"] = nil
	}
	...
	if v, ok := d.GetOk("gui_workflow_management"); ok {
		if setArgNil {
	...
	} else if d.HasChange("ssh_hostkey_password") {
		obj["ssh-hostkey-password"] = nil
	}
	...
	} else if d.HasChange("ssh_hostkey") {
		obj["ssh-hostkey"] = nil
	}
	...
	if v, ok := d.GetOk("ipv6_snat_route_change"); ok {
		if setArgNil {
			obj["ipv6-snat-route-change"] = nil
		} else {
			t, err := expandSystemGlobalIpv6SnatRouteChange(d, v, "ipv6_snat_route_change", sv)
			if err != nil {
				return &obj, err
			} else if t != nil {
	...
	} else if d.HasChange("multicast_forward") {
		obj["multicast-forward"] = nil
	}
	...
	} else if d.HasChange("mc_ttl_notchange") {
		obj["mc-ttl-notchange"] = nil
	}
	...
	if v, ok := d.GetOk("ip_fragment_timeout"); ok {
		if setArgNil {
			obj["ip-fragment-timeout"] = nil
		} else {
			t, err := expandSystemGlobalIpFragmentTimeout(d, v, "ip_fragment_timeout", sv)
			if err != nil {
				return &obj, err
			} else if t != nil {
	...
	if v, ok := d.GetOk("ipv6_fragment_timeout"); ok {
		if setArgNil {
			obj["ipv6-fragment-timeout"] = nil
		} else {
			t, err := expandSystemGlobalIpv6FragmentTimeout(d, v, "ipv6_fragment_timeout", sv)
			if err != nil {
				return &obj, err
			} else if t != nil {
	...
	if v, ok := d.GetOk("single_vdom_npuvlink"); ok {
		if setArgNil {
			obj["single-vdom-npuvlink"] = nil
		} else {
			t, err := expandSystemGlobalSingleVdomNpuvlink(d, v, "single_vdom_npuvlink", sv)
			if err != nil {
				return &obj, err
			} else if t != nil {
	...
	} else if d.HasChange("vdom_admin") {
		obj["vdom-admin"] = nil
	}
	...
	} else if d.HasChange("admin_host") {
		obj["admin-host"] = nil
	}
	...
	} else if d.HasChange("admin_forticloud_sso_default_profile") {
		obj["admin-forticloud-sso-default-profile"] = nil
	}
	...
	if v, ok := d.GetOkExists("auth_ike_saml_port"); ok {
		if setArgNil {
	...
	} else if d.HasChange("policy_auth_concurrent") {
		obj["policy-auth-concurrent"] = nil
	}
	...
	} else if d.HasChange("endpoint_control_portal_port") {
		obj["endpoint-control-portal-port"] = nil
	}
	...
	} else if d.HasChange("endpoint_control_fds_access") {
		obj["endpoint-control-fds-access"] = nil
	}
	...
	} else if d.HasChange("tp_mc_skip_policy") {
		obj["tp-mc-skip-policy"] = nil
	}
	...
	if v, ok := d.GetOk("tcp_congestion_control"); ok {
		if setArgNil {
			obj["tcp-congestion-control"] = nil
		} else {
			t, err := expandSystemGlobalTcpCongestionControl(d, v, "tcp_congestion_control", sv)
			if err != nil {
				return &obj, err
			} else if t != nil {
	...
	if v, ok := d.GetOk("telemetry_controller"); ok {
		if setArgNil {
			obj["telemetry-controller"] = nil
		} else {
			t, err := expandSystemGlobalTelemetryController(d, v, "telemetry_controller", sv)
			if err != nil {
				return &obj, err
			} else if t != nil {
	...
	if v, ok := d.GetOk("telemetry_data_port"); ok {
		if setArgNil {
			obj["telemetry-data-port"] = nil
		} else {
			t, err := expandSystemGlobalTelemetryDataPort(d, v, "telemetry_data_port", sv)
			if err != nil {
				return &obj, err
			} else if t != nil {
	...
	if v, ok := d.GetOkExists("httpd_max_worker_count"); ok {
		if setArgNil {
			obj["httpd-max-worker-count"] = nil
		} else {
			t, err := expandSystemGlobalHttpdMaxWorkerCount(d, v, "httpd_max_worker_count", sv)
			if err != nil {
				return &obj, err
			} else if t != nil {
	...
	} else if d.HasChange("httpd_max_worker_count") {
		obj["httpd-max-worker-count"] = nil
	}
	...
	} else if d.HasChange("proxy_worker_count") {
		obj["proxy-worker-count"] = nil
	}
	...
	} else if d.HasChange("scanunit_count") {
		obj["scanunit-count"] = nil
	}
	...
	} else if d.HasChange("proxy_kxp_hardware_acceleration") {
		obj["proxy-kxp-hardware-acceleration"] = nil
	}
	...
	} else if d.HasChange("proxy_cipher_hardware_acceleration") {
		obj["proxy-cipher-hardware-acceleration"] = nil
	}
	...
	} else if d.HasChange("fgd_alert_subscription") {
		obj["fgd-alert-subscription"] = nil
	}
	...
	if v, ok := d.GetOk("ipv6_allow_multicast_probe"); ok {
		if setArgNil {
	...
	} else if d.HasChange("sslvpn_max_worker_count") {
		obj["sslvpn-max-worker-count"] = nil
	}

	if v, ok := d.GetOk("sslvpn_affinity"); ok {
		if setArgNil {
			obj["sslvpn-affinity"] = nil
		} else {
			t, err := expandSystemGlobalSslvpnAffinity(d, v, "sslvpn_affinity", sv)
			if err != nil {
				return &obj, err
			} else if t != nil {
	...
	} else if d.HasChange("virtual_server_count") {
		obj["virtual-server-count"] = nil
	}
	...
	} else if d.HasChange("virtual_server_hardware_acceleration") {
		obj["virtual-server-hardware-acceleration"] = nil
	}
	...
	} else if d.HasChange("wad_worker_count") {
		obj["wad-worker-count"] = nil
	}
	...
	} else if d.HasChange("wad_csvc_db_count") {
		obj["wad-csvc-db-count"] = nil
	}
	...
	if v, ok := d.GetOk("ip_conflict_detection"); ok {
		if setArgNil {
			obj["ip-conflict-detection"] = nil
		} else {
			t, err := expandSystemGlobalIpConflictDetection(d, v, "ip_conflict_detection", sv)
			if err != nil {
				return &obj, err
			} else if t != nil {
	...
	} else if d.HasChange("log_uuid_policy") {
		obj["log-uuid-policy"] = nil
	}
	...
	if v, ok := d.GetOkExists("gui_login_request_rate_limit"); ok {
		if setArgNil {
			obj["gui-login-request-rate-limit"] = nil
		} else {
			t, err := expandSystemGlobalGuiLoginRequestRateLimit(d, v, "gui_login_request_rate_limit", sv)
			if err != nil {
				return &obj, err
			} else if t != nil {
	...
	} else if d.HasChange("gui_login_request_rate_limit") {
		obj["gui-login-request-rate-limit"] = nil
	}

	if v, ok := d.GetOk("http_request_limit"); ok {
		if setArgNil {
			obj["http-request-limit"] = nil
		} else {
			t, err := expandSystemGlobalHttpRequestLimit(d, v, "http_request_limit", sv)
			if err != nil {
				return &obj, err
			} else if t != nil {
	...
	if v, ok := d.GetOk("admin_http_login_request_size_limit"); ok {
		if setArgNil {
			obj["admin-http-login-request-size-limit"] = nil
		} else {
			t, err := expandSystemGlobalAdminHttpLoginRequestSizeLimit(d, v, "admin_http_login_request_size_limit", sv)
			if err != nil {
				return &obj, err
			} else if t != nil {
	...
	if v, ok := d.GetOk("admin_http_json_request_limit"); ok {
		if setArgNil {
			obj["admin-http-json-request-limit"] = nil
		} else {
			t, err := expandSystemGlobalAdminHttpJsonRequestLimit(d, v, "admin_http_json_request_limit", sv)
			if err != nil {
				return &obj, err
			} else if t != nil {
	...
	if v, ok := d.GetOk("http_unauthenticated_request_limit"); ok {
		if setArgNil {
			obj["http-unauthenticated-request-limit"] = nil
		} else {
			t, err := expandSystemGlobalHttpUnauthenticatedRequestLimit(d, v, "http_unauthenticated_request_limit", sv)
			if err != nil {
				return &obj, err
			} else if t != nil {
	...
	if v, ok := d.GetOk("admin_http_request_header_timeout"); ok {
		if setArgNil {
			obj["admin-http-request-header-timeout"] = nil
		} else {
			t, err := expandSystemGlobalAdminHttpRequestHeaderTimeout(d, v, "admin_http_request_header_timeout", sv)
			if err != nil {
				return &obj, err
			} else if t != nil {
	...
	if v, ok := d.GetOk("admin_http_request_body_timeout"); ok {
		if setArgNil {
			obj["admin-http-request-body-timeout"] = nil
		} else {
			t, err := expandSystemGlobalAdminHttpRequestBodyTimeout(d, v, "admin_http_request_body_timeout", sv)
			if err != nil {
				return &obj, err
			} else if t != nil {
	...
	if v, ok := d.GetOk("admin_http_unauthenticated_request_body_timeout"); ok {
		if setArgNil {
			obj["admin-http-unauthenticated-request-body-timeout"] = nil
		} else {
			t, err := expandSystemGlobalAdminHttpUnauthenticatedRequestBodyTimeout(d, v, "admin_http_unauthenticated_request_body_timeout", sv)
			if err != nil {
				return &obj, err
			} else if t != nil {
	...
	if v, ok := d.GetOk("admin_http_rate_limit_max_requests"); ok {
		if setArgNil {
			obj["admin-http-rate-limit-max-requests"] = nil
		} else {
			t, err := expandSystemGlobalAdminHttpRateLimitMaxRequests(d, v, "admin_http_rate_limit_max_requests", sv)
			if err != nil {
				return &obj, err
			} else if t != nil {
	...
	if v, ok := d.GetOk("admin_http_rate_limit_exempt_auth"); ok {
		if setArgNil {
			obj["admin-http-rate-limit-exempt-auth"] = nil
		} else {
			t, err := expandSystemGlobalAdminHttpRateLimitExemptAuth(d, v, "admin_http_rate_limit_exempt_auth", sv)
			if err != nil {
				return &obj, err
			} else if t != nil {
	...
	} else if d.HasChange("gui_cdn_domain_override") {
		obj["gui-cdn-domain-override"] = nil
	}
	...
	if v, ok := d.GetOk("router_affinity"); ok {
		if setArgNil {
			obj["router-affinity"] = nil
		} else {
			t, err := expandSystemGlobalRouterAffinity(d, v, "router_affinity", sv)
			if err != nil {
				return &obj, err
			} else if t != nil {
	...
	} else if d.HasChange("ndp_max_entry") {
		obj["ndp-max-entry"] = nil
	}
	...
	} else if d.HasChange("max_route_cache_size") {
		obj["max-route-cache-size"] = nil
	}
	...
	} else if d.HasChange("ike_embryonic_limit") {
		obj["ike-embryonic-limit"] = nil
	}
	...
	if v, ok := d.GetOk("user_device_store_max_device_mem"); ok {
		if setArgNil {
			obj["user-device-store-max-device-mem"] = nil
		} else {
			t, err := expandSystemGlobalUserDeviceStoreMaxDeviceMem(d, v, "user_device_store_max_device_mem", sv)
			if err != nil {
				return &obj, err
			} else if t != nil {
	...
	} else if d.HasChange("device_identification_active_scan_delay") {
		obj["device-identification-active-scan-delay"] = nil
	}
	...
	} else if d.HasChange("compliance_check_time") {
		obj["compliance-check-time"] = nil
	}
	...
	if v, ok := d.GetOk("gui_custom_theme"); ok {
		if setArgNil {
			...
			t, err := expandSystemGlobalGuiCustomTheme(d, v, "gui_custom_theme", sv)
			if err != nil {
				return &obj, err
			} else if t != nil {
	...
	if v, ok := d.GetOk("fortitoken_cloud_region"); ok {
		if setArgNil {
			obj["fortitoken-cloud-region"] = nil
		} else {
			t, err := expandSystemGlobalFortitokenCloudRegion(d, v, "fortitoken_cloud_region", sv)
			if err != nil {
				return &obj, err
			} else if t != nil {
	...
	} else if d.HasChange("fortitoken_cloud_region") {
		obj["fortitoken-cloud-region"] = nil
	}
	...
	} else if d.HasChange("faz_disk_buffer_size") {
		obj["faz-disk-buffer-size"] = nil
	}
	...
	if v, ok := d.GetOk("delay_tcp_npu_session"); ok {
		if setArgNil {
			obj["delay-tcp-npu-session"] = nil
		} else {
			t, err := expandSystemGlobalDelayTcpNpuSession(d, v, "delay_tcp_npu_session", sv)
			if err != nil {
				return &obj, err
			} else if t != nil {
	...
	if v, ok := d.GetOk("gtpu_dynamic_source_port"); ok {
		if setArgNil {
			obj["gtpu-dynamic-source-port"] = nil
		} else {
			t, err := expandSystemGlobalGtpuDynamicSourcePort(d, v, "gtpu_dynamic_source_port", sv)
			if err != nil {
				return &obj, err
			} else if t != nil {
	...
	if v, ok := d.GetOk("user_history_password_threshold"); ok {
		if setArgNil {
			obj["user-history-password-threshold"] = nil
		} else {
			t, err := expandSystemGlobalUserHistoryPasswordThreshold(d, v, "user_history_password_threshold", sv)
			if err != nil {
				return &obj, err
			} else if t != nil {
	...
	if v, ok := d.GetOk("auth_session_auto_backup"); ok {
		if setArgNil {
			obj["auth-session-auto-backup"] = nil
		} else {
			t, err := expandSystemGlobalAuthSessionAutoBackup(d, v, "auth_session_auto_backup", sv)
			if err != nil {
				return &obj, err
			} else if t != nil {
	...
	if v, ok := d.GetOk("auth_session_auto_backup_interval"); ok {
		if setArgNil {
			obj["auth-session-auto-backup-interval"] = nil
		} else {
			t, err := expandSystemGlobalAuthSessionAutoBackupInterval(d, v, "auth_session_auto_backup_interval", sv)
			if err != nil {
				return &obj, err
			} else if t != nil {
	...
	if v, ok := d.GetOkExists("scim_https_port"); ok {
		if setArgNil {
			obj["scim-https-port"] = nil
		} else {
			t, err := expandSystemGlobalScimHttpsPort(d, v, "scim_https_port", sv)
			if err != nil {
				return &obj, err
			} else if t != nil {
	...
	if v, ok := d.GetOkExists("scim_http_port"); ok {
		if setArgNil {
			obj["scim-http-port"] = nil
		} else {
			t, err := expandSystemGlobalScimHttpPort(d, v, "scim_http_port", sv)
			if err != nil {
				return &obj, err
			} else if t != nil {
	...
	if v, ok := d.GetOk("scim_server_cert"); ok {
		if setArgNil {
			obj["scim-server-cert"] = nil
		} else {
			t, err := expandSystemGlobalScimServerCert(d, v, "scim_server_cert", sv)
			if err != nil {
				return &obj, err
			} else if t != nil {
	...
	if v, ok := d.GetOk("tls_session_cache"); ok {
		if setArgNil {
			obj["tls-session-cache"] = nil
		} else {
			t, err := expandSystemGlobalTlsSessionCache(d, v, "tls_session_cache", sv)
			if err != nil {
				return &obj, err
			} else if t != nil {
	...
	if v, ok := d.GetOk("gui_restrict_theme_change"); ok {
		if setArgNil {
			obj["gui-restrict-theme-change"] = nil
		} else {
			t, err := expandSystemGlobalGuiRestrictThemeChange(d, v, "gui_restrict_theme_change", sv)
			if err != nil {
				return &obj, err
			} else if t != nil {
