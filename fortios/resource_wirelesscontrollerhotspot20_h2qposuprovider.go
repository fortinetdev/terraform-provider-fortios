...
func resourceWirelessControllerHotspot20H2QpOsuProviderCreate(d *schema.ResourceData, m interface{}) error {
	...
	return readBackAfterCreate(d, "WirelessControllerHotspot20H2QpOsuProvider", mkey,
		func() (map[string]interface{}, error) {
			return c.ReadWirelessControllerHotspot20H2QpOsuProvider(mkey, vdomparam)
		},
		refreshObjectWirelessControllerHotspot20H2QpOsuProvider, c.Fv)
}
...
func flattenWirelessControllerHotspot20H2QpOsuProviderServiceDescription(v interface{}, d *schema.ResourceData, pre string, sv string) []map[string]interface{} {
	...
	parsed_list := mergeBlock(tf_list, l, "service-id", "service_id")
