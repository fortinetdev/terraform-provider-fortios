...
func flattenLogWebtrendsFilterHttpTransaction(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func flattenLogWebtrendsFilterFortiSwitch(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}

func flattenLogWebtrendsFilterDebug(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func flattenLogWebtrendsFilterFreeStyle(v interface{}, d *schema.ResourceData, pre string, sv string) []map[string]interface{} {
	...
	for _, r := range parsed_list {
		...
		if cur_v, ok := i["id"]; ok {
			...
			tmp["id"] = flattenLogWebtrendsFilterFreeStyleId(cur_v, d, pre_append, sv)
		}
		...
		if cur_v, ok := i["category"]; ok {
			...
			tmp["category"] = flattenLogWebtrendsFilterFreeStyleCategory(cur_v, d, pre_append, sv)
		}
		...
		if cur_v, ok := i["filter"]; ok {
			...
			tmp["filter"] = flattenLogWebtrendsFilterFreeStyleFilter(cur_v, d, pre_append, sv)
		}
		...
		if cur_v, ok := i["filter-type"]; ok {
			...
			tmp["filter_type"] = flattenLogWebtrendsFilterFreeStyleFilterType(cur_v, d, pre_append, sv)
		}
...
func refreshObjectLogWebtrendsFilter(d *schema.ResourceData, o map[string]interface{}, sv string) error {
	...
	if err = d.Set("http_transaction", flattenLogWebtrendsFilterHttpTransaction(o["http-transaction"], d, "http_transaction", sv)); err != nil {
	...
	if err = d.Set("forti_switch", flattenLogWebtrendsFilterFortiSwitch(o["forti-switch"], d, "forti_switch", sv)); err != nil {
		if !fortiAPIPatch(o["forti-switch"]) {
			return fmt.Errorf("Error reading forti_switch: %v", err)
		}
	}

	if err = d.Set("debug", flattenLogWebtrendsFilterDebug(o["debug"], d, "debug", sv)); err != nil {
...
func expandLogWebtrendsFilterHttpTransaction(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func expandLogWebtrendsFilterFortiSwitch(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandLogWebtrendsFilterDebug(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func getObjectLogWebtrendsFilter(d *schema.ResourceData, setArgNil bool, sv string) (*map[string]interface{}, error) {
	...
	if v, ok := d.GetOk("http_transaction"); ok {
		if setArgNil {
			...
			t, err := expandLogWebtrendsFilterHttpTransaction(d, v, "http_transaction", sv)
			if err != nil {
				return &obj, err
			} else if t != nil {
	...
	if v, ok := d.GetOk("forti_switch"); ok {
		if setArgNil {
			...
			t, err := expandLogWebtrendsFilterFortiSwitch(d, v, "forti_switch", sv)
			if err != nil {
				return &obj, err
			} else if t != nil {
				obj["forti-switch"] = t
	...
	if v, ok := d.GetOk("debug"); ok {
		if setArgNil {
			...
			t, err := expandLogWebtrendsFilterDebug(d, v, "debug", sv)
			if err != nil {
				return &obj, err
			} else if t != nil {
				obj["debug"] = t
