...
func flattenAntivirusProfileInspectionMode(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func flattenAntivirusProfileSmb(v interface{}, d *schema.ResourceData, pre string) []map[string]interface{} {
	if v == nil {
		return nil
	}
	...
	pre_append =  pre + ".0." + "options"
	if _, ok := i["options"]; ok {
		result["options"] = flattenAntivirusProfileSmbOptions(i["options"], d, pre_append)
	}

	pre_append =  pre + ".0." + "archive_block"
	if _, ok := i["archive-block"]; ok {
		result["archive_block"] = flattenAntivirusProfileSmbArchiveBlock(i["archive-block"], d, pre_append)
	}

	pre_append =  pre + ".0." + "archive_log"
	if _, ok := i["archive-log"]; ok {
		result["archive_log"] = flattenAntivirusProfileSmbArchiveLog(i["archive-log"], d, pre_append)
	}

	pre_append =  pre + ".0." + "emulator"
	if _, ok := i["emulator"]; ok {
		result["emulator"] = flattenAntivirusProfileSmbEmulator(i["emulator"], d, pre_append)
	}

	pre_append =  pre + ".0." + "outbreak_prevention"
	if _, ok := i["outbreak-prevention"]; ok {
		result["outbreak_prevention"] = flattenAntivirusProfileSmbOutbreakPrevention(i["outbreak-prevention"], d, pre_append)
	}
...
func flattenAntivirusProfileSmbOptions(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenAntivirusProfileSmbArchiveBlock(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenAntivirusProfileSmbArchiveLog(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenAntivirusProfileSmbEmulator(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}

func flattenAntivirusProfileSmbOutbreakPrevention(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func refreshObjectAntivirusProfile(d *schema.ResourceData, o map[string]interface{}) error {
	...
	if err = d.Set("inspection_mode", flattenAntivirusProfileInspectionMode(o["inspection-mode"], d, "inspection_mode")); err != nil {
    ...
    if isImportTable() {
        if err = d.Set("smb", flattenAntivirusProfileSmb(o["smb"], d, "smb")); err != nil {
...
func expandAntivirusProfileInspectionMode(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func expandAntivirusProfileSmb(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	l := v.([]interface{})
	if len(l) == 0 || l[0] == nil {
		return nil, nil
	}
	...
	pre_append =  pre + ".0." + "options"
	if _, ok := d.GetOk(pre_append); ok {
		result["options"], _ = expandAntivirusProfileSmbOptions(d, i["options"], pre_append)
	}
	pre_append =  pre + ".0." + "archive_block"
	if _, ok := d.GetOk(pre_append); ok {
		result["archive-block"], _ = expandAntivirusProfileSmbArchiveBlock(d, i["archive_block"], pre_append)
	}
	pre_append =  pre + ".0." + "archive_log"
	if _, ok := d.GetOk(pre_append); ok {
		result["archive-log"], _ = expandAntivirusProfileSmbArchiveLog(d, i["archive_log"], pre_append)
	}
	pre_append =  pre + ".0." + "emulator"
	if _, ok := d.GetOk(pre_append); ok {
		result["emulator"], _ = expandAntivirusProfileSmbEmulator(d, i["emulator"], pre_append)
	}
	pre_append =  pre + ".0." + "outbreak_prevention"
	if _, ok := d.GetOk(pre_append); ok {
		result["outbreak-prevention"], _ = expandAntivirusProfileSmbOutbreakPrevention(d, i["outbreak_prevention"], pre_append)
	}

	return result, nil
}

func expandAntivirusProfileSmbOptions(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandAntivirusProfileSmbArchiveBlock(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandAntivirusProfileSmbArchiveLog(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandAntivirusProfileSmbEmulator(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}

func expandAntivirusProfileSmbOutbreakPrevention(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
...
func getObjectAntivirusProfile(d *schema.ResourceData) (*map[string]interface{}, error) {
	...
	if v, ok := d.GetOk("inspection_mode"); ok {
		t, err := expandAntivirusProfileInspectionMode(d, v, "inspection_mode")
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("smb"); ok {
		t, err := expandAntivirusProfileSmb(d, v, "smb")
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["smb"] = t
