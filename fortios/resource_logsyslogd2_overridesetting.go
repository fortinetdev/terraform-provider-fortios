...
func resourceLogSyslogd2OverrideSettingUpdate(d *schema.ResourceData, m interface{}) error {
	...
	obj, err := getObjectLogSyslogd2OverrideSetting(d, false, c.Fv)
	if err != nil {
...
func resourceLogSyslogd2OverrideSettingDelete(d *schema.ResourceData, m interface{}) error {
	...
	obj, err := getObjectLogSyslogd2OverrideSetting(d, true, c.Fv)

	if err != nil {
		return fmt.Errorf("Error updating LogSyslogd2OverrideSetting resource while getting object: %v", err)
	}

	_, err = c.UpdateLogSyslogd2OverrideSetting(obj, mkey, vdomparam)
	if err != nil {
...
func flattenLogSyslogd2OverrideSettingCustomFieldName(v interface{}, d *schema.ResourceData, pre string, sv string) []map[string]interface{} {
	...
	for _, r := range parsed_list {
		...
		if cur_v, ok := i["id"]; ok {
			...
			tmp["id"] = flattenLogSyslogd2OverrideSettingCustomFieldNameId(cur_v, d, pre_append, sv)
		}
		...
		if cur_v, ok := i["name"]; ok {
			...
			tmp["name"] = flattenLogSyslogd2OverrideSettingCustomFieldNameName(cur_v, d, pre_append, sv)
		}
		...
		if cur_v, ok := i["custom"]; ok {
			...
			tmp["custom"] = flattenLogSyslogd2OverrideSettingCustomFieldNameCustom(cur_v, d, pre_append, sv)
		}
...
func flattenLogSyslogd2OverrideSettingVrfSelect(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return convintf2i(v)
}

func flattenLogSyslogd2OverrideSettingCustomLogFormat(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func refreshObjectLogSyslogd2OverrideSetting(d *schema.ResourceData, o map[string]interface{}, sv string) error {
	...
	if err = d.Set("vrf_select", flattenLogSyslogd2OverrideSettingVrfSelect(o["vrf-select"], d, "vrf_select", sv)); err != nil {
		if !fortiAPIPatch(o["vrf-select"]) {
			return fmt.Errorf("Error reading vrf_select: %v", err)
		}
	}

	if err = d.Set("custom_log_format", flattenLogSyslogd2OverrideSettingCustomLogFormat(o["custom-log-format"], d, "custom_log_format", sv)); err != nil {
...
func expandLogSyslogd2OverrideSettingVrfSelect(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandLogSyslogd2OverrideSettingCustomLogFormat(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func getObjectLogSyslogd2OverrideSetting(d *schema.ResourceData, setArgNil bool, sv string) (*map[string]interface{}, error) {
	...
	if v, ok := d.GetOkExists("vrf_select"); ok {
		if setArgNil {
			...
			t, err := expandLogSyslogd2OverrideSettingVrfSelect(d, v, "vrf_select", sv)
			if err != nil {
				return &obj, err
			} else if t != nil {
				obj["vrf-select"] = t
	...
	if v, ok := d.GetOk("custom_log_format"); ok {
		if setArgNil {
			...
			t, err := expandLogSyslogd2OverrideSettingCustomLogFormat(d, v, "custom_log_format", sv)
			if err != nil {
				return &obj, err
			} else if t != nil {
