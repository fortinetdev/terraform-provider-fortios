...
func flattenLogSyslogdFilterHttpTransaction(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func flattenLogSyslogdFilterFortiSwitch(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}

func flattenLogSyslogdFilterDebug(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func flattenLogSyslogdFilterFreeStyle(v interface{}, d *schema.ResourceData, pre string, sv string) []map[string]interface{} {
	...
	for _, r := range parsed_list {
		...
		if cur_v, ok := i["id"]; ok {
			...
			tmp["id"] = flattenLogSyslogdFilterFreeStyleId(cur_v, d, pre_append, sv)
		}
		...
		if cur_v, ok := i["category"]; ok {
			...
			tmp["category"] = flattenLogSyslogdFilterFreeStyleCategory(cur_v, d, pre_append, sv)
		}
		...
		if cur_v, ok := i["filter"]; ok {
			...
			tmp["filter"] = flattenLogSyslogdFilterFreeStyleFilter(cur_v, d, pre_append, sv)
		}
		...
		if cur_v, ok := i["filter-type"]; ok {
			...
			tmp["filter_type"] = flattenLogSyslogdFilterFreeStyleFilterType(cur_v, d, pre_append, sv)
		}
...
func refreshObjectLogSyslogdFilter(d *schema.ResourceData, o map[string]interface{}, sv string) error {
	...
	if err = d.Set("http_transaction", flattenLogSyslogdFilterHttpTransaction(o["http-transaction"], d, "http_transaction", sv)); err != nil {
	...
	if err = d.Set("forti_switch", flattenLogSyslogdFilterFortiSwitch(o["forti-switch"], d, "forti_switch", sv)); err != nil {
		if !fortiAPIPatch(o["forti-switch"]) {
			return fmt.Errorf("Error reading forti_switch: %v", err)
		}
	}

	if err = d.Set("debug", flattenLogSyslogdFilterDebug(o["debug"], d, "debug", sv)); err != nil {
...
func expandLogSyslogdFilterHttpTransaction(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func expandLogSyslogdFilterFortiSwitch(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandLogSyslogdFilterDebug(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func getObjectLogSyslogdFilter(d *schema.ResourceData, setArgNil bool, sv string) (*map[string]interface{}, error) {
	...
	if v, ok := d.GetOk("http_transaction"); ok {
		if setArgNil {
			...
			t, err := expandLogSyslogdFilterHttpTransaction(d, v, "http_transaction", sv)
			if err != nil {
				return &obj, err
			} else if t != nil {
	...
	if v, ok := d.GetOk("forti_switch"); ok {
		if setArgNil {
			...
			t, err := expandLogSyslogdFilterFortiSwitch(d, v, "forti_switch", sv)
			if err != nil {
				return &obj, err
			} else if t != nil {
				obj["forti-switch"] = t
	...
	if v, ok := d.GetOk("debug"); ok {
		if setArgNil {
			...
			t, err := expandLogSyslogdFilterDebug(d, v, "debug", sv)
			if err != nil {
				return &obj, err
			} else if t != nil {
				obj["debug"] = t
