...
func flattenFirewallScheduleOnetimeStartUtc(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func flattenFirewallScheduleOnetimeEndUtc(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func flattenFirewallScheduleOnetimeFabricForceSync(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}

func flattenFirewallScheduleOnetimeFabricObjectSource(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func refreshObjectFirewallScheduleOnetime(d *schema.ResourceData, o map[string]interface{}, sv string) error {
	...
	if err = d.Set("start_utc", flattenFirewallScheduleOnetimeStartUtc(o["start-utc"], d, "start_utc", sv)); err != nil {
	...
	if err = d.Set("end_utc", flattenFirewallScheduleOnetimeEndUtc(o["end-utc"], d, "end_utc", sv)); err != nil {
	...
	if err = d.Set("fabric_force_sync", flattenFirewallScheduleOnetimeFabricForceSync(o["fabric-force-sync"], d, "fabric_force_sync", sv)); err != nil {
		if !fortiAPIPatch(o["fabric-force-sync"]) {
			return fmt.Errorf("Error reading fabric_force_sync: %v", err)
		}
	}

	if err = d.Set("fabric_object_source", flattenFirewallScheduleOnetimeFabricObjectSource(o["fabric-object-source"], d, "fabric_object_source", sv)); err != nil {
...
func expandFirewallScheduleOnetimeStartUtc(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func expandFirewallScheduleOnetimeEndUtc(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func expandFirewallScheduleOnetimeFabricForceSync(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandFirewallScheduleOnetimeFabricObjectSource(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func getObjectFirewallScheduleOnetime(d *schema.ResourceData, sv string) (*map[string]interface{}, error) {
	...
	if v, ok := d.GetOk("start_utc"); ok {
		t, err := expandFirewallScheduleOnetimeStartUtc(d, v, "start_utc", sv)
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["start-utc"] = t
	...
	if v, ok := d.GetOk("end_utc"); ok {
		t, err := expandFirewallScheduleOnetimeEndUtc(d, v, "end_utc", sv)
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["end-utc"] = t
	...
	if v, ok := d.GetOk("fabric_force_sync"); ok {
		t, err := expandFirewallScheduleOnetimeFabricForceSync(d, v, "fabric_force_sync", sv)
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("fabric_object_source"); ok {
		t, err := expandFirewallScheduleOnetimeFabricObjectSource(d, v, "fabric_object_source", sv)
		if err != nil {
			return &obj, err
		} else if t != nil {
