...
func resourceLogSyslogd2SettingUpdate(d *schema.ResourceData, m interface{}) error {
	...
	o, err := c.UpdateLogSyslogd2Setting(obj, mkey, vdomparam)
	if err != nil {
...
func resourceLogSyslogd2SettingDelete(d *schema.ResourceData, m interface{}) error {
	...
	_, err = c.UpdateLogSyslogd2Setting(obj, mkey, vdomparam)
	if err != nil {
...
func resourceLogSyslogd2SettingRead(d *schema.ResourceData, m interface{}) error {
	...
	o, err := c.ReadLogSyslogd2Setting(mkey, vdomparam)
	if err != nil {
...
func flattenLogSyslogd2SettingSourceIpInterface(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func flattenLogSyslogd2SettingVrfSelect(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return convintf2i(v)
}

func flattenLogSyslogd2SettingCustomLogFormat(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func refreshObjectLogSyslogd2Setting(d *schema.ResourceData, o map[string]interface{}, sv string) error {
	...
	if err = d.Set("source_ip_interface", flattenLogSyslogd2SettingSourceIpInterface(o["source-ip-interface"], d, "source_ip_interface", sv)); err != nil {
	...
	if err = d.Set("vrf_select", flattenLogSyslogd2SettingVrfSelect(o["vrf-select"], d, "vrf_select", sv)); err != nil {
		if !fortiAPIPatch(o["vrf-select"]) {
			return fmt.Errorf("Error reading vrf_select: %v", err)
		}
	}

	if err = d.Set("custom_log_format", flattenLogSyslogd2SettingCustomLogFormat(o["custom-log-format"], d, "custom_log_format", sv)); err != nil {
...
func expandLogSyslogd2SettingSourceIpInterface(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func expandLogSyslogd2SettingVrfSelect(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandLogSyslogd2SettingCustomLogFormat(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func getObjectLogSyslogd2Setting(d *schema.ResourceData, setArgNil bool, sv string) (*map[string]interface{}, error) {
	...
	if v, ok := d.GetOk("source_ip_interface"); ok {
		if setArgNil {
			...
			t, err := expandLogSyslogd2SettingSourceIpInterface(d, v, "source_ip_interface", sv)
			if err != nil {
				return &obj, err
			} else if t != nil {
	...
	if v, ok := d.GetOkExists("vrf_select"); ok {
		if setArgNil {
			...
			t, err := expandLogSyslogd2SettingVrfSelect(d, v, "vrf_select", sv)
			if err != nil {
				return &obj, err
			} else if t != nil {
				obj["vrf-select"] = t
	...
	if v, ok := d.GetOk("custom_log_format"); ok {
		if setArgNil {
			...
			t, err := expandLogSyslogd2SettingCustomLogFormat(d, v, "custom_log_format", sv)
			if err != nil {
				return &obj, err
			} else if t != nil {
