...
func flattenWirelessControllerHotspot20HsProfileOsuProvider(v interface{}, d *schema.ResourceData, pre string) []map[string]interface{} {
	if v == nil {
		return nil
	}
	...
	for _, r := range l {
		...
		if _, ok := i["name"]; ok {
			tmp["name"] = flattenWirelessControllerHotspot20HsProfileOsuProviderName(i["name"], d, pre_append)
		}
...
func flattenWirelessControllerHotspot20HsProfileOsuProviderName(v interface{}, d *schema.ResourceData, pre string) interface{} {
	return v
}
...
func expandWirelessControllerHotspot20HsProfileOsuProvider(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	...
	for _, r := range l {
		...
		if _, ok := d.GetOk(pre_append); ok {
			tmp["name"], _ = expandWirelessControllerHotspot20HsProfileOsuProviderName(d, i["name"], pre_append)
		}
...
func expandWirelessControllerHotspot20HsProfileOsuProviderName(d *schema.ResourceData, v interface{}, pre string) (interface{}, error) {
	return v, nil
}
