...
func (c *Config) CreateClient() (interface{}, error) {
	...
	case "fortimanager":
		{
			return createFortiManagerClient(&fClient, c)
		}
	// default is for fortios provider
	default:
		{
			return createFortiOSClient(&fClient, c)
		}
	}
}

func createFortiManagerClient(fClient *FortiClient, c *Config) (interface{}, error) {
	if c.Hostname == "" {
...
func createFortiOSClient(fClient *FortiClient, c *Config) (interface{}, error) {
	config := &tls.Config{}
