...
func flattenWirelessControllerWtpProfileBonjourProfile(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func flattenWirelessControllerWtpProfileLwProfile(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func flattenWirelessControllerWtpProfileLedSchedules(v interface{}, d *schema.ResourceData, pre string, sv string) []map[string]interface{} {
	...
	for _, r := range parsed_list {
		...
		if cur_v, ok := i["name"]; ok {
			...
			tmp["name"] = flattenWirelessControllerWtpProfileLedSchedulesName(cur_v, d, pre_append, sv)
		}
...
func flattenWirelessControllerWtpProfileDenyMacList(v interface{}, d *schema.ResourceData, pre string, sv string) []map[string]interface{} {
	...
	for _, r := range parsed_list {
		...
		if cur_v, ok := i["id"]; ok {
			...
			tmp["id"] = flattenWirelessControllerWtpProfileDenyMacListId(cur_v, d, pre_append, sv)
		}
		...
		if cur_v, ok := i["mac"]; ok {
			...
			tmp["mac"] = flattenWirelessControllerWtpProfileDenyMacListMac(cur_v, d, pre_append, sv)
		}
...
func flattenWirelessControllerWtpProfileSplitTunnelingAcl(v interface{}, d *schema.ResourceData, pre string, sv string) []map[string]interface{} {
	...
	for _, r := range parsed_list {
		...
		if cur_v, ok := i["id"]; ok {
			...
			tmp["id"] = flattenWirelessControllerWtpProfileSplitTunnelingAclId(cur_v, d, pre_append, sv)
		}
		...
		if cur_v, ok := i["dest-ip"]; ok {
			...
			tmp["dest_ip"] = flattenWirelessControllerWtpProfileSplitTunnelingAclDestIp(cur_v, d, pre_append, sv)
		}
...
func flattenWirelessControllerWtpProfileRadio1(v interface{}, d *schema.ResourceData, pre string, sv string) []map[string]interface{} {
	...
	if _, ok := i["mimo-mode"]; ok {
		result["mimo_mode"] = flattenWirelessControllerWtpProfileRadio1MimoMode(i["mimo-mode"], d, pre_append, sv)
	}
	...
	if _, ok := i["optional-antenna-gain"]; ok {
		result["optional_antenna_gain"] = flattenWirelessControllerWtpProfileRadio1OptionalAntennaGain(i["optional-antenna-gain"], d, pre_append, sv)
	}
	...
	if _, ok := i["80211mc"]; ok {
		result["n80211mc"] = flattenWirelessControllerWtpProfileRadio180211Mc(i["80211mc"], d, pre_append, sv)
	}
	...
	if _, ok := i["ap-sniffer-chan-width"]; ok {
		result["ap_sniffer_chan_width"] = flattenWirelessControllerWtpProfileRadio1ApSnifferChanWidth(i["ap-sniffer-chan-width"], d, pre_append, sv)
	}
	...
	if _, ok := i["sam-eap-method"]; ok {
		result["sam_eap_method"] = flattenWirelessControllerWtpProfileRadio1SamEapMethod(i["sam-eap-method"], d, pre_append, sv)
	}

	pre_append = pre + ".0." + "sam_client_certificate"
	if _, ok := i["sam-client-certificate"]; ok {
		result["sam_client_certificate"] = flattenWirelessControllerWtpProfileRadio1SamClientCertificate(i["sam-client-certificate"], d, pre_append, sv)
	}

	pre_append = pre + ".0." + "sam_private_key"
	if _, ok := i["sam-private-key"]; ok {
		result["sam_private_key"] = flattenWirelessControllerWtpProfileRadio1SamPrivateKey(i["sam-private-key"], d, pre_append, sv)
	}
	...
	if _, ok := i["sam-private-key-password"]; ok {
		c := d.Get(pre_append).(string)
		if c != "" {
			result["sam_private_key_password"] = c
		}
	}

	pre_append = pre + ".0." + "sam_ca_certificate"
	if _, ok := i["sam-ca-certificate"]; ok {
		result["sam_ca_certificate"] = flattenWirelessControllerWtpProfileRadio1SamCaCertificate(i["sam-ca-certificate"], d, pre_append, sv)
	}
	...
	if _, ok := i["ai-darrp-support"]; ok {
		result["ai_darrp_support"] = flattenWirelessControllerWtpProfileRadio1AiDarrpSupport(i["ai-darrp-support"], d, pre_append, sv)
	}
...
func flattenWirelessControllerWtpProfileRadio1MimoMode(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func flattenWirelessControllerWtpProfileRadio1OptionalAntennaGain(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func flattenWirelessControllerWtpProfileRadio180211Mc(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func flattenWirelessControllerWtpProfileRadio1ApSnifferChanWidth(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func flattenWirelessControllerWtpProfileRadio1SamEapMethod(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}

func flattenWirelessControllerWtpProfileRadio1SamClientCertificate(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}

func flattenWirelessControllerWtpProfileRadio1SamPrivateKey(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}

func flattenWirelessControllerWtpProfileRadio1SamCaCertificate(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func flattenWirelessControllerWtpProfileRadio1AiDarrpSupport(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func flattenWirelessControllerWtpProfileRadio1Vaps(v interface{}, d *schema.ResourceData, pre string, sv string) []map[string]interface{} {
	...
	for _, r := range parsed_list {
		...
		if cur_v, ok := i["name"]; ok {
			...
			tmp["name"] = flattenWirelessControllerWtpProfileRadio1VapsName(cur_v, d, pre_append, sv)
		}
...
func flattenWirelessControllerWtpProfileRadio1Channel(v interface{}, d *schema.ResourceData, pre string, sv string) []map[string]interface{} {
	...
	for _, r := range parsed_list {
		...
		if cur_v, ok := i["chan"]; ok {
			...
			tmp["chan"] = flattenWirelessControllerWtpProfileRadio1ChannelChan(cur_v, d, pre_append, sv)
		}
...
func flattenWirelessControllerWtpProfileRadio2(v interface{}, d *schema.ResourceData, pre string, sv string) []map[string]interface{} {
	...
	pre_append = pre + ".0." + "mimo_mode"
	if _, ok := i["mimo-mode"]; ok {
		result["mimo_mode"] = flattenWirelessControllerWtpProfileRadio2MimoMode(i["mimo-mode"], d, pre_append, sv)
	}
	...
	pre_append = pre + ".0." + "optional_antenna_gain"
	if _, ok := i["optional-antenna-gain"]; ok {
		result["optional_antenna_gain"] = flattenWirelessControllerWtpProfileRadio2OptionalAntennaGain(i["optional-antenna-gain"], d, pre_append, sv)
	}
	...
	pre_append = pre + ".0." + "n80211mc"
	if _, ok := i["80211mc"]; ok {
		result["n80211mc"] = flattenWirelessControllerWtpProfileRadio280211Mc(i["80211mc"], d, pre_append, sv)
	}
	...
	pre_append = pre + ".0." + "ap_sniffer_chan_width"
	if _, ok := i["ap-sniffer-chan-width"]; ok {
		result["ap_sniffer_chan_width"] = flattenWirelessControllerWtpProfileRadio2ApSnifferChanWidth(i["ap-sniffer-chan-width"], d, pre_append, sv)
	}
	...
	pre_append = pre + ".0." + "sam_eap_method"
	if _, ok := i["sam-eap-method"]; ok {
		result["sam_eap_method"] = flattenWirelessControllerWtpProfileRadio2SamEapMethod(i["sam-eap-method"], d, pre_append, sv)
	}

	pre_append = pre + ".0." + "sam_client_certificate"
	if _, ok := i["sam-client-certificate"]; ok {
		result["sam_client_certificate"] = flattenWirelessControllerWtpProfileRadio2SamClientCertificate(i["sam-client-certificate"], d, pre_append, sv)
	}

	pre_append = pre + ".0." + "sam_private_key"
	if _, ok := i["sam-private-key"]; ok {
		result["sam_private_key"] = flattenWirelessControllerWtpProfileRadio2SamPrivateKey(i["sam-private-key"], d, pre_append, sv)
	}
	...
	pre_append = pre + ".0." + "sam_ca_certificate"
	if _, ok := i["sam-ca-certificate"]; ok {
		result["sam_ca_certificate"] = flattenWirelessControllerWtpProfileRadio2SamCaCertificate(i["sam-ca-certificate"], d, pre_append, sv)
	}
	...
	pre_append = pre + ".0." + "ai_darrp_support"
	if _, ok := i["ai-darrp-support"]; ok {
		result["ai_darrp_support"] = flattenWirelessControllerWtpProfileRadio2AiDarrpSupport(i["ai-darrp-support"], d, pre_append, sv)
	}
...
func flattenWirelessControllerWtpProfileRadio2MimoMode(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func flattenWirelessControllerWtpProfileRadio2OptionalAntennaGain(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func flattenWirelessControllerWtpProfileRadio280211Mc(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func flattenWirelessControllerWtpProfileRadio2ApSnifferChanWidth(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func flattenWirelessControllerWtpProfileRadio2SamEapMethod(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}

func flattenWirelessControllerWtpProfileRadio2SamClientCertificate(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}

func flattenWirelessControllerWtpProfileRadio2SamPrivateKey(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}

func flattenWirelessControllerWtpProfileRadio2SamCaCertificate(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func flattenWirelessControllerWtpProfileRadio2AiDarrpSupport(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func flattenWirelessControllerWtpProfileRadio2Vaps(v interface{}, d *schema.ResourceData, pre string, sv string) []map[string]interface{} {
	...
	for _, r := range parsed_list {
		...
		if cur_v, ok := i["name"]; ok {
			...
			tmp["name"] = flattenWirelessControllerWtpProfileRadio2VapsName(cur_v, d, pre_append, sv)
		}
...
func flattenWirelessControllerWtpProfileRadio2Channel(v interface{}, d *schema.ResourceData, pre string, sv string) []map[string]interface{} {
	...
	for _, r := range parsed_list {
		...
		if cur_v, ok := i["chan"]; ok {
			...
			tmp["chan"] = flattenWirelessControllerWtpProfileRadio2ChannelChan(cur_v, d, pre_append, sv)
		}
...
func flattenWirelessControllerWtpProfileRadio3(v interface{}, d *schema.ResourceData, pre string, sv string) []map[string]interface{} {
	...
	pre_append = pre + ".0." + "mimo_mode"
	if _, ok := i["mimo-mode"]; ok {
		result["mimo_mode"] = flattenWirelessControllerWtpProfileRadio3MimoMode(i["mimo-mode"], d, pre_append, sv)
	}
	...
	pre_append = pre + ".0." + "optional_antenna_gain"
	if _, ok := i["optional-antenna-gain"]; ok {
		result["optional_antenna_gain"] = flattenWirelessControllerWtpProfileRadio3OptionalAntennaGain(i["optional-antenna-gain"], d, pre_append, sv)
	}
	...
	pre_append = pre + ".0." + "n80211mc"
	if _, ok := i["80211mc"]; ok {
		result["n80211mc"] = flattenWirelessControllerWtpProfileRadio380211Mc(i["80211mc"], d, pre_append, sv)
	}
	...
	pre_append = pre + ".0." + "ap_sniffer_chan_width"
	if _, ok := i["ap-sniffer-chan-width"]; ok {
		result["ap_sniffer_chan_width"] = flattenWirelessControllerWtpProfileRadio3ApSnifferChanWidth(i["ap-sniffer-chan-width"], d, pre_append, sv)
	}
	...
	pre_append = pre + ".0." + "sam_eap_method"
	if _, ok := i["sam-eap-method"]; ok {
		result["sam_eap_method"] = flattenWirelessControllerWtpProfileRadio3SamEapMethod(i["sam-eap-method"], d, pre_append, sv)
	}

	pre_append = pre + ".0." + "sam_client_certificate"
	if _, ok := i["sam-client-certificate"]; ok {
		result["sam_client_certificate"] = flattenWirelessControllerWtpProfileRadio3SamClientCertificate(i["sam-client-certificate"], d, pre_append, sv)
	}

	pre_append = pre + ".0." + "sam_private_key"
	if _, ok := i["sam-private-key"]; ok {
		result["sam_private_key"] = flattenWirelessControllerWtpProfileRadio3SamPrivateKey(i["sam-private-key"], d, pre_append, sv)
	}
	...
	pre_append = pre + ".0." + "sam_ca_certificate"
	if _, ok := i["sam-ca-certificate"]; ok {
		result["sam_ca_certificate"] = flattenWirelessControllerWtpProfileRadio3SamCaCertificate(i["sam-ca-certificate"], d, pre_append, sv)
	}
	...
	pre_append = pre + ".0." + "ai_darrp_support"
	if _, ok := i["ai-darrp-support"]; ok {
		result["ai_darrp_support"] = flattenWirelessControllerWtpProfileRadio3AiDarrpSupport(i["ai-darrp-support"], d, pre_append, sv)
	}
...
func flattenWirelessControllerWtpProfileRadio3MimoMode(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func flattenWirelessControllerWtpProfileRadio3OptionalAntennaGain(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func flattenWirelessControllerWtpProfileRadio380211Mc(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func flattenWirelessControllerWtpProfileRadio3ApSnifferChanWidth(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func flattenWirelessControllerWtpProfileRadio3SamEapMethod(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}

func flattenWirelessControllerWtpProfileRadio3SamClientCertificate(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}

func flattenWirelessControllerWtpProfileRadio3SamPrivateKey(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}

func flattenWirelessControllerWtpProfileRadio3SamCaCertificate(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func flattenWirelessControllerWtpProfileRadio3AiDarrpSupport(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func flattenWirelessControllerWtpProfileRadio3Vaps(v interface{}, d *schema.ResourceData, pre string, sv string) []map[string]interface{} {
	...
	for _, r := range parsed_list {
		...
		if cur_v, ok := i["name"]; ok {
			...
			tmp["name"] = flattenWirelessControllerWtpProfileRadio3VapsName(cur_v, d, pre_append, sv)
		}
...
func flattenWirelessControllerWtpProfileRadio3Channel(v interface{}, d *schema.ResourceData, pre string, sv string) []map[string]interface{} {
	...
	for _, r := range parsed_list {
		...
		if cur_v, ok := i["chan"]; ok {
			...
			tmp["chan"] = flattenWirelessControllerWtpProfileRadio3ChannelChan(cur_v, d, pre_append, sv)
		}
...
func flattenWirelessControllerWtpProfileRadio4(v interface{}, d *schema.ResourceData, pre string, sv string) []map[string]interface{} {
	...
	pre_append = pre + ".0." + "mimo_mode"
	if _, ok := i["mimo-mode"]; ok {
		result["mimo_mode"] = flattenWirelessControllerWtpProfileRadio4MimoMode(i["mimo-mode"], d, pre_append, sv)
	}
	...
	pre_append = pre + ".0." + "optional_antenna_gain"
	if _, ok := i["optional-antenna-gain"]; ok {
		result["optional_antenna_gain"] = flattenWirelessControllerWtpProfileRadio4OptionalAntennaGain(i["optional-antenna-gain"], d, pre_append, sv)
	}
	...
	pre_append = pre + ".0." + "n80211mc"
	if _, ok := i["80211mc"]; ok {
		result["n80211mc"] = flattenWirelessControllerWtpProfileRadio480211Mc(i["80211mc"], d, pre_append, sv)
	}
	...
	pre_append = pre + ".0." + "ap_sniffer_chan_width"
	if _, ok := i["ap-sniffer-chan-width"]; ok {
		result["ap_sniffer_chan_width"] = flattenWirelessControllerWtpProfileRadio4ApSnifferChanWidth(i["ap-sniffer-chan-width"], d, pre_append, sv)
	}
	...
	pre_append = pre + ".0." + "sam_eap_method"
	if _, ok := i["sam-eap-method"]; ok {
		result["sam_eap_method"] = flattenWirelessControllerWtpProfileRadio4SamEapMethod(i["sam-eap-method"], d, pre_append, sv)
	}

	pre_append = pre + ".0." + "sam_client_certificate"
	if _, ok := i["sam-client-certificate"]; ok {
		result["sam_client_certificate"] = flattenWirelessControllerWtpProfileRadio4SamClientCertificate(i["sam-client-certificate"], d, pre_append, sv)
	}

	pre_append = pre + ".0." + "sam_private_key"
	if _, ok := i["sam-private-key"]; ok {
		result["sam_private_key"] = flattenWirelessControllerWtpProfileRadio4SamPrivateKey(i["sam-private-key"], d, pre_append, sv)
	}
	...
	pre_append = pre + ".0." + "sam_ca_certificate"
	if _, ok := i["sam-ca-certificate"]; ok {
		result["sam_ca_certificate"] = flattenWirelessControllerWtpProfileRadio4SamCaCertificate(i["sam-ca-certificate"], d, pre_append, sv)
	}
	...
	pre_append = pre + ".0." + "ai_darrp_support"
	if _, ok := i["ai-darrp-support"]; ok {
		result["ai_darrp_support"] = flattenWirelessControllerWtpProfileRadio4AiDarrpSupport(i["ai-darrp-support"], d, pre_append, sv)
	}
...
func flattenWirelessControllerWtpProfileRadio4MimoMode(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func flattenWirelessControllerWtpProfileRadio4OptionalAntennaGain(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func flattenWirelessControllerWtpProfileRadio480211Mc(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func flattenWirelessControllerWtpProfileRadio4ApSnifferChanWidth(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func flattenWirelessControllerWtpProfileRadio4SamEapMethod(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}

func flattenWirelessControllerWtpProfileRadio4SamClientCertificate(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}

func flattenWirelessControllerWtpProfileRadio4SamPrivateKey(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}

func flattenWirelessControllerWtpProfileRadio4SamCaCertificate(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func flattenWirelessControllerWtpProfileRadio4AiDarrpSupport(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func flattenWirelessControllerWtpProfileRadio4Vaps(v interface{}, d *schema.ResourceData, pre string, sv string) []map[string]interface{} {
	...
	for _, r := range parsed_list {
		...
		if cur_v, ok := i["name"]; ok {
			...
			tmp["name"] = flattenWirelessControllerWtpProfileRadio4VapsName(cur_v, d, pre_append, sv)
		}
...
func flattenWirelessControllerWtpProfileRadio4Channel(v interface{}, d *schema.ResourceData, pre string, sv string) []map[string]interface{} {
	...
	for _, r := range parsed_list {
		...
		if cur_v, ok := i["chan"]; ok {
			...
			tmp["chan"] = flattenWirelessControllerWtpProfileRadio4ChannelChan(cur_v, d, pre_append, sv)
		}
...
func flattenWirelessControllerWtpProfileLbs(v interface{}, d *schema.ResourceData, pre string, sv string) []map[string]interface{} {
	...
	if _, ok := i["ble-rtls"]; ok {
		result["ble_rtls"] = flattenWirelessControllerWtpProfileLbsBleRtls(i["ble-rtls"], d, pre_append, sv)
	}

	pre_append = pre + ".0." + "ble_rtls_protocol"
	if _, ok := i["ble-rtls-protocol"]; ok {
		result["ble_rtls_protocol"] = flattenWirelessControllerWtpProfileLbsBleRtlsProtocol(i["ble-rtls-protocol"], d, pre_append, sv)
	}

	pre_append = pre + ".0." + "ble_rtls_server_fqdn"
	if _, ok := i["ble-rtls-server-fqdn"]; ok {
		result["ble_rtls_server_fqdn"] = flattenWirelessControllerWtpProfileLbsBleRtlsServerFqdn(i["ble-rtls-server-fqdn"], d, pre_append, sv)
	}

	pre_append = pre + ".0." + "ble_rtls_server_path"
	if _, ok := i["ble-rtls-server-path"]; ok {
		result["ble_rtls_server_path"] = flattenWirelessControllerWtpProfileLbsBleRtlsServerPath(i["ble-rtls-server-path"], d, pre_append, sv)
	}

	pre_append = pre + ".0." + "ble_rtls_server_token"
	if _, ok := i["ble-rtls-server-token"]; ok {
		result["ble_rtls_server_token"] = flattenWirelessControllerWtpProfileLbsBleRtlsServerToken(i["ble-rtls-server-token"], d, pre_append, sv)
	}

	pre_append = pre + ".0." + "ble_rtls_server_port"
	if _, ok := i["ble-rtls-server-port"]; ok {
		result["ble_rtls_server_port"] = flattenWirelessControllerWtpProfileLbsBleRtlsServerPort(i["ble-rtls-server-port"], d, pre_append, sv)
	}

	pre_append = pre + ".0." + "ble_rtls_accumulation_interval"
	if _, ok := i["ble-rtls-accumulation-interval"]; ok {
		result["ble_rtls_accumulation_interval"] = flattenWirelessControllerWtpProfileLbsBleRtlsAccumulationInterval(i["ble-rtls-accumulation-interval"], d, pre_append, sv)
	}

	pre_append = pre + ".0." + "ble_rtls_reporting_interval"
	if _, ok := i["ble-rtls-reporting-interval"]; ok {
		result["ble_rtls_reporting_interval"] = flattenWirelessControllerWtpProfileLbsBleRtlsReportingInterval(i["ble-rtls-reporting-interval"], d, pre_append, sv)
	}

	pre_append = pre + ".0." + "ble_rtls_asset_uuid_list1"
	if _, ok := i["ble-rtls-asset-uuid-list1"]; ok {
		result["ble_rtls_asset_uuid_list1"] = flattenWirelessControllerWtpProfileLbsBleRtlsAssetUuidList1(i["ble-rtls-asset-uuid-list1"], d, pre_append, sv)
	}

	pre_append = pre + ".0." + "ble_rtls_asset_uuid_list2"
	if _, ok := i["ble-rtls-asset-uuid-list2"]; ok {
		result["ble_rtls_asset_uuid_list2"] = flattenWirelessControllerWtpProfileLbsBleRtlsAssetUuidList2(i["ble-rtls-asset-uuid-list2"], d, pre_append, sv)
	}

	pre_append = pre + ".0." + "ble_rtls_asset_uuid_list3"
	if _, ok := i["ble-rtls-asset-uuid-list3"]; ok {
		result["ble_rtls_asset_uuid_list3"] = flattenWirelessControllerWtpProfileLbsBleRtlsAssetUuidList3(i["ble-rtls-asset-uuid-list3"], d, pre_append, sv)
	}

	pre_append = pre + ".0." + "ble_rtls_asset_uuid_list4"
	if _, ok := i["ble-rtls-asset-uuid-list4"]; ok {
		result["ble_rtls_asset_uuid_list4"] = flattenWirelessControllerWtpProfileLbsBleRtlsAssetUuidList4(i["ble-rtls-asset-uuid-list4"], d, pre_append, sv)
	}

	pre_append = pre + ".0." + "ble_rtls_asset_addrgrp_list"
	if _, ok := i["ble-rtls-asset-addrgrp-list"]; ok {
		result["ble_rtls_asset_addrgrp_list"] = flattenWirelessControllerWtpProfileLbsBleRtlsAssetAddrgrpList(i["ble-rtls-asset-addrgrp-list"], d, pre_append, sv)
	}

	pre_append = pre + ".0." + "polestar"
	if _, ok := i["polestar"]; ok {
		result["polestar"] = flattenWirelessControllerWtpProfileLbsPolestar(i["polestar"], d, pre_append, sv)
	}

	pre_append = pre + ".0." + "polestar_protocol"
	if _, ok := i["polestar-protocol"]; ok {
		result["polestar_protocol"] = flattenWirelessControllerWtpProfileLbsPolestarProtocol(i["polestar-protocol"], d, pre_append, sv)
	}

	pre_append = pre + ".0." + "polestar_server_fqdn"
	if _, ok := i["polestar-server-fqdn"]; ok {
		result["polestar_server_fqdn"] = flattenWirelessControllerWtpProfileLbsPolestarServerFqdn(i["polestar-server-fqdn"], d, pre_append, sv)
	}

	pre_append = pre + ".0." + "polestar_server_path"
	if _, ok := i["polestar-server-path"]; ok {
		result["polestar_server_path"] = flattenWirelessControllerWtpProfileLbsPolestarServerPath(i["polestar-server-path"], d, pre_append, sv)
	}

	pre_append = pre + ".0." + "polestar_server_token"
	if _, ok := i["polestar-server-token"]; ok {
		result["polestar_server_token"] = flattenWirelessControllerWtpProfileLbsPolestarServerToken(i["polestar-server-token"], d, pre_append, sv)
	}

	pre_append = pre + ".0." + "polestar_server_port"
	if _, ok := i["polestar-server-port"]; ok {
		result["polestar_server_port"] = flattenWirelessControllerWtpProfileLbsPolestarServerPort(i["polestar-server-port"], d, pre_append, sv)
	}

	pre_append = pre + ".0." + "polestar_accumulation_interval"
	if _, ok := i["polestar-accumulation-interval"]; ok {
		result["polestar_accumulation_interval"] = flattenWirelessControllerWtpProfileLbsPolestarAccumulationInterval(i["polestar-accumulation-interval"], d, pre_append, sv)
	}

	pre_append = pre + ".0." + "polestar_reporting_interval"
	if _, ok := i["polestar-reporting-interval"]; ok {
		result["polestar_reporting_interval"] = flattenWirelessControllerWtpProfileLbsPolestarReportingInterval(i["polestar-reporting-interval"], d, pre_append, sv)
	}

	pre_append = pre + ".0." + "polestar_asset_uuid_list1"
	if _, ok := i["polestar-asset-uuid-list1"]; ok {
		result["polestar_asset_uuid_list1"] = flattenWirelessControllerWtpProfileLbsPolestarAssetUuidList1(i["polestar-asset-uuid-list1"], d, pre_append, sv)
	}

	pre_append = pre + ".0." + "polestar_asset_uuid_list2"
	if _, ok := i["polestar-asset-uuid-list2"]; ok {
		result["polestar_asset_uuid_list2"] = flattenWirelessControllerWtpProfileLbsPolestarAssetUuidList2(i["polestar-asset-uuid-list2"], d, pre_append, sv)
	}

	pre_append = pre + ".0." + "polestar_asset_uuid_list3"
	if _, ok := i["polestar-asset-uuid-list3"]; ok {
		result["polestar_asset_uuid_list3"] = flattenWirelessControllerWtpProfileLbsPolestarAssetUuidList3(i["polestar-asset-uuid-list3"], d, pre_append, sv)
	}

	pre_append = pre + ".0." + "polestar_asset_uuid_list4"
	if _, ok := i["polestar-asset-uuid-list4"]; ok {
		result["polestar_asset_uuid_list4"] = flattenWirelessControllerWtpProfileLbsPolestarAssetUuidList4(i["polestar-asset-uuid-list4"], d, pre_append, sv)
	}

	pre_append = pre + ".0." + "polestar_asset_addrgrp_list"
	if _, ok := i["polestar-asset-addrgrp-list"]; ok {
		result["polestar_asset_addrgrp_list"] = flattenWirelessControllerWtpProfileLbsPolestarAssetAddrgrpList(i["polestar-asset-addrgrp-list"], d, pre_append, sv)
	}
...
func flattenWirelessControllerWtpProfileLbsBleRtls(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}

func flattenWirelessControllerWtpProfileLbsBleRtlsProtocol(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}

func flattenWirelessControllerWtpProfileLbsBleRtlsServerFqdn(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}

func flattenWirelessControllerWtpProfileLbsBleRtlsServerPath(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}

func flattenWirelessControllerWtpProfileLbsBleRtlsServerToken(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}

func flattenWirelessControllerWtpProfileLbsBleRtlsServerPort(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return convintf2i(v)
}

func flattenWirelessControllerWtpProfileLbsBleRtlsAccumulationInterval(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return convintf2i(v)
}

func flattenWirelessControllerWtpProfileLbsBleRtlsReportingInterval(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return convintf2i(v)
}

func flattenWirelessControllerWtpProfileLbsBleRtlsAssetUuidList1(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}

func flattenWirelessControllerWtpProfileLbsBleRtlsAssetUuidList2(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}

func flattenWirelessControllerWtpProfileLbsBleRtlsAssetUuidList3(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}

func flattenWirelessControllerWtpProfileLbsBleRtlsAssetUuidList4(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}

func flattenWirelessControllerWtpProfileLbsBleRtlsAssetAddrgrpList(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}

func flattenWirelessControllerWtpProfileLbsPolestar(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}

func flattenWirelessControllerWtpProfileLbsPolestarProtocol(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}

func flattenWirelessControllerWtpProfileLbsPolestarServerFqdn(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}

func flattenWirelessControllerWtpProfileLbsPolestarServerPath(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}

func flattenWirelessControllerWtpProfileLbsPolestarServerToken(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}

func flattenWirelessControllerWtpProfileLbsPolestarServerPort(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return convintf2i(v)
}

func flattenWirelessControllerWtpProfileLbsPolestarAccumulationInterval(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return convintf2i(v)
}

func flattenWirelessControllerWtpProfileLbsPolestarReportingInterval(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return convintf2i(v)
}

func flattenWirelessControllerWtpProfileLbsPolestarAssetUuidList1(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}

func flattenWirelessControllerWtpProfileLbsPolestarAssetUuidList2(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}

func flattenWirelessControllerWtpProfileLbsPolestarAssetUuidList3(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}

func flattenWirelessControllerWtpProfileLbsPolestarAssetUuidList4(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}

func flattenWirelessControllerWtpProfileLbsPolestarAssetAddrgrpList(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func flattenWirelessControllerWtpProfileWanPortAuthMacsec(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}

func flattenWirelessControllerWtpProfileApcfgAutoCert(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}

func flattenWirelessControllerWtpProfileApcfgAutoCertEnrollProtocol(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}

func flattenWirelessControllerWtpProfileApcfgAutoCertCryptoAlgo(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}

func flattenWirelessControllerWtpProfileApcfgAutoCertEstServer(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}

func flattenWirelessControllerWtpProfileApcfgAutoCertEstCaId(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}

func flattenWirelessControllerWtpProfileApcfgAutoCertEstHttpUsername(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}

func flattenWirelessControllerWtpProfileApcfgAutoCertEstSubject(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}

func flattenWirelessControllerWtpProfileApcfgAutoCertEstSubjectAltName(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}

func flattenWirelessControllerWtpProfileApcfgAutoCertAutoRegenDays(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return convintf2i(v)
}

func flattenWirelessControllerWtpProfileApcfgAutoCertEstHttpsCa(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}

func flattenWirelessControllerWtpProfileApcfgAutoCertScepKeytype(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}

func flattenWirelessControllerWtpProfileApcfgAutoCertScepKeysize(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}

func flattenWirelessControllerWtpProfileApcfgAutoCertScepEcName(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}

func flattenWirelessControllerWtpProfileApcfgAutoCertScepSubFullyDn(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}

func flattenWirelessControllerWtpProfileApcfgAutoCertScepUrl(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}

func flattenWirelessControllerWtpProfileApcfgAutoCertScepCaId(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}

func flattenWirelessControllerWtpProfileApcfgAutoCertScepSubjectAltName(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}

func flattenWirelessControllerWtpProfileApcfgAutoCertScepHttpsCa(v interface{}, d *schema.ResourceData, pre string, sv string) interface{} {
	return v
}
...
func refreshObjectWirelessControllerWtpProfile(d *schema.ResourceData, o map[string]interface{}, sv string) error {
	...
	if err = d.Set("bonjour_profile", flattenWirelessControllerWtpProfileBonjourProfile(o["bonjour-profile"], d, "bonjour_profile", sv)); err != nil {
	...
	if err = d.Set("lw_profile", flattenWirelessControllerWtpProfileLwProfile(o["lw-profile"], d, "lw_profile", sv)); err != nil {
		if !fortiAPIPatch(o["lw-profile"]) {
	...
	if err = d.Set("wan_port_auth_macsec", flattenWirelessControllerWtpProfileWanPortAuthMacsec(o["wan-port-auth-macsec"], d, "wan_port_auth_macsec", sv)); err != nil {
		if !fortiAPIPatch(o["wan-port-auth-macsec"]) {
			return fmt.Errorf("Error reading wan_port_auth_macsec: %v", err)
		}
	}

	if err = d.Set("apcfg_auto_cert", flattenWirelessControllerWtpProfileApcfgAutoCert(o["apcfg-auto-cert"], d, "apcfg_auto_cert", sv)); err != nil {
		if !fortiAPIPatch(o["apcfg-auto-cert"]) {
			return fmt.Errorf("Error reading apcfg_auto_cert: %v", err)
		}
	}

	if err = d.Set("apcfg_auto_cert_enroll_protocol", flattenWirelessControllerWtpProfileApcfgAutoCertEnrollProtocol(o["apcfg-auto-cert-enroll-protocol"], d, "apcfg_auto_cert_enroll_protocol", sv)); err != nil {
		if !fortiAPIPatch(o["apcfg-auto-cert-enroll-protocol"]) {
			return fmt.Errorf("Error reading apcfg_auto_cert_enroll_protocol: %v", err)
		}
	}

	if err = d.Set("apcfg_auto_cert_crypto_algo", flattenWirelessControllerWtpProfileApcfgAutoCertCryptoAlgo(o["apcfg-auto-cert-crypto-algo"], d, "apcfg_auto_cert_crypto_algo", sv)); err != nil {
		if !fortiAPIPatch(o["apcfg-auto-cert-crypto-algo"]) {
			return fmt.Errorf("Error reading apcfg_auto_cert_crypto_algo: %v", err)
		}
	}

	if err = d.Set("apcfg_auto_cert_est_server", flattenWirelessControllerWtpProfileApcfgAutoCertEstServer(o["apcfg-auto-cert-est-server"], d, "apcfg_auto_cert_est_server", sv)); err != nil {
		if !fortiAPIPatch(o["apcfg-auto-cert-est-server"]) {
			return fmt.Errorf("Error reading apcfg_auto_cert_est_server: %v", err)
		}
	}

	if err = d.Set("apcfg_auto_cert_est_ca_id", flattenWirelessControllerWtpProfileApcfgAutoCertEstCaId(o["apcfg-auto-cert-est-ca-id"], d, "apcfg_auto_cert_est_ca_id", sv)); err != nil {
		if !fortiAPIPatch(o["apcfg-auto-cert-est-ca-id"]) {
			return fmt.Errorf("Error reading apcfg_auto_cert_est_ca_id: %v", err)
		}
	}

	if err = d.Set("apcfg_auto_cert_est_http_username", flattenWirelessControllerWtpProfileApcfgAutoCertEstHttpUsername(o["apcfg-auto-cert-est-http-username"], d, "apcfg_auto_cert_est_http_username", sv)); err != nil {
		if !fortiAPIPatch(o["apcfg-auto-cert-est-http-username"]) {
			return fmt.Errorf("Error reading apcfg_auto_cert_est_http_username: %v", err)
		}
	}

	if err = d.Set("apcfg_auto_cert_est_subject", flattenWirelessControllerWtpProfileApcfgAutoCertEstSubject(o["apcfg-auto-cert-est-subject"], d, "apcfg_auto_cert_est_subject", sv)); err != nil {
		if !fortiAPIPatch(o["apcfg-auto-cert-est-subject"]) {
			return fmt.Errorf("Error reading apcfg_auto_cert_est_subject: %v", err)
		}
	}

	if err = d.Set("apcfg_auto_cert_est_subject_alt_name", flattenWirelessControllerWtpProfileApcfgAutoCertEstSubjectAltName(o["apcfg-auto-cert-est-subject-alt-name"], d, "apcfg_auto_cert_est_subject_alt_name", sv)); err != nil {
		if !fortiAPIPatch(o["apcfg-auto-cert-est-subject-alt-name"]) {
			return fmt.Errorf("Error reading apcfg_auto_cert_est_subject_alt_name: %v", err)
		}
	}

	if err = d.Set("apcfg_auto_cert_auto_regen_days", flattenWirelessControllerWtpProfileApcfgAutoCertAutoRegenDays(o["apcfg-auto-cert-auto-regen-days"], d, "apcfg_auto_cert_auto_regen_days", sv)); err != nil {
		if !fortiAPIPatch(o["apcfg-auto-cert-auto-regen-days"]) {
			return fmt.Errorf("Error reading apcfg_auto_cert_auto_regen_days: %v", err)
		}
	}

	if err = d.Set("apcfg_auto_cert_est_https_ca", flattenWirelessControllerWtpProfileApcfgAutoCertEstHttpsCa(o["apcfg-auto-cert-est-https-ca"], d, "apcfg_auto_cert_est_https_ca", sv)); err != nil {
		if !fortiAPIPatch(o["apcfg-auto-cert-est-https-ca"]) {
			return fmt.Errorf("Error reading apcfg_auto_cert_est_https_ca: %v", err)
		}
	}

	if err = d.Set("apcfg_auto_cert_scep_keytype", flattenWirelessControllerWtpProfileApcfgAutoCertScepKeytype(o["apcfg-auto-cert-scep-keytype"], d, "apcfg_auto_cert_scep_keytype", sv)); err != nil {
		if !fortiAPIPatch(o["apcfg-auto-cert-scep-keytype"]) {
			return fmt.Errorf("Error reading apcfg_auto_cert_scep_keytype: %v", err)
		}
	}

	if err = d.Set("apcfg_auto_cert_scep_keysize", flattenWirelessControllerWtpProfileApcfgAutoCertScepKeysize(o["apcfg-auto-cert-scep-keysize"], d, "apcfg_auto_cert_scep_keysize", sv)); err != nil {
		if !fortiAPIPatch(o["apcfg-auto-cert-scep-keysize"]) {
			return fmt.Errorf("Error reading apcfg_auto_cert_scep_keysize: %v", err)
		}
	}

	if err = d.Set("apcfg_auto_cert_scep_ec_name", flattenWirelessControllerWtpProfileApcfgAutoCertScepEcName(o["apcfg-auto-cert-scep-ec-name"], d, "apcfg_auto_cert_scep_ec_name", sv)); err != nil {
		if !fortiAPIPatch(o["apcfg-auto-cert-scep-ec-name"]) {
			return fmt.Errorf("Error reading apcfg_auto_cert_scep_ec_name: %v", err)
		}
	}

	if err = d.Set("apcfg_auto_cert_scep_sub_fully_dn", flattenWirelessControllerWtpProfileApcfgAutoCertScepSubFullyDn(o["apcfg-auto-cert-scep-sub-fully-dn"], d, "apcfg_auto_cert_scep_sub_fully_dn", sv)); err != nil {
		if !fortiAPIPatch(o["apcfg-auto-cert-scep-sub-fully-dn"]) {
			return fmt.Errorf("Error reading apcfg_auto_cert_scep_sub_fully_dn: %v", err)
		}
	}

	if err = d.Set("apcfg_auto_cert_scep_url", flattenWirelessControllerWtpProfileApcfgAutoCertScepUrl(o["apcfg-auto-cert-scep-url"], d, "apcfg_auto_cert_scep_url", sv)); err != nil {
		if !fortiAPIPatch(o["apcfg-auto-cert-scep-url"]) {
			return fmt.Errorf("Error reading apcfg_auto_cert_scep_url: %v", err)
		}
	}

	if err = d.Set("apcfg_auto_cert_scep_ca_id", flattenWirelessControllerWtpProfileApcfgAutoCertScepCaId(o["apcfg-auto-cert-scep-ca-id"], d, "apcfg_auto_cert_scep_ca_id", sv)); err != nil {
		if !fortiAPIPatch(o["apcfg-auto-cert-scep-ca-id"]) {
			return fmt.Errorf("Error reading apcfg_auto_cert_scep_ca_id: %v", err)
		}
	}

	if err = d.Set("apcfg_auto_cert_scep_subject_alt_name", flattenWirelessControllerWtpProfileApcfgAutoCertScepSubjectAltName(o["apcfg-auto-cert-scep-subject-alt-name"], d, "apcfg_auto_cert_scep_subject_alt_name", sv)); err != nil {
		if !fortiAPIPatch(o["apcfg-auto-cert-scep-subject-alt-name"]) {
			return fmt.Errorf("Error reading apcfg_auto_cert_scep_subject_alt_name: %v", err)
		}
	}

	if err = d.Set("apcfg_auto_cert_scep_https_ca", flattenWirelessControllerWtpProfileApcfgAutoCertScepHttpsCa(o["apcfg-auto-cert-scep-https-ca"], d, "apcfg_auto_cert_scep_https_ca", sv)); err != nil {
		if !fortiAPIPatch(o["apcfg-auto-cert-scep-https-ca"]) {
...
func expandWirelessControllerWtpProfileBonjourProfile(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func expandWirelessControllerWtpProfileLwProfile(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func expandWirelessControllerWtpProfileRadio1(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	...
	pre_append = pre + ".0." + "mimo_mode"
	if _, ok := d.GetOk(pre_append); ok {
		result["mimo-mode"], _ = expandWirelessControllerWtpProfileRadio1MimoMode(d, i["mimo_mode"], pre_append, sv)
	}
	pre_append = pre + ".0." + "channel_bonding"
	if _, ok := d.GetOk(pre_append); ok {
	...
	pre_append = pre + ".0." + "optional_antenna_gain"
	if _, ok := d.GetOk(pre_append); ok {
		result["optional-antenna-gain"], _ = expandWirelessControllerWtpProfileRadio1OptionalAntennaGain(d, i["optional_antenna_gain"], pre_append, sv)
	}
	pre_append = pre + ".0." + "auto_power_level"
	if _, ok := d.GetOk(pre_append); ok {
	...
	pre_append = pre + ".0." + "n80211mc"
	if _, ok := d.GetOk(pre_append); ok {
		result["80211mc"], _ = expandWirelessControllerWtpProfileRadio180211Mc(d, i["n80211mc"], pre_append, sv)
	}
	pre_append = pre + ".0." + "rts_threshold"
	if _, ok := d.GetOk(pre_append); ok {
	...
	pre_append = pre + ".0." + "ap_sniffer_chan_width"
	if _, ok := d.GetOk(pre_append); ok {
		result["ap-sniffer-chan-width"], _ = expandWirelessControllerWtpProfileRadio1ApSnifferChanWidth(d, i["ap_sniffer_chan_width"], pre_append, sv)
	}
	pre_append = pre + ".0." + "ap_sniffer_addr"
	if _, ok := d.GetOk(pre_append); ok {
	...
	if _, ok := d.GetOk(pre_append); ok {
		...
		result["sam-cwp-match-string"] = nil
	}
	pre_append = pre + ".0." + "sam_cwp_success_string"
	if _, ok := d.GetOk(pre_append); ok {
		...
		result["sam-cwp-success-string"] = nil
	}
	pre_append = pre + ".0." + "sam_cwp_failure_string"
	if _, ok := d.GetOk(pre_append); ok {
		...
		result["sam-cwp-failure-string"] = nil
	}
	pre_append = pre + ".0." + "sam_eap_method"
	if _, ok := d.GetOk(pre_append); ok {
		result["sam-eap-method"], _ = expandWirelessControllerWtpProfileRadio1SamEapMethod(d, i["sam_eap_method"], pre_append, sv)
	}
	pre_append = pre + ".0." + "sam_client_certificate"
	if _, ok := d.GetOk(pre_append); ok {
		result["sam-client-certificate"], _ = expandWirelessControllerWtpProfileRadio1SamClientCertificate(d, i["sam_client_certificate"], pre_append, sv)
	} else if d.HasChange(pre_append) {
		result["sam-client-certificate"] = nil
	}
	pre_append = pre + ".0." + "sam_private_key"
	if _, ok := d.GetOk(pre_append); ok {
		result["sam-private-key"], _ = expandWirelessControllerWtpProfileRadio1SamPrivateKey(d, i["sam_private_key"], pre_append, sv)
	} else if d.HasChange(pre_append) {
		result["sam-private-key"] = nil
	}
	pre_append = pre + ".0." + "sam_private_key_password"
	if _, ok := d.GetOk(pre_append); ok {
		result["sam-private-key-password"], _ = expandWirelessControllerWtpProfileRadio1SamPrivateKeyPassword(d, i["sam_private_key_password"], pre_append, sv)
	} else if d.HasChange(pre_append) {
		result["sam-private-key-password"] = nil
	}
	pre_append = pre + ".0." + "sam_ca_certificate"
	if _, ok := d.GetOk(pre_append); ok {
		result["sam-ca-certificate"], _ = expandWirelessControllerWtpProfileRadio1SamCaCertificate(d, i["sam_ca_certificate"], pre_append, sv)
	} else if d.HasChange(pre_append) {
		result["sam-ca-certificate"] = nil
	}
	pre_append = pre + ".0." + "sam_username"
	if _, ok := d.GetOk(pre_append); ok {
		result["sam-username"], _ = expandWirelessControllerWtpProfileRadio1SamUsername(d, i["sam_username"], pre_append, sv)
	} else if d.HasChange(pre_append) {
		result["sam-username"] = nil
	}
	pre_append = pre + ".0." + "sam_password"
	if _, ok := d.GetOk(pre_append); ok {
		result["sam-password"], _ = expandWirelessControllerWtpProfileRadio1SamPassword(d, i["sam_password"], pre_append, sv)
	} else if d.HasChange(pre_append) {
		result["sam-password"] = nil
	}
	pre_append = pre + ".0." + "sam_test"
	if _, ok := d.GetOk(pre_append); ok {
	...
	if _, ok := d.GetOk(pre_append); ok {
		...
		result["wids-profile"] = nil
	}
	pre_append = pre + ".0." + "ai_darrp_support"
	if _, ok := d.GetOk(pre_append); ok {
		result["ai-darrp-support"], _ = expandWirelessControllerWtpProfileRadio1AiDarrpSupport(d, i["ai_darrp_support"], pre_append, sv)
	}
	pre_append = pre + ".0." + "darrp"
	if _, ok := d.GetOk(pre_append); ok {
...
func expandWirelessControllerWtpProfileRadio1MimoMode(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func expandWirelessControllerWtpProfileRadio1OptionalAntennaGain(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func expandWirelessControllerWtpProfileRadio180211Mc(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func expandWirelessControllerWtpProfileRadio1ApSnifferChanWidth(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func expandWirelessControllerWtpProfileRadio1SamEapMethod(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerWtpProfileRadio1SamClientCertificate(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerWtpProfileRadio1SamPrivateKey(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerWtpProfileRadio1SamPrivateKeyPassword(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerWtpProfileRadio1SamCaCertificate(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func expandWirelessControllerWtpProfileRadio1AiDarrpSupport(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func expandWirelessControllerWtpProfileRadio2(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	...
	pre_append = pre + ".0." + "mimo_mode"
	if _, ok := d.GetOk(pre_append); ok {
		result["mimo-mode"], _ = expandWirelessControllerWtpProfileRadio2MimoMode(d, i["mimo_mode"], pre_append, sv)
	}
	pre_append = pre + ".0." + "channel_bonding"
	if _, ok := d.GetOk(pre_append); ok {
	...
	pre_append = pre + ".0." + "optional_antenna_gain"
	if _, ok := d.GetOk(pre_append); ok {
		result["optional-antenna-gain"], _ = expandWirelessControllerWtpProfileRadio2OptionalAntennaGain(d, i["optional_antenna_gain"], pre_append, sv)
	}
	pre_append = pre + ".0." + "auto_power_level"
	if _, ok := d.GetOk(pre_append); ok {
	...
	pre_append = pre + ".0." + "n80211mc"
	if _, ok := d.GetOk(pre_append); ok {
		result["80211mc"], _ = expandWirelessControllerWtpProfileRadio280211Mc(d, i["n80211mc"], pre_append, sv)
	}
	pre_append = pre + ".0." + "rts_threshold"
	if _, ok := d.GetOk(pre_append); ok {
	...
	pre_append = pre + ".0." + "ap_sniffer_chan_width"
	if _, ok := d.GetOk(pre_append); ok {
		result["ap-sniffer-chan-width"], _ = expandWirelessControllerWtpProfileRadio2ApSnifferChanWidth(d, i["ap_sniffer_chan_width"], pre_append, sv)
	}
	pre_append = pre + ".0." + "ap_sniffer_addr"
	if _, ok := d.GetOk(pre_append); ok {
	...
	pre_append = pre + ".0." + "sam_eap_method"
	if _, ok := d.GetOk(pre_append); ok {
		result["sam-eap-method"], _ = expandWirelessControllerWtpProfileRadio2SamEapMethod(d, i["sam_eap_method"], pre_append, sv)
	}
	pre_append = pre + ".0." + "sam_client_certificate"
	if _, ok := d.GetOk(pre_append); ok {
		result["sam-client-certificate"], _ = expandWirelessControllerWtpProfileRadio2SamClientCertificate(d, i["sam_client_certificate"], pre_append, sv)
	} else if d.HasChange(pre_append) {
		result["sam-client-certificate"] = nil
	}
	pre_append = pre + ".0." + "sam_private_key"
	if _, ok := d.GetOk(pre_append); ok {
		result["sam-private-key"], _ = expandWirelessControllerWtpProfileRadio2SamPrivateKey(d, i["sam_private_key"], pre_append, sv)
	} else if d.HasChange(pre_append) {
		result["sam-private-key"] = nil
	}
	pre_append = pre + ".0." + "sam_private_key_password"
	if _, ok := d.GetOk(pre_append); ok {
		result["sam-private-key-password"], _ = expandWirelessControllerWtpProfileRadio2SamPrivateKeyPassword(d, i["sam_private_key_password"], pre_append, sv)
	} else if d.HasChange(pre_append) {
		result["sam-private-key-password"] = nil
	}
	pre_append = pre + ".0." + "sam_ca_certificate"
	if _, ok := d.GetOk(pre_append); ok {
		result["sam-ca-certificate"], _ = expandWirelessControllerWtpProfileRadio2SamCaCertificate(d, i["sam_ca_certificate"], pre_append, sv)
	} else if d.HasChange(pre_append) {
		result["sam-ca-certificate"] = nil
	}
	pre_append = pre + ".0." + "sam_username"
	...
	pre_append = pre + ".0." + "ai_darrp_support"
	if _, ok := d.GetOk(pre_append); ok {
		result["ai-darrp-support"], _ = expandWirelessControllerWtpProfileRadio2AiDarrpSupport(d, i["ai_darrp_support"], pre_append, sv)
	}
	pre_append = pre + ".0." + "darrp"
	if _, ok := d.GetOk(pre_append); ok {
...
func expandWirelessControllerWtpProfileRadio2MimoMode(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func expandWirelessControllerWtpProfileRadio2OptionalAntennaGain(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func expandWirelessControllerWtpProfileRadio280211Mc(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func expandWirelessControllerWtpProfileRadio2ApSnifferChanWidth(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func expandWirelessControllerWtpProfileRadio2SamEapMethod(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerWtpProfileRadio2SamClientCertificate(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerWtpProfileRadio2SamPrivateKey(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerWtpProfileRadio2SamPrivateKeyPassword(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerWtpProfileRadio2SamCaCertificate(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func expandWirelessControllerWtpProfileRadio2AiDarrpSupport(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func expandWirelessControllerWtpProfileRadio3(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	...
	pre_append = pre + ".0." + "mimo_mode"
	if _, ok := d.GetOk(pre_append); ok {
		result["mimo-mode"], _ = expandWirelessControllerWtpProfileRadio3MimoMode(d, i["mimo_mode"], pre_append, sv)
	}
	pre_append = pre + ".0." + "channel_bonding"
	if _, ok := d.GetOk(pre_append); ok {
	...
	pre_append = pre + ".0." + "optional_antenna_gain"
	if _, ok := d.GetOk(pre_append); ok {
		result["optional-antenna-gain"], _ = expandWirelessControllerWtpProfileRadio3OptionalAntennaGain(d, i["optional_antenna_gain"], pre_append, sv)
	}
	pre_append = pre + ".0." + "auto_power_level"
	if _, ok := d.GetOk(pre_append); ok {
	...
	pre_append = pre + ".0." + "n80211mc"
	if _, ok := d.GetOk(pre_append); ok {
		result["80211mc"], _ = expandWirelessControllerWtpProfileRadio380211Mc(d, i["n80211mc"], pre_append, sv)
	}
	pre_append = pre + ".0." + "rts_threshold"
	if _, ok := d.GetOk(pre_append); ok {
	...
	pre_append = pre + ".0." + "ap_sniffer_chan_width"
	if _, ok := d.GetOk(pre_append); ok {
		result["ap-sniffer-chan-width"], _ = expandWirelessControllerWtpProfileRadio3ApSnifferChanWidth(d, i["ap_sniffer_chan_width"], pre_append, sv)
	}
	pre_append = pre + ".0." + "ap_sniffer_addr"
	if _, ok := d.GetOk(pre_append); ok {
	...
	pre_append = pre + ".0." + "sam_eap_method"
	if _, ok := d.GetOk(pre_append); ok {
		result["sam-eap-method"], _ = expandWirelessControllerWtpProfileRadio3SamEapMethod(d, i["sam_eap_method"], pre_append, sv)
	}
	pre_append = pre + ".0." + "sam_client_certificate"
	if _, ok := d.GetOk(pre_append); ok {
		result["sam-client-certificate"], _ = expandWirelessControllerWtpProfileRadio3SamClientCertificate(d, i["sam_client_certificate"], pre_append, sv)
	} else if d.HasChange(pre_append) {
		result["sam-client-certificate"] = nil
	}
	pre_append = pre + ".0." + "sam_private_key"
	if _, ok := d.GetOk(pre_append); ok {
		result["sam-private-key"], _ = expandWirelessControllerWtpProfileRadio3SamPrivateKey(d, i["sam_private_key"], pre_append, sv)
	} else if d.HasChange(pre_append) {
		result["sam-private-key"] = nil
	}
	pre_append = pre + ".0." + "sam_private_key_password"
	if _, ok := d.GetOk(pre_append); ok {
		result["sam-private-key-password"], _ = expandWirelessControllerWtpProfileRadio3SamPrivateKeyPassword(d, i["sam_private_key_password"], pre_append, sv)
	} else if d.HasChange(pre_append) {
		result["sam-private-key-password"] = nil
	}
	pre_append = pre + ".0." + "sam_ca_certificate"
	if _, ok := d.GetOk(pre_append); ok {
		result["sam-ca-certificate"], _ = expandWirelessControllerWtpProfileRadio3SamCaCertificate(d, i["sam_ca_certificate"], pre_append, sv)
	} else if d.HasChange(pre_append) {
		result["sam-ca-certificate"] = nil
	}
	pre_append = pre + ".0." + "sam_username"
	...
	pre_append = pre + ".0." + "ai_darrp_support"
	if _, ok := d.GetOk(pre_append); ok {
		result["ai-darrp-support"], _ = expandWirelessControllerWtpProfileRadio3AiDarrpSupport(d, i["ai_darrp_support"], pre_append, sv)
	}
	pre_append = pre + ".0." + "darrp"
	if _, ok := d.GetOk(pre_append); ok {
...
func expandWirelessControllerWtpProfileRadio3MimoMode(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func expandWirelessControllerWtpProfileRadio3OptionalAntennaGain(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func expandWirelessControllerWtpProfileRadio380211Mc(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func expandWirelessControllerWtpProfileRadio3ApSnifferChanWidth(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func expandWirelessControllerWtpProfileRadio3SamEapMethod(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerWtpProfileRadio3SamClientCertificate(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerWtpProfileRadio3SamPrivateKey(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerWtpProfileRadio3SamPrivateKeyPassword(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerWtpProfileRadio3SamCaCertificate(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func expandWirelessControllerWtpProfileRadio3AiDarrpSupport(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func expandWirelessControllerWtpProfileRadio4(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	...
	pre_append = pre + ".0." + "mimo_mode"
	if _, ok := d.GetOk(pre_append); ok {
		result["mimo-mode"], _ = expandWirelessControllerWtpProfileRadio4MimoMode(d, i["mimo_mode"], pre_append, sv)
	}
	pre_append = pre + ".0." + "channel_bonding"
	if _, ok := d.GetOk(pre_append); ok {
	...
	pre_append = pre + ".0." + "optional_antenna_gain"
	if _, ok := d.GetOk(pre_append); ok {
		result["optional-antenna-gain"], _ = expandWirelessControllerWtpProfileRadio4OptionalAntennaGain(d, i["optional_antenna_gain"], pre_append, sv)
	}
	pre_append = pre + ".0." + "auto_power_level"
	if _, ok := d.GetOk(pre_append); ok {
	...
	pre_append = pre + ".0." + "n80211mc"
	if _, ok := d.GetOk(pre_append); ok {
		result["80211mc"], _ = expandWirelessControllerWtpProfileRadio480211Mc(d, i["n80211mc"], pre_append, sv)
	}
	pre_append = pre + ".0." + "rts_threshold"
	if _, ok := d.GetOk(pre_append); ok {
	...
	pre_append = pre + ".0." + "ap_sniffer_chan_width"
	if _, ok := d.GetOk(pre_append); ok {
		result["ap-sniffer-chan-width"], _ = expandWirelessControllerWtpProfileRadio4ApSnifferChanWidth(d, i["ap_sniffer_chan_width"], pre_append, sv)
	}
	pre_append = pre + ".0." + "ap_sniffer_addr"
	if _, ok := d.GetOk(pre_append); ok {
	...
	pre_append = pre + ".0." + "sam_eap_method"
	if _, ok := d.GetOk(pre_append); ok {
		result["sam-eap-method"], _ = expandWirelessControllerWtpProfileRadio4SamEapMethod(d, i["sam_eap_method"], pre_append, sv)
	}
	pre_append = pre + ".0." + "sam_client_certificate"
	if _, ok := d.GetOk(pre_append); ok {
		result["sam-client-certificate"], _ = expandWirelessControllerWtpProfileRadio4SamClientCertificate(d, i["sam_client_certificate"], pre_append, sv)
	} else if d.HasChange(pre_append) {
		result["sam-client-certificate"] = nil
	}
	pre_append = pre + ".0." + "sam_private_key"
	if _, ok := d.GetOk(pre_append); ok {
		result["sam-private-key"], _ = expandWirelessControllerWtpProfileRadio4SamPrivateKey(d, i["sam_private_key"], pre_append, sv)
	} else if d.HasChange(pre_append) {
		result["sam-private-key"] = nil
	}
	pre_append = pre + ".0." + "sam_private_key_password"
	if _, ok := d.GetOk(pre_append); ok {
		result["sam-private-key-password"], _ = expandWirelessControllerWtpProfileRadio4SamPrivateKeyPassword(d, i["sam_private_key_password"], pre_append, sv)
	} else if d.HasChange(pre_append) {
		result["sam-private-key-password"] = nil
	}
	pre_append = pre + ".0." + "sam_ca_certificate"
	if _, ok := d.GetOk(pre_append); ok {
		result["sam-ca-certificate"], _ = expandWirelessControllerWtpProfileRadio4SamCaCertificate(d, i["sam_ca_certificate"], pre_append, sv)
	} else if d.HasChange(pre_append) {
		result["sam-ca-certificate"] = nil
	}
	pre_append = pre + ".0." + "sam_username"
	...
	pre_append = pre + ".0." + "ai_darrp_support"
	if _, ok := d.GetOk(pre_append); ok {
		result["ai-darrp-support"], _ = expandWirelessControllerWtpProfileRadio4AiDarrpSupport(d, i["ai_darrp_support"], pre_append, sv)
	}
	pre_append = pre + ".0." + "darrp"
	if _, ok := d.GetOk(pre_append); ok {
...
func expandWirelessControllerWtpProfileRadio4MimoMode(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func expandWirelessControllerWtpProfileRadio4OptionalAntennaGain(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func expandWirelessControllerWtpProfileRadio480211Mc(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func expandWirelessControllerWtpProfileRadio4ApSnifferChanWidth(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func expandWirelessControllerWtpProfileRadio4SamEapMethod(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerWtpProfileRadio4SamClientCertificate(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerWtpProfileRadio4SamPrivateKey(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerWtpProfileRadio4SamPrivateKeyPassword(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerWtpProfileRadio4SamCaCertificate(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func expandWirelessControllerWtpProfileRadio4AiDarrpSupport(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func expandWirelessControllerWtpProfileLbs(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	...
	if _, ok := d.GetOk(pre_append); ok {
		...
		result["aeroscout-server-port"] = nil
	}
	pre_append = pre + ".0." + "aeroscout_mu"
	if _, ok := d.GetOk(pre_append); ok {
	...
	if _, ok := d.GetOk(pre_append); ok {
		...
		result["fortipresence-server-fqdn"] = nil
	}
	pre_append = pre + ".0." + "fortipresence_port"
	if _, ok := d.GetOk(pre_append); ok {
	...
	if _, ok := d.GetOk(pre_append); ok {
		...
		result["fortipresence-secret"] = nil
	}
	pre_append = pre + ".0." + "fortipresence_project"
	if _, ok := d.GetOk(pre_append); ok {
	...
	pre_append = pre + ".0." + "ble_rtls"
	if _, ok := d.GetOk(pre_append); ok {
		result["ble-rtls"], _ = expandWirelessControllerWtpProfileLbsBleRtls(d, i["ble_rtls"], pre_append, sv)
	}
	pre_append = pre + ".0." + "ble_rtls_protocol"
	if _, ok := d.GetOk(pre_append); ok {
		result["ble-rtls-protocol"], _ = expandWirelessControllerWtpProfileLbsBleRtlsProtocol(d, i["ble_rtls_protocol"], pre_append, sv)
	}
	pre_append = pre + ".0." + "ble_rtls_server_fqdn"
	if _, ok := d.GetOk(pre_append); ok {
		result["ble-rtls-server-fqdn"], _ = expandWirelessControllerWtpProfileLbsBleRtlsServerFqdn(d, i["ble_rtls_server_fqdn"], pre_append, sv)
	} else if d.HasChange(pre_append) {
		result["ble-rtls-server-fqdn"] = nil
	}
	pre_append = pre + ".0." + "ble_rtls_server_path"
	if _, ok := d.GetOk(pre_append); ok {
		result["ble-rtls-server-path"], _ = expandWirelessControllerWtpProfileLbsBleRtlsServerPath(d, i["ble_rtls_server_path"], pre_append, sv)
	} else if d.HasChange(pre_append) {
		result["ble-rtls-server-path"] = nil
	}
	pre_append = pre + ".0." + "ble_rtls_server_token"
	if _, ok := d.GetOk(pre_append); ok {
		result["ble-rtls-server-token"], _ = expandWirelessControllerWtpProfileLbsBleRtlsServerToken(d, i["ble_rtls_server_token"], pre_append, sv)
	} else if d.HasChange(pre_append) {
		result["ble-rtls-server-token"] = nil
	}
	pre_append = pre + ".0." + "ble_rtls_server_port"
	if _, ok := d.GetOk(pre_append); ok {
		result["ble-rtls-server-port"], _ = expandWirelessControllerWtpProfileLbsBleRtlsServerPort(d, i["ble_rtls_server_port"], pre_append, sv)
	}
	pre_append = pre + ".0." + "ble_rtls_accumulation_interval"
	if _, ok := d.GetOk(pre_append); ok {
		result["ble-rtls-accumulation-interval"], _ = expandWirelessControllerWtpProfileLbsBleRtlsAccumulationInterval(d, i["ble_rtls_accumulation_interval"], pre_append, sv)
	}
	pre_append = pre + ".0." + "ble_rtls_reporting_interval"
	if _, ok := d.GetOk(pre_append); ok {
		result["ble-rtls-reporting-interval"], _ = expandWirelessControllerWtpProfileLbsBleRtlsReportingInterval(d, i["ble_rtls_reporting_interval"], pre_append, sv)
	}
	pre_append = pre + ".0." + "ble_rtls_asset_uuid_list1"
	if _, ok := d.GetOk(pre_append); ok {
		result["ble-rtls-asset-uuid-list1"], _ = expandWirelessControllerWtpProfileLbsBleRtlsAssetUuidList1(d, i["ble_rtls_asset_uuid_list1"], pre_append, sv)
	} else if d.HasChange(pre_append) {
		result["ble-rtls-asset-uuid-list1"] = nil
	}
	pre_append = pre + ".0." + "ble_rtls_asset_uuid_list2"
	if _, ok := d.GetOk(pre_append); ok {
		result["ble-rtls-asset-uuid-list2"], _ = expandWirelessControllerWtpProfileLbsBleRtlsAssetUuidList2(d, i["ble_rtls_asset_uuid_list2"], pre_append, sv)
	} else if d.HasChange(pre_append) {
		result["ble-rtls-asset-uuid-list2"] = nil
	}
	pre_append = pre + ".0." + "ble_rtls_asset_uuid_list3"
	if _, ok := d.GetOk(pre_append); ok {
		result["ble-rtls-asset-uuid-list3"], _ = expandWirelessControllerWtpProfileLbsBleRtlsAssetUuidList3(d, i["ble_rtls_asset_uuid_list3"], pre_append, sv)
	} else if d.HasChange(pre_append) {
		result["ble-rtls-asset-uuid-list3"] = nil
	}
	pre_append = pre + ".0." + "ble_rtls_asset_uuid_list4"
	if _, ok := d.GetOk(pre_append); ok {
		result["ble-rtls-asset-uuid-list4"], _ = expandWirelessControllerWtpProfileLbsBleRtlsAssetUuidList4(d, i["ble_rtls_asset_uuid_list4"], pre_append, sv)
	} else if d.HasChange(pre_append) {
		result["ble-rtls-asset-uuid-list4"] = nil
	}
	pre_append = pre + ".0." + "ble_rtls_asset_addrgrp_list"
	if _, ok := d.GetOk(pre_append); ok {
		result["ble-rtls-asset-addrgrp-list"], _ = expandWirelessControllerWtpProfileLbsBleRtlsAssetAddrgrpList(d, i["ble_rtls_asset_addrgrp_list"], pre_append, sv)
	} else if d.HasChange(pre_append) {
		result["ble-rtls-asset-addrgrp-list"] = nil
	}
	pre_append = pre + ".0." + "polestar"
	if _, ok := d.GetOk(pre_append); ok {
		result["polestar"], _ = expandWirelessControllerWtpProfileLbsPolestar(d, i["polestar"], pre_append, sv)
	}
	pre_append = pre + ".0." + "polestar_protocol"
	if _, ok := d.GetOk(pre_append); ok {
		result["polestar-protocol"], _ = expandWirelessControllerWtpProfileLbsPolestarProtocol(d, i["polestar_protocol"], pre_append, sv)
	}
	pre_append = pre + ".0." + "polestar_server_fqdn"
	if _, ok := d.GetOk(pre_append); ok {
		result["polestar-server-fqdn"], _ = expandWirelessControllerWtpProfileLbsPolestarServerFqdn(d, i["polestar_server_fqdn"], pre_append, sv)
	}
	pre_append = pre + ".0." + "polestar_server_path"
	if _, ok := d.GetOk(pre_append); ok {
		result["polestar-server-path"], _ = expandWirelessControllerWtpProfileLbsPolestarServerPath(d, i["polestar_server_path"], pre_append, sv)
	}
	pre_append = pre + ".0." + "polestar_server_token"
	if _, ok := d.GetOk(pre_append); ok {
		result["polestar-server-token"], _ = expandWirelessControllerWtpProfileLbsPolestarServerToken(d, i["polestar_server_token"], pre_append, sv)
	} else if d.HasChange(pre_append) {
		result["polestar-server-token"] = nil
	}
	pre_append = pre + ".0." + "polestar_server_port"
	if _, ok := d.GetOk(pre_append); ok {
		result["polestar-server-port"], _ = expandWirelessControllerWtpProfileLbsPolestarServerPort(d, i["polestar_server_port"], pre_append, sv)
	}
	pre_append = pre + ".0." + "polestar_accumulation_interval"
	if _, ok := d.GetOk(pre_append); ok {
		result["polestar-accumulation-interval"], _ = expandWirelessControllerWtpProfileLbsPolestarAccumulationInterval(d, i["polestar_accumulation_interval"], pre_append, sv)
	}
	pre_append = pre + ".0." + "polestar_reporting_interval"
	if _, ok := d.GetOk(pre_append); ok {
		result["polestar-reporting-interval"], _ = expandWirelessControllerWtpProfileLbsPolestarReportingInterval(d, i["polestar_reporting_interval"], pre_append, sv)
	}
	pre_append = pre + ".0." + "polestar_asset_uuid_list1"
	if _, ok := d.GetOk(pre_append); ok {
		result["polestar-asset-uuid-list1"], _ = expandWirelessControllerWtpProfileLbsPolestarAssetUuidList1(d, i["polestar_asset_uuid_list1"], pre_append, sv)
	} else if d.HasChange(pre_append) {
		result["polestar-asset-uuid-list1"] = nil
	}
	pre_append = pre + ".0." + "polestar_asset_uuid_list2"
	if _, ok := d.GetOk(pre_append); ok {
		result["polestar-asset-uuid-list2"], _ = expandWirelessControllerWtpProfileLbsPolestarAssetUuidList2(d, i["polestar_asset_uuid_list2"], pre_append, sv)
	} else if d.HasChange(pre_append) {
		result["polestar-asset-uuid-list2"] = nil
	}
	pre_append = pre + ".0." + "polestar_asset_uuid_list3"
	if _, ok := d.GetOk(pre_append); ok {
		result["polestar-asset-uuid-list3"], _ = expandWirelessControllerWtpProfileLbsPolestarAssetUuidList3(d, i["polestar_asset_uuid_list3"], pre_append, sv)
	} else if d.HasChange(pre_append) {
		result["polestar-asset-uuid-list3"] = nil
	}
	pre_append = pre + ".0." + "polestar_asset_uuid_list4"
	if _, ok := d.GetOk(pre_append); ok {
		result["polestar-asset-uuid-list4"], _ = expandWirelessControllerWtpProfileLbsPolestarAssetUuidList4(d, i["polestar_asset_uuid_list4"], pre_append, sv)
	} else if d.HasChange(pre_append) {
		result["polestar-asset-uuid-list4"] = nil
	}
	pre_append = pre + ".0." + "polestar_asset_addrgrp_list"
	if _, ok := d.GetOk(pre_append); ok {
		result["polestar-asset-addrgrp-list"], _ = expandWirelessControllerWtpProfileLbsPolestarAssetAddrgrpList(d, i["polestar_asset_addrgrp_list"], pre_append, sv)
	} else if d.HasChange(pre_append) {
		result["polestar-asset-addrgrp-list"] = nil
	}
...
func expandWirelessControllerWtpProfileLbsBleRtls(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerWtpProfileLbsBleRtlsProtocol(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerWtpProfileLbsBleRtlsServerFqdn(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerWtpProfileLbsBleRtlsServerPath(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerWtpProfileLbsBleRtlsServerToken(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerWtpProfileLbsBleRtlsServerPort(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerWtpProfileLbsBleRtlsAccumulationInterval(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerWtpProfileLbsBleRtlsReportingInterval(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerWtpProfileLbsBleRtlsAssetUuidList1(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerWtpProfileLbsBleRtlsAssetUuidList2(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerWtpProfileLbsBleRtlsAssetUuidList3(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerWtpProfileLbsBleRtlsAssetUuidList4(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerWtpProfileLbsBleRtlsAssetAddrgrpList(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerWtpProfileLbsPolestar(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerWtpProfileLbsPolestarProtocol(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerWtpProfileLbsPolestarServerFqdn(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerWtpProfileLbsPolestarServerPath(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerWtpProfileLbsPolestarServerToken(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerWtpProfileLbsPolestarServerPort(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerWtpProfileLbsPolestarAccumulationInterval(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerWtpProfileLbsPolestarReportingInterval(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerWtpProfileLbsPolestarAssetUuidList1(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerWtpProfileLbsPolestarAssetUuidList2(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerWtpProfileLbsPolestarAssetUuidList3(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerWtpProfileLbsPolestarAssetUuidList4(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerWtpProfileLbsPolestarAssetAddrgrpList(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func expandWirelessControllerWtpProfileWanPortAuthMacsec(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerWtpProfileApcfgAutoCert(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerWtpProfileApcfgAutoCertEnrollProtocol(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerWtpProfileApcfgAutoCertCryptoAlgo(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerWtpProfileApcfgAutoCertEstServer(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerWtpProfileApcfgAutoCertEstCaId(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerWtpProfileApcfgAutoCertEstHttpUsername(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerWtpProfileApcfgAutoCertEstHttpPassword(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerWtpProfileApcfgAutoCertEstSubject(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerWtpProfileApcfgAutoCertEstSubjectAltName(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerWtpProfileApcfgAutoCertAutoRegenDays(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerWtpProfileApcfgAutoCertEstHttpsCa(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerWtpProfileApcfgAutoCertScepKeytype(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerWtpProfileApcfgAutoCertScepKeysize(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerWtpProfileApcfgAutoCertScepEcName(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerWtpProfileApcfgAutoCertScepSubFullyDn(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerWtpProfileApcfgAutoCertScepUrl(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerWtpProfileApcfgAutoCertScepPassword(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerWtpProfileApcfgAutoCertScepCaId(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerWtpProfileApcfgAutoCertScepSubjectAltName(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}

func expandWirelessControllerWtpProfileApcfgAutoCertScepHttpsCa(d *schema.ResourceData, v interface{}, pre string, sv string) (interface{}, error) {
	return v, nil
}
...
func getObjectWirelessControllerWtpProfile(d *schema.ResourceData, sv string) (*map[string]interface{}, error) {
	...
	if v, ok := d.GetOk("bonjour_profile"); ok {
		t, err := expandWirelessControllerWtpProfileBonjourProfile(d, v, "bonjour_profile", sv)
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	} else if d.HasChange("ble_profile") {
		obj["ble-profile"] = nil
	}

	if v, ok := d.GetOk("lw_profile"); ok {
		t, err := expandWirelessControllerWtpProfileLwProfile(d, v, "lw_profile", sv)
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["lw-profile"] = t
		}
	} else if d.HasChange("lw_profile") {
		obj["lw-profile"] = nil
	}
	...
	} else if d.HasChange("syslog_profile") {
		obj["syslog-profile"] = nil
	}
	...
	} else if d.HasChange("wan_port_auth_usrname") {
		obj["wan-port-auth-usrname"] = nil
	}
	...
	} else if d.HasChange("wan_port_auth_password") {
		obj["wan-port-auth-password"] = nil
	}
	...
	if v, ok := d.GetOk("wan_port_auth_macsec"); ok {
		t, err := expandWirelessControllerWtpProfileWanPortAuthMacsec(d, v, "wan_port_auth_macsec", sv)
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("apcfg_auto_cert"); ok {
		t, err := expandWirelessControllerWtpProfileApcfgAutoCert(d, v, "apcfg_auto_cert", sv)
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("apcfg_auto_cert_enroll_protocol"); ok {
		t, err := expandWirelessControllerWtpProfileApcfgAutoCertEnrollProtocol(d, v, "apcfg_auto_cert_enroll_protocol", sv)
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("apcfg_auto_cert_crypto_algo"); ok {
		t, err := expandWirelessControllerWtpProfileApcfgAutoCertCryptoAlgo(d, v, "apcfg_auto_cert_crypto_algo", sv)
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("apcfg_auto_cert_est_server"); ok {
		t, err := expandWirelessControllerWtpProfileApcfgAutoCertEstServer(d, v, "apcfg_auto_cert_est_server", sv)
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["apcfg-auto-cert-est-server"] = t
		}
	} else if d.HasChange("apcfg_auto_cert_est_server") {
		obj["apcfg-auto-cert-est-server"] = nil
	}

	if v, ok := d.GetOk("apcfg_auto_cert_est_ca_id"); ok {
		t, err := expandWirelessControllerWtpProfileApcfgAutoCertEstCaId(d, v, "apcfg_auto_cert_est_ca_id", sv)
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["apcfg-auto-cert-est-ca-id"] = t
		}
	} else if d.HasChange("apcfg_auto_cert_est_ca_id") {
		obj["apcfg-auto-cert-est-ca-id"] = nil
	}

	if v, ok := d.GetOk("apcfg_auto_cert_est_http_username"); ok {
		t, err := expandWirelessControllerWtpProfileApcfgAutoCertEstHttpUsername(d, v, "apcfg_auto_cert_est_http_username", sv)
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["apcfg-auto-cert-est-http-username"] = t
		}
	} else if d.HasChange("apcfg_auto_cert_est_http_username") {
		obj["apcfg-auto-cert-est-http-username"] = nil
	}

	if v, ok := d.GetOk("apcfg_auto_cert_est_http_password"); ok {
		t, err := expandWirelessControllerWtpProfileApcfgAutoCertEstHttpPassword(d, v, "apcfg_auto_cert_est_http_password", sv)
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["apcfg-auto-cert-est-http-password"] = t
		}
	} else if d.HasChange("apcfg_auto_cert_est_http_password") {
		obj["apcfg-auto-cert-est-http-password"] = nil
	}

	if v, ok := d.GetOk("apcfg_auto_cert_est_subject"); ok {
		t, err := expandWirelessControllerWtpProfileApcfgAutoCertEstSubject(d, v, "apcfg_auto_cert_est_subject", sv)
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("apcfg_auto_cert_est_subject_alt_name"); ok {
		t, err := expandWirelessControllerWtpProfileApcfgAutoCertEstSubjectAltName(d, v, "apcfg_auto_cert_est_subject_alt_name", sv)
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["apcfg-auto-cert-est-subject-alt-name"] = t
		}
	} else if d.HasChange("apcfg_auto_cert_est_subject_alt_name") {
		obj["apcfg-auto-cert-est-subject-alt-name"] = nil
	}

	if v, ok := d.GetOkExists("apcfg_auto_cert_auto_regen_days"); ok {
		t, err := expandWirelessControllerWtpProfileApcfgAutoCertAutoRegenDays(d, v, "apcfg_auto_cert_auto_regen_days", sv)
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("apcfg_auto_cert_est_https_ca"); ok {
		t, err := expandWirelessControllerWtpProfileApcfgAutoCertEstHttpsCa(d, v, "apcfg_auto_cert_est_https_ca", sv)
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["apcfg-auto-cert-est-https-ca"] = t
		}
	} else if d.HasChange("apcfg_auto_cert_est_https_ca") {
		obj["apcfg-auto-cert-est-https-ca"] = nil
	}

	if v, ok := d.GetOk("apcfg_auto_cert_scep_keytype"); ok {
		t, err := expandWirelessControllerWtpProfileApcfgAutoCertScepKeytype(d, v, "apcfg_auto_cert_scep_keytype", sv)
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("apcfg_auto_cert_scep_keysize"); ok {
		t, err := expandWirelessControllerWtpProfileApcfgAutoCertScepKeysize(d, v, "apcfg_auto_cert_scep_keysize", sv)
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("apcfg_auto_cert_scep_ec_name"); ok {
		t, err := expandWirelessControllerWtpProfileApcfgAutoCertScepEcName(d, v, "apcfg_auto_cert_scep_ec_name", sv)
		if err != nil {
			return &obj, err
		} else if t != nil {
	...
	if v, ok := d.GetOk("apcfg_auto_cert_scep_sub_fully_dn"); ok {
		t, err := expandWirelessControllerWtpProfileApcfgAutoCertScepSubFullyDn(d, v, "apcfg_auto_cert_scep_sub_fully_dn", sv)
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["apcfg-auto-cert-scep-sub-fully-dn"] = t
		}
	} else if d.HasChange("apcfg_auto_cert_scep_sub_fully_dn") {
		obj["apcfg-auto-cert-scep-sub-fully-dn"] = nil
	}

	if v, ok := d.GetOk("apcfg_auto_cert_scep_url"); ok {
		t, err := expandWirelessControllerWtpProfileApcfgAutoCertScepUrl(d, v, "apcfg_auto_cert_scep_url", sv)
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["apcfg-auto-cert-scep-url"] = t
		}
	} else if d.HasChange("apcfg_auto_cert_scep_url") {
		obj["apcfg-auto-cert-scep-url"] = nil
	}

	if v, ok := d.GetOk("apcfg_auto_cert_scep_password"); ok {
		t, err := expandWirelessControllerWtpProfileApcfgAutoCertScepPassword(d, v, "apcfg_auto_cert_scep_password", sv)
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["apcfg-auto-cert-scep-password"] = t
		}
	} else if d.HasChange("apcfg_auto_cert_scep_password") {
		obj["apcfg-auto-cert-scep-password"] = nil
	}

	if v, ok := d.GetOk("apcfg_auto_cert_scep_ca_id"); ok {
		t, err := expandWirelessControllerWtpProfileApcfgAutoCertScepCaId(d, v, "apcfg_auto_cert_scep_ca_id", sv)
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["apcfg-auto-cert-scep-ca-id"] = t
		}
	} else if d.HasChange("apcfg_auto_cert_scep_ca_id") {
		obj["apcfg-auto-cert-scep-ca-id"] = nil
	}

	if v, ok := d.GetOk("apcfg_auto_cert_scep_subject_alt_name"); ok {
		t, err := expandWirelessControllerWtpProfileApcfgAutoCertScepSubjectAltName(d, v, "apcfg_auto_cert_scep_subject_alt_name", sv)
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["apcfg-auto-cert-scep-subject-alt-name"] = t
		}
	} else if d.HasChange("apcfg_auto_cert_scep_subject_alt_name") {
		obj["apcfg-auto-cert-scep-subject-alt-name"] = nil
	}

	if v, ok := d.GetOk("apcfg_auto_cert_scep_https_ca"); ok {
		t, err := expandWirelessControllerWtpProfileApcfgAutoCertScepHttpsCa(d, v, "apcfg_auto_cert_scep_https_ca", sv)
		if err != nil {
			return &obj, err
		} else if t != nil {
			obj["apcfg-auto-cert-scep-https-ca"] = t
		}
	} else if d.HasChange("apcfg_auto_cert_scep_https_ca") {
		obj["apcfg-auto-cert-scep-https-ca"] = nil
	}
