...
func TestAccFortiOSFirewallObjectIPPool_Overload(t *testing.T) {
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccFortiOSFirewallObjectIPPoolConfigOverload,
				Check: resource.ComposeTestCheckFunc(
					testAccCheckFortiOSFirewallObjectIPPoolExists("fortios_firewall_object_ippool.test1"),
					resource.TestCheckResourceAttr("fortios_firewall_object_ippool.test1", "name", "s1"),
...
func TestAccFortiOSFirewallObjectIPPool_OneToOne(t *testing.T) {
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccFortiOSFirewallObjectIPPoolConfigOneToOne,
				Check: resource.ComposeTestCheckFunc(
					testAccCheckFortiOSFirewallObjectIPPoolExists("fortios_firewall_object_ippool.test2"),
					resource.TestCheckResourceAttr("fortios_firewall_object_ippool.test2", "name", "s2"),
...
const testAccFortiOSFirewallObjectIPPoolConfigOverload = `
...
const testAccFortiOSFirewallObjectIPPoolConfigOneToOne = `
