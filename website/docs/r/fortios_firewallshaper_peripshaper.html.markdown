...
* `max_bandwidth` - Upper bandwidth limit enforced by this shaper. 0 means no limit. Units depend on the bandwidth-unit setting. On FortiOS versions 6.2.0-6.4.2, 7.0.0-7.0.5, 7.2.0: 0 - 16776000. On FortiOS versions 6.4.10-6.4.15, 7.0.6-7.0.19, 7.2.1-7.2.12, 7.4.0-7.6.7: 0 - 80000000. On FortiOS versions 7.2.13, >= 8.0.0: 0 - 100000000.
