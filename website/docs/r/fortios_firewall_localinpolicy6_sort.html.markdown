...
---
layout: "fortios"
page_title: "FortiOS: fortios_firewall_localinpolicy6_sort"
sidebar_current: "docs-fortios_firewall_localinpolicy6_sort"
subcategory: "FortiGate Firewall"
description: |-
  Provides a resource to sort firewall localinpolicy6 policy
---

# fortios_firewall_localinpolicy6_sort
Provides a resource to sort firewall localinpolicy6 policy

```hcl

resource "fortios_firewall_localinpolicy6_sort" "test" {
  sortby        = "policyid"
