...
layout: "fortios"
page_title: "FortiOS: fortios_firewall_proxyaddrgrp6"
description: |-
  Configure web proxy address group6.
---

# fortios_firewall_proxyaddrgrp6
Configure web proxy address group6. Applies to FortiOS Version `>= 8.0.0`.
...
* `name` - Address group6.
* `type` - Source or destination address group6 type. Valid values: `src`, `dst`.
* `uuid` - Universally Unique Identifier (UUID; automatically assigned but can be manually reset).
* `member` - Members of address group6. The structure of `member` block is documented below.
...
```
$ terraform import fortios_firewall_proxyaddrgrp6.labelname {{name}}
