...
layout: "fortios"
page_title: "FortiOS: fortios_firewall_internetservicefortiguard"
description: |-
  Configure FortiGuard Internet Services.
---

# fortios_firewall_internetservicefortiguard
Configure FortiGuard Internet Services. Applies to FortiOS Version `>= 7.6.4`.
...
* `comment` - Comment.
* `entry` - Entries added to the Internet Service FortiGuard database. The structure of `entry` block is documented below.
...
Firewall InternetServiceFortiguard can be imported using any of these accepted formats:
```
$ terraform import fortios_firewall_internetservicefortiguard.labelname {{name}}
