...
layout: "fortios"
page_title: "FortiOS: fortios_router_multicast6flow"
description: |-
  Configure IPv6 multicast-flow.
---

# fortios_router_multicast6flow
Configure IPv6 multicast-flow. Applies to FortiOS Version `>= 8.0.0`.
...
* `name` - Name.
* `comments` - Comment.
* `flows` - IPv6 multicast-flow entries. The structure of `flows` block is documented below.
...
```
$ terraform import fortios_router_multicast6flow.labelname {{name}}
