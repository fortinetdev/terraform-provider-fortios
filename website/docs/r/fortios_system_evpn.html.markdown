...
* `adv_default_gw` - Enable/disable advertisement of default gateway. Valid values: `enable`, `disable`.
* `distribute_local_route` - Enable/disable distribution of local EVPN routes as IPv4 routes to BGP. Valid values: `enable`, `disable`.
