...
* `discovery_mc_addr` - Multicast IP address for AP discovery (default = 224.0.1.140).
...
* `tunnel_mode` - Configure tunnel mode security. On FortiOS versions >= 8.0.0: default = compatible. Valid values: `compatible`, `strict`.
