...
* `client_certificate_blocklist` - Enable/disable blocking client malicious certificates list by FortiGuard during TLS handshake. Valid values: `enable`, `disable`.
